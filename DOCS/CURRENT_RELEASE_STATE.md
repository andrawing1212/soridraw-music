...
- 실제 PREVIEW 앱: **088** — `preview.soridraw.com`
...
## 3. 087 실사용 FAIL — 같은 Explore 세션에서 방금 누른 좋아요 하트 소실
사용자 영상에서 재현:
...
- 하트의 현재 기준을 `pending outbox → current liked-state cache` 순서로 고정.
...
- Release trigger commit: `efb3438f83b88cbe7eec54ed6a3e0a3d3a927722`
- App Run: `34817897316` — **PASS**
- `LOCKED_PREVIEW_SHA=efb3438f83b88cbe7eec54ed6a3e0a3d3a927722`
- TypeScript PASS
- Build PASS
...
088:
- Worker 변경 없음
- Firebase Hosting만 PREVIEW 앱 배포
- Functions/D1 schema 변경 없음
...
088 실사용 통과 후 공개곡 카드 `... → 다음곡에도 적용 / 공유노트 저장` 작업으로 이동.

## 9. 승격 상태
- PREVIEW 실제: **088 / Worker 053**
- 088: **배포 완료 / 자동검증 PASS / 사용자 실사용 검증 전**
- TEST 승격: 금지
