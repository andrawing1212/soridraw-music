...
export const STYLE_CYCLES: SoundStyleCycle[] = [
  ...
  },
  {
    ...
    titleKo: '시대 질감',
    variants: [
      // SORIDRAW_ERA_TEXTURE_CURATED_V169: 시대질감은 메인 장르를 덮지 않는 보조 시대/프로덕션 문법만 남깁니다.
      { id: 'separator-style-era-production', kind: 'separator', label: '시대 프로덕션', labelKo: '시대 프로덕션', description: '', descriptionKo: '', promptCore: '' },
      { id: 'era-prefix-60s', label: '60s Classic Warmth', labelKo: '60s 클래식 온기', description: '60s-style classic warmth for pop, soul, folk, and ballad contexts.', descriptionKo: '60s Classic Warmth - 60년대식 고전적인 따뜻함과 빈티지 녹음 질감입니다. 특정 장르를 덮지 않고 시대적 색감만 더합니다.', style: '60s classic warmth', sound: 'warm organ, live drums, vintage guitar, soft tape-like recording color', mood: 'classic, warm, nostalgic' },
      { id: '70s-vintage-soul', label: '70s Analog Groove', labelKo: '70s 아날로그 그루브', description: '70s analog band groove for soul, disco, funk, pop, and crossover tracks.', descriptionKo: '70s Analog Groove - 70년대식 라이브 밴드감, 소울/디스코/펑크 그루브를 넓게 더하는 시대 질감입니다.', style: '70s analog groove', sound: 'live bass, rhythm guitar, warm keys, analog drums', mood: 'warm, groovy, vintage' },
      { id: '80s-retro-synth', label: '80s Synth Color', labelKo: '80s 신스 컬러', description: '80s synth color with analog synths, gated drums, and neon-pop polish.', descriptionKo: '80s Synth Color - 80년대식 신스, 게이트 드럼, 네온빛 전자 질감을 더합니다.', style: '80s synth color', sound: 'analog synths, gated drums, drum machine, neon pads', mood: 'retro, glossy, cinematic' },
      { id: '90s-rnb', label: '90s Warm Studio Feel', labelKo: '90s 따뜻한 스튜디오감', description: '90s warm studio production feel usable for ballad, R&B, pop, and Korean gayo.', descriptionKo: '90s Warm Studio Feel - 90년대식 따뜻한 스튜디오 사운드입니다. R&B뿐 아니라 발라드, 팝, 한국 가요에도 쓸 수 있습니다.', style: '90s warm studio color', sound: 'warm keys, smooth drums, soft pads, rounded studio mix', mood: 'mellow, warm, nostalgic' },
      { id: '90s-new-jack', label: '90s Rhythm Pop Bounce', labelKo: '90s 리듬 팝 바운스', description: '90s rhythm-pop bounce with new-jack-inspired drums and syncopated pop movement.', descriptionKo: '90s Rhythm Pop Bounce - 90년대 댄스팝/뉴잭스윙 계열의 탄력 있는 리듬감입니다.', style: '90s rhythm-pop bounce', sound: 'punchy drums, syncopated keys, slap bass, bright rhythm accents', mood: 'fresh, rhythmic, energetic' },
      { id: '2000s-y2k-pop', label: '2000s Glossy Pop Polish', labelKo: '2000s 글로시 팝 광택', description: '2000s glossy pop polish with digital brightness and tight hook focus.', descriptionKo: '2000s Glossy Pop Polish - 2000년대식 반짝이는 디지털 팝 광택과 선명한 훅 질감입니다.', style: '2000s glossy pop polish', sound: 'glossy synths, digital keys, tight pop drums, bright hook accents', mood: 'shiny, nostalgic, catchy' },
      { id: 'cyworld-2000s', label: '2000s Korean Sentiment', labelKo: '2000s 한국 감성', description: '2000s Korean sentimental pop color for ballad, gayo, acoustic pop, and nostalgic tracks.', descriptionKo: '2000s Korean Sentiment - 싸이월드/미니홈피 시절의 한국형 발라드, 감성팝, 추억 정서를 더합니다.', style: '2000s Korean sentimental color', sound: 'soft piano, warm strings, clean drums, sentimental pop polish', mood: 'nostalgic, sentimental, earnest' },
      { id: '2010s-idol-pop', label: '2010s Polished Pop Energy', labelKo: '2010s 폴리시드 팝 에너지', description: '2010s polished pop energy with clean section contrast and chorus lift, without forcing idol group vocals.', descriptionKo: '2010s Polished Pop Energy - 2010년대식 깔끔한 팝 섹션감, 선명한 후렴, 세련된 믹스를 더합니다. 아이돌 그룹 보컬을 강제하지 않습니다.', style: '2010s polished pop energy', sound: 'polished synths, punchy drums, clean pop mix, sharp section accents', mood: 'bright, sleek, energetic' },
      { id: '2010s-edm-pop', label: '2010s Festival Build', labelKo: '2010s 페스티벌 빌드업', description: '2010s festival build color with risers, sidechain synths, and drop-like lift without replacing the main genre.', descriptionKo: '2010s Festival Build - 2010년대 EDM 팝의 빌드업, 라이저, 드롭형 상승감을 보조 색감으로 더합니다.', style: '2010s festival build color', sound: 'sidechain synths, EDM risers, festival drums, bright synth lift', mood: 'energetic, expansive, bright' },
      { id: '2020s-hyperpop', label: '2020s Hyper-Digital Texture', labelKo: '2020s 하이퍼 디지털 질감', description: '2020s hyper-digital texture with glitch, saturation, and sharp processed impact.', descriptionKo: '2020s Hyper-Digital Texture - 2020년대식 과포화 디지털, 글리치, 압축된 팝 질감을 더합니다.', style: '2020s hyper-digital texture', sound: 'glitch synths, bright digital hits, processed drums, compressed hook impact', mood: 'hyper, synthetic, sharp' },
      { id: '2020s-minimal-pop', label: '2020s Minimal Clean Pop', labelKo: '2020s 미니멀 클린 팝', description: '2020s minimal clean pop color with restrained beat, clean space, and focused hook.', descriptionKo: '2020s Minimal Clean Pop - 2020년대식 절제된 비트, 깨끗한 공간감, 단정한 훅 중심의 시대 질감입니다.', style: '2020s minimal clean pop color', sound: 'minimal beat, soft synth, clean bass, sparse modern mix', mood: 'modern, restrained, crisp' }
    ],
  },
  {
    id: 'synth-space',
...
export const SOUND_TEXTURE_CYCLES = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'tape-hiss', label: 'Tape / Cassette Texture', labelKo: '테이프/카세트 질감', description: 'tape/cassette texture - cassette warmth, soft wobble, and gentle hiss. (Lo-fi, Indie Pop, Retro Pop)', descriptionKo: 'tape/cassette texture - 카세트 특유의 따뜻함, 흔들림, 히스 노이즈를 통합한 질감입니다. (Lo-fi, Indie Pop, Retro Pop)', promptCore: 'tape hiss, cassette warmth' },
      ...
      { id: 'radio-noise', label: 'Radio Filter', labelKo: '라디오 필터', description: 'radio filter - old radio midrange filtering, soft noise, and broadcast warmth. (Lo-fi, Retro Pop, Indie, Cinematic)', descriptionKo: 'radio filter - 오래된 라디오처럼 중역이 좁고 부드러운 송출 잡음이 섞이는 필터 질감입니다. (Lo-fi, Retro Pop, Indie, Cinematic)', promptCore: 'radio filter, soft broadcast noise' },
      { id: 'digital-noise', label: 'Digital Compression', labelKo: '디지털 압축 질감', description: 'digital compression - compressed, narrow, and slightly broken digital texture. (Hyperpop, Electronic, Experimental)', descriptionKo: 'digital compression - 구형 MP3나 압축된 파일처럼 좁고 깨지는 디지털 질감입니다. (Hyperpop, Electronic, Experimental)', promptCore: 'digital compression texture' },
