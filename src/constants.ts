...
export const TAG_META: Record<string, { tier: TagTier }> = {
  "Soft opening": { tier: 'basic' },
  "Atmospheric": { tier: 'basic' },
  "Minimal start": { tier: 'basic' },
  "Cinematic start": { tier: 'basic' },
  "Dreamy": { tier: 'basic' },
  "Tension setup": { tier: 'basic' },
  "Hook preview": { tier: 'basic' },
  "Vocal teaser": { tier: 'basic' },
  "Instrumental start": { tier: 'basic' },
  "Fade in": { tier: 'basic' },
  "Ambient texture": { tier: 'basic' },
  "Quiet entrance": { tier: 'basic' },
  "Storytelling": { tier: 'basic' },
  "Conversational": { tier: 'basic' },
  "Low energy": { tier: 'basic' },
  "Intimate": { tier: 'basic' },
  "Sparse": { tier: 'basic' },
  "Rhythmic": { tier: 'basic' },
  "Scene setting": { tier: 'basic' },
  "Detailed narrative": { tier: 'basic' },
  "Emotional restraint": { tier: 'basic' },
  "Spoken feel": { tier: 'basic' },
  "Tension building": { tier: 'basic' },
  "Melodic flow": { tier: 'basic' },
  "Build-up": { tier: 'basic' },
  "Rising tension": { tier: 'basic' },
  "Emotional lift": { tier: 'basic' },
  "Vocal climb": { tier: 'basic' },
  "Anticipation": { tier: 'basic' },
  "Soft to big": { tier: 'basic' },
  "Harmonic lift": { tier: 'basic' },
  "Breath-held": { tier: 'basic' },
  "Energy ramp": { tier: 'basic' },
  "Suspense": { tier: 'basic' },
  "Hook setup": { tier: 'basic' },
  "Melodic rise": { tier: 'basic' },
  "Big hook": { tier: 'basic' },
  "Catchy hook": { tier: 'basic' },
  "Emotional release": { tier: 'basic' },
  "Singalong": { tier: 'basic' },
  "Wide lift": { tier: 'basic' },
  "Explosive": { tier: 'basic' },
  "Repeated phrase": { tier: 'basic' },
  "Anthemic": { tier: 'basic' },
  "Bright lift": { tier: 'basic' },
  "Full band": { tier: 'basic' },
  "Melodic climax": { tier: 'basic' },
  "Memorable refrain": { tier: 'basic' },
  "Catchy loop": { tier: 'basic' },
  "Short hook": { tier: 'basic' },
  "Earworm": { tier: 'basic' },
  "Chant-like": { tier: 'basic' },
  "Call back": { tier: 'basic' },
  "Simple phrase": { tier: 'basic' },
  "Rhythmic hook": { tier: 'basic' },
  "Vocal hook": { tier: 'basic' },
  "Melodic hook": { tier: 'basic' },
  "Punchy repeat": { tier: 'basic' },
  "Minimal hook": { tier: 'basic' },
  "Beat drop": { tier: 'basic' },
  "Bass drop": { tier: 'basic' },
  "Impact": { tier: 'basic' },
  "Rhythmic drop": { tier: 'basic' },
  "Synth hit": { tier: 'basic' },
  "Vocal chop": { tier: 'basic' },
  "Minimal drop": { tier: 'basic' },
  "Dance drop": { tier: 'basic' },
  "Dark drop": { tier: 'basic' },
  "Bright drop": { tier: 'basic' },
  "Club energy": { tier: 'basic' },
  "Hook-driven": { tier: 'basic' },
  "Mood shift": { tier: 'basic' },
  "Emotional turn": { tier: 'basic' },
  "New perspective": { tier: 'basic' },
  "Quiet confession": { tier: 'basic' },
  "Dramatic pause": { tier: 'basic' },
  "Tension release": { tier: 'basic' },
  "Scene reversal": { tier: 'basic' },
  "Dreamlike shift": { tier: 'basic' },
  "Vocal handoff": { tier: 'basic' },
  "Rebuild": { tier: 'basic' },
  "Key-change feel": { tier: 'basic' },
  "Final setup": { tier: 'basic' },
  "Energy drop": { tier: 'basic' },
  "Minimal reset": { tier: 'basic' },
  "Stripped down": { tier: 'basic' },
  "Half-time feel": { tier: 'basic' },
  "Tension hold": { tier: 'basic' },
  "Low drums": { tier: 'basic' },
  "Bass focus": { tier: 'basic' },
  "Sparse texture": { tier: 'basic' },
  "Dark reset": { tier: 'basic' },
  "Quiet collapse": { tier: 'basic' },
  "Rebuild start": { tier: 'basic' },
  "Contrast": { tier: 'basic' },
  "Lead solo": { tier: 'basic' },
  "Guitar lead": { tier: 'basic' },
  "Synth lead": { tier: 'basic' },
  "Piano lead": { tier: 'basic' },
  "Sax lead": { tier: 'basic' },
  "String lead": { tier: 'basic' },
  "Improvised feel": { tier: 'basic' },
  "Melodic solo": { tier: 'basic' },
  "Expressive lead": { tier: 'basic' },
  "Short solo": { tier: 'basic' },
  "Emotional solo": { tier: 'basic' },
  "Technical solo": { tier: 'basic' },
  "Tight flow": { tier: 'basic' },
  "Punchy flow": { tier: 'basic' },
  "Fast rhythm": { tier: 'basic' },
  "Laid-back": { tier: 'basic' },
  "Off-beat flow": { tier: 'basic' },
  "Conversational rap": { tier: 'basic' },
  "Dry spoken rap": { tier: 'basic' },
  "Melodic rap": { tier: 'basic' },
  "Aggressive": { tier: 'basic' },
  "Playful": { tier: 'basic' },
  "Call and response": { tier: 'basic' },
  "Character switch": { tier: 'basic' },
  "Soft ending": { tier: 'basic' },
  "Fade out": { tier: 'basic' },
  "Quiet ending": { tier: 'basic' },
  "Echo finish": { tier: 'basic' },
  "Emotional closure": { tier: 'basic' },
  "Open ending": { tier: 'basic' },
  "Last phrase": { tier: 'basic' },
  "Minimal ending": { tier: 'basic' },
  "Gradual exit": { tier: 'basic' },
  "Calm closure": { tier: 'basic' },
  "Bittersweet": { tier: 'basic' },
  "Loop-friendly": { tier: 'basic' },
  "Main motif": { tier: 'basic' },
  "Soft motif": { tier: 'basic' },
  "Repeated motif": { tier: 'basic' },
  "Emotional motif": { tier: 'basic' },
  "Melodic idea": { tier: 'basic' },
  "Contrast idea": { tier: 'basic' },
  "Variation": { tier: 'basic' },
  "Scene motif": { tier: 'basic' },
  "Character motif": { tier: 'basic' },
  "Memory cue": { tier: 'basic' },
  "Motif return": { tier: 'basic' },
  "Rising drums": { tier: 'basic' },
  "Layer increase": { tier: 'basic' },
  "Tension rise": { tier: 'basic' },
  "Snare lift": { tier: 'basic' },
  "Vocal lift": { tier: 'basic' },
  "Pre-drop lift": { tier: 'basic' },
  "Dramatic swell": { tier: 'basic' },
  "Gradual build": { tier: 'basic' },
  "Fast build": { tier: 'basic' },
  "Controlled rise": { tier: 'basic' },
  "Final push": { tier: 'basic' },
  "Signature melody": { tier: 'basic' },
  "Strong melody": { tier: 'basic' },
  "Emotional lead": { tier: 'basic' },
  "Full theme": { tier: 'basic' },
  "Repeated theme": { tier: 'basic' },
  "Hero melody": { tier: 'basic' },
  "Cinematic lead": { tier: 'basic' },
  "Clear motif": { tier: 'basic' },
  "Wide theme": { tier: 'basic' },
  "Memorable line": { tier: 'basic' },
  "Theme return": { tier: 'basic' },
  "Peak energy": { tier: 'basic' },
  "Full impact": { tier: 'basic' },
  "Final release": { tier: 'basic' },
  "Emotional peak": { tier: 'basic' },
  "Big lift": { tier: 'basic' },
  "Maximum tension": { tier: 'basic' },
  "Grand moment": { tier: 'basic' },
  "Explosive hit": { tier: 'basic' },
  "Vocal peak": { tier: 'basic' },
  "Full arrangement": { tier: 'basic' },
  "Dramatic high": { tier: 'basic' },
  "Last burst": { tier: 'basic' },
  "Short break": { tier: 'basic' },
  "Drum break": { tier: 'basic' },
  "Silence gap": { tier: 'basic' },
  "Transition break": { tier: 'basic' },
  "Sudden stop": { tier: 'basic' },
  "Hard stop": { tier: 'basic' },
  "Beat stop": { tier: 'basic' },
  "Comic pause": { tier: 'basic' }
};
...
export const TAG_DESCRIPTIONS = {
  "Soft opening": "부드럽게 시작해 첫 분위기를 편하게 열어줍니다.",
  "Atmospheric": "공간감과 공기를 넓혀 장면의 배경을 만듭니다.",
  "Minimal start": "악기와 움직임을 줄여 담백하게 출발합니다.",
  "Cinematic start": "영화처럼 장면이 열리는 인상을 줍니다.",
  "Dreamy": "몽환적인 질감으로 흐릿하고 부유하는 느낌을 만듭니다.",
  "Tension setup": "초반부터 긴장감을 깔아 다음 전개를 준비합니다.",
  "Hook preview": "뒤에 나올 핵심 멜로디나 훅을 살짝 예고합니다.",
  "Vocal teaser": "목소리를 짧게 비춰 보컬 등장을 예고합니다.",
  "Instrumental start": "보컬 없이 악기 중심으로 곡을 엽니다.",
  "Fade in": "소리가 서서히 들어오며 자연스럽게 시작합니다.",
  "Ambient texture": "배경 질감과 잔향으로 분위기를 채웁니다.",
  "Quiet entrance": "조용하고 절제된 진입으로 몰입감을 만듭니다.",

  "Storytelling": "이야기와 장면 전달을 중심에 둡니다.",
  "Conversational": "대화하듯 자연스러운 말맛을 살립니다.",
  "Low energy": "에너지를 낮춰 차분하고 눌린 흐름을 만듭니다.",
  "Intimate": "가까이 말하는 듯한 사적인 느낌을 줍니다.",
  "Sparse": "요소를 비워 목소리와 가사가 더 잘 들리게 합니다.",
  "Rhythmic": "말과 멜로디의 리듬감을 또렷하게 살립니다.",
  "Scene setting": "장소와 상황이 먼저 보이도록 장면을 세웁니다.",
  "Detailed narrative": "작은 디테일로 이야기를 구체적으로 풀어갑니다.",
  "Emotional restraint": "감정을 터뜨리지 않고 절제해서 표현합니다.",
  "Spoken feel": "노래보다 말하듯 붙는 전달감을 만듭니다.",
  "Tension building": "구간 안에서 긴장과 기대를 천천히 쌓습니다.",
  "Melodic flow": "멜로디 흐름을 부드럽고 자연스럽게 이어줍니다.",

  "Build-up": "다음 큰 구간을 향해 힘을 끌어올립니다.",
  "Rising tension": "긴장감을 점점 높여 몰입을 키웁니다.",
  "Emotional lift": "감정선을 위로 끌어올려 후렴 진입을 준비합니다.",
  "Vocal climb": "보컬 음역과 표현을 점점 높여 고조시킵니다.",
  "Anticipation": "곧 터질 듯한 기대감을 만듭니다.",
  "Soft to big": "작게 시작해 크게 확장되는 흐름을 만듭니다.",
  "Harmonic lift": "화성 변화로 밝아지거나 떠오르는 느낌을 줍니다.",
  "Breath-held": "숨을 참는 듯한 긴장과 정적을 만듭니다.",
  "Energy ramp": "리듬과 레이어를 늘려 에너지를 단계적으로 올립니다.",
  "Suspense": "다음 전개를 기다리게 하는 긴장감을 줍니다.",
  "Hook setup": "핵심 훅이 더 잘 터지도록 앞단을 정리합니다.",
  "Melodic rise": "선율을 위로 올리며 자연스럽게 고조시킵니다.",

  "Big hook": "후렴의 중심 멜로디를 크고 선명하게 만듭니다.",
  "Catchy hook": "한 번에 기억되는 중독성 있는 포인트를 만듭니다.",
  "Emotional release": "쌓인 감정을 풀어내는 시원한 해방감을 줍니다.",
  "Singalong": "따라 부르기 쉬운 합창형 흐름을 만듭니다.",
  "Wide lift": "소리 폭을 넓혀 크게 펼쳐지는 느낌을 줍니다.",
  "Explosive": "강하게 터지는 에너지와 임팩트를 만듭니다.",
  "Repeated phrase": "짧은 문구를 반복해 훅의 기억도를 높입니다.",
  "Anthemic": "웅장하고 다 함께 외치는 듯한 인상을 줍니다.",
  "Bright lift": "밝게 상승하는 에너지로 분위기를 끌어올립니다.",
  "Full band": "밴드 전체가 들어온 듯 풍성하게 채웁니다.",
  "Melodic climax": "선율의 최고점을 만들어 감정 피크를 줍니다.",
  "Memorable refrain": "곡을 대표하는 반복 구절을 또렷하게 남깁니다.",

  "Catchy loop": "짧은 반복으로 귀에 남는 루프를 만듭니다.",
  "Short hook": "간결한 포인트로 빠르게 각인시킵니다.",
  "Earworm": "머릿속에 계속 맴도는 중독성을 노립니다.",
  "Chant-like": "구호처럼 외치기 쉬운 리듬감을 만듭니다.",
  "Call back": "앞선 멜로디나 문구를 다시 불러 연결감을 줍니다.",
  "Simple phrase": "복잡하지 않은 한 줄 포인트로 기억도를 높입니다.",
  "Rhythmic hook": "박자감이 살아 있는 반복 포인트를 만듭니다.",
  "Vocal hook": "목소리 자체가 포인트가 되도록 보컬을 강조합니다.",
  "Melodic hook": "선율 중심의 반복 포인트를 선명하게 만듭니다.",
  "Punchy repeat": "짧고 강한 반복으로 타격감을 줍니다.",
  "Minimal hook": "최소한의 요소로 깔끔한 중독성을 만듭니다.",

  "Beat drop": "비트가 중심이 되어 확 떨어지는 전환을 만듭니다.",
  "Bass drop": "저음이 강하게 들어오며 무게감을 줍니다.",
  "Impact": "짧고 강한 타격으로 구간 전환을 강조합니다.",
  "Rhythmic drop": "리듬 변화로 몸이 반응하는 구간을 만듭니다.",
  "Synth hit": "신스 포인트로 전자적인 임팩트를 줍니다.",
  "Vocal chop": "보컬을 잘게 잘라 리듬 소스로 활용합니다.",
  "Minimal drop": "과하게 채우지 않고 절제된 드롭을 만듭니다.",
  "Dance drop": "춤추기 좋은 리듬 중심의 에너지를 줍니다.",
  "Dark drop": "어둡고 묵직한 전환감을 만듭니다.",
  "Bright drop": "밝고 시원하게 터지는 드롭을 만듭니다.",
  "Club energy": "클럽처럼 밀도 있는 리듬 에너지를 줍니다.",
  "Hook-driven": "드롭 안에서도 훅이 중심에 남도록 만듭니다.",

  "Mood shift": "분위기를 확 바꿔 곡의 흐름에 변화를 줍니다.",
  "Emotional turn": "감정 방향을 전환해 새로운 국면을 만듭니다.",
  "New perspective": "화자나 장면의 시선을 새롭게 바꿉니다.",
  "Quiet confession": "조용히 고백하듯 진심을 드러냅니다.",
  "Dramatic pause": "극적인 멈춤으로 다음 순간을 강조합니다.",
  "Tension release": "쌓인 긴장을 풀어 잠시 숨 쉴 공간을 만듭니다.",
  "Scene reversal": "장면의 의미나 관계를 반전시키는 느낌을 줍니다.",
  "Dreamlike shift": "현실감이 흐려지는 몽환적 전환을 만듭니다.",
  "Vocal handoff": "한 보컬에서 다른 보컬로 자연스럽게 넘깁니다.",
  "Rebuild": "줄였던 에너지를 다시 쌓아 올립니다.",
  "Key-change feel": "키가 바뀐 듯한 상승감과 새로움을 줍니다.",
  "Final setup": "마지막 큰 구간으로 가기 위한 준비감을 만듭니다.",

  "Energy drop": "힘을 빼서 대비되는 낮은 구간을 만듭니다.",
  "Minimal reset": "편곡을 줄여 흐름을 다시 정리합니다.",
  "Stripped down": "악기를 덜어내고 핵심만 남깁니다.",
  "Half-time feel": "박자를 느리게 체감시켜 무게감을 줍니다.",
  "Tension hold": "긴장을 풀지 않고 눌러 유지합니다.",
  "Low drums": "낮고 절제된 드럼으로 바닥감을 만듭니다.",
  "Bass focus": "저음을 중심에 두어 묵직한 흐름을 만듭니다.",
  "Sparse texture": "빈 공간이 느껴지는 성긴 질감을 만듭니다.",
  "Dark reset": "어두운 분위기로 다시 가라앉힙니다.",
  "Quiet collapse": "조용히 무너지는 듯한 감정 하강을 만듭니다.",
  "Rebuild start": "다시 고조되기 전 첫 발판을 만듭니다.",
  "Contrast": "앞뒤 구간과 확실한 대비를 만듭니다.",

  "Lead solo": "주선율 악기가 앞에 나와 중심을 잡습니다.",
  "Guitar lead": "기타 선율을 앞세워 존재감을 줍니다.",
  "Synth lead": "신스 리드로 또렷한 멜로디 포인트를 만듭니다.",
  "Piano lead": "피아노 선율로 감정과 멜로디를 강조합니다.",
  "Sax lead": "색소폰 선율로 재즈스럽고 감성적인 포인트를 줍니다.",
  "String lead": "스트링 선율로 드라마틱한 감정을 더합니다.",
  "Improvised feel": "즉흥 연주처럼 자유로운 움직임을 줍니다.",
  "Melodic solo": "멜로디가 분명한 연주 구간을 만듭니다.",
  "Expressive lead": "표현력 있는 리드 악기로 감정을 강조합니다.",
  "Short solo": "짧게 치고 빠지는 연주 포인트를 만듭니다.",
  "Emotional solo": "감정선을 살린 연주로 여운을 줍니다.",
  "Technical solo": "기교가 느껴지는 화려한 연주감을 줍니다.",

  "Tight flow": "박자에 딱 붙는 탄탄한 랩 흐름을 만듭니다.",
  "Punchy flow": "강한 발음과 리듬으로 타격감을 줍니다.",
  "Fast rhythm": "빠른 박자감으로 긴장과 속도를 만듭니다.",
  "Laid-back": "박자 뒤에 느슨하게 걸치는 여유를 줍니다.",
  "Off-beat flow": "정박을 살짝 비껴가는 독특한 리듬감을 만듭니다.",
  "Conversational rap": "말하듯 자연스럽게 이어지는 랩을 만듭니다.",
  "Dry spoken rap": "건조하고 담담한 말투의 랩 느낌을 줍니다.",
  "Melodic rap": "랩 안에 선율감을 섞어 부드럽게 연결합니다.",
  "Aggressive": "공격적인 에너지와 강한 전달감을 줍니다.",
  "Playful": "장난스럽고 가벼운 리듬감을 만듭니다.",
  "Call and response": "주고받는 응답 구조로 대화감을 만듭니다.",
  "Character switch": "화자나 캐릭터가 바뀌는 느낌을 줍니다.",

  "Soft ending": "부드럽게 마무리해 여운을 남깁니다.",
  "Fade out": "소리가 서서히 사라지며 끝납니다.",
  "Quiet ending": "조용히 내려앉는 마무리를 만듭니다.",
  "Echo finish": "마지막 소리의 잔향을 남깁니다.",
  "Emotional closure": "감정이 정리되는 완결감을 줍니다.",
  "Open ending": "완전히 닫지 않고 여지를 남깁니다.",
  "Last phrase": "마지막 한 줄을 강조해 기억에 남깁니다.",
  "Minimal ending": "최소한의 소리로 깔끔하게 끝냅니다.",
  "Gradual exit": "천천히 빠져나가듯 자연스럽게 마무리합니다.",
  "Calm closure": "차분하고 안정적으로 곡을 닫습니다.",
  "Bittersweet": "달콤하지만 쓸쓸한 여운을 남깁니다.",
  "Loop-friendly": "반복 재생해도 자연스럽게 이어지게 합니다.",

  "Main motif": "곡을 대표하는 핵심 선율을 세웁니다.",
  "Soft motif": "부드러운 선율 아이디어로 테마를 잡습니다.",
  "Repeated motif": "반복되는 선율로 곡의 인상을 고정합니다.",
  "Emotional motif": "감정이 담긴 선율 아이디어를 강조합니다.",
  "Melodic idea": "짧은 선율 아이디어를 중심에 둡니다.",
  "Contrast idea": "다른 구간과 대비되는 새 아이디어를 넣습니다.",
  "Variation": "기존 테마를 살짝 바꿔 변화를 줍니다.",
  "Scene motif": "특정 장면을 떠올리게 하는 선율을 만듭니다.",
  "Character motif": "특정 인물이나 화자의 테마감을 줍니다.",
  "Memory cue": "회상처럼 느껴지는 작은 선율 단서를 만듭니다.",
  "Motif return": "앞서 나온 테마를 다시 불러 연결감을 줍니다.",

  "Rising drums": "드럼이 점점 올라오며 추진력을 만듭니다.",
  "Layer increase": "소리 레이어를 늘려 점점 풍성하게 만듭니다.",
  "Tension rise": "긴장감을 위로 끌어올립니다.",
  "Snare lift": "스네어 빌드로 드롭 전 상승감을 줍니다.",
  "Vocal lift": "보컬 에너지를 위로 올려 고조감을 만듭니다.",
  "Pre-drop lift": "드롭 직전 기대감을 강하게 만듭니다.",
  "Dramatic swell": "소리가 부풀어 오르는 극적인 상승을 만듭니다.",
  "Gradual build": "천천히 단계적으로 커지는 전개를 만듭니다.",
  "Fast build": "빠르게 몰아쳐 짧은 시간 안에 고조시킵니다.",
  "Controlled rise": "과하지 않게 정돈된 상승감을 줍니다.",
  "Final push": "마지막으로 힘을 밀어 올리는 느낌을 줍니다.",

  "Signature melody": "곡의 얼굴이 되는 선명한 멜로디를 만듭니다.",
  "Strong melody": "힘 있고 분명한 선율을 강조합니다.",
  "Emotional lead": "감정을 이끄는 주선율을 앞세웁니다.",
  "Full theme": "테마를 온전히 펼쳐 곡의 중심을 보여줍니다.",
  "Repeated theme": "테마를 반복해 인상을 깊게 남깁니다.",
  "Hero melody": "주인공처럼 돋보이는 큰 멜로디를 만듭니다.",
  "Cinematic lead": "영화음악처럼 선명한 리드 선율을 줍니다.",
  "Clear motif": "구분이 쉬운 또렷한 테마 단서를 만듭니다.",
  "Wide theme": "넓게 펼쳐지는 스케일감 있는 테마를 만듭니다.",
  "Memorable line": "기억에 남는 한 줄 선율을 강조합니다.",
  "Theme return": "테마가 다시 돌아오며 완성감을 줍니다.",

  "Peak energy": "곡의 에너지를 최고점까지 끌어올립니다.",
  "Full impact": "모든 요소가 한 번에 크게 들어오는 힘을 줍니다.",
  "Final release": "마지막 감정 해방을 강하게 만듭니다.",
  "Emotional peak": "감정의 최고점을 분명하게 찍습니다.",
  "Big lift": "크게 떠오르는 상승감을 만듭니다.",
  "Maximum tension": "긴장감을 가장 높은 상태로 끌어올립니다.",
  "Grand moment": "웅장하고 중요한 순간처럼 들리게 합니다.",
  "Explosive hit": "폭발하듯 강한 타격 포인트를 만듭니다.",
  "Vocal peak": "보컬이 가장 크게 돋보이는 순간을 만듭니다.",
  "Full arrangement": "편곡 전체를 채워 가장 풍성한 구간을 만듭니다.",
  "Dramatic high": "극적인 고점과 강한 감정 상승을 줍니다.",
  "Last burst": "끝나기 전 마지막 폭발감을 만듭니다.",

  "Short break": "짧게 흐름을 끊고 다음 구간으로 넘깁니다.",
  "Drum break": "드럼 중심의 짧은 전환을 만듭니다.",
  "Silence gap": "순간적인 여백으로 다음 구간을 강조합니다.",
  "Transition break": "다음 섹션으로 자연스럽게 넘어갑니다.",
  "Sudden stop": "갑자기 멈추는 정지감을 만듭니다.",
  "Hard stop": "강하게 끊기는 컷 효과를 만듭니다.",
  "Beat stop": "비트가 순간적으로 멈추는 느낌을 줍니다.",
  "Comic pause": "코믹한 타이밍의 짧은 정지를 만듭니다."
};
