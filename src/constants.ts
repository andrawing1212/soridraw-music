...
export const STYLE_CYCLES: SoundStyleCycle[] = [
  ...
  // SORIDRAW_STYLE_CATEGORY_RECLASS_V11: EDM build-up and selected groove items moved to Mood Transition, Groove renamed to 그루브 리듬감, 70s-Disco label fixed.
  {
    ...
    variants: [
      ...
      { id: 'swing-feel', label: 'Swing / Jazz', labelKo: '스윙 / 재즈', description: 'Swing-like rhythmic looseness and motion.', descriptionKo: '스윙 특유의 느슨하고 유연한 리듬감을 더합니다. (Swing / Jazz)', style: 'swing-aware rhythmic motion', sound: 'loose offbeat accents', mood: 'playful, stylish' },
      ...
      { id: 'rnb-groove-bounce', label: 'Contemporary R&B', labelKo: '컨템퍼러리 R&B', description: 'Smooth R&B pocket and flexible groove.', descriptionKo: '부드럽고 유연한 R&B 그루브를 더합니다. (Contemporary R&B)', style: 'smooth R&B rhythmic pocket', sound: 'laid-back drums and flexible groove', mood: 'smooth, sensual' },
      ...
      { id: 'fusion-pbrnb', label: 'PBR&B', labelKo: 'PBR&B', description: 'Alternative R&B color with atmospheric electronic texture.', descriptionKo: '몽환적인 전자 질감이 섞인 얼터너티브 R&B 색채입니다. (PBR&B)', style: 'PBR&B fusion', sound: 'moody synth pads, sparse R&B drums, deep sub bass', mood: 'moody, atmospheric' }
    ],
  },
  {
    id: 'space-texture',
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'easy-sing-chorus', label: 'Easy-sing Chorus', labelKo: '따라 부르는 후렴', description: 'A chorus with simple phrasing for easy singing.', descriptionKo: '누구나 따라 부르기 쉬운 후렴 구조입니다. (Easy-sing Chorus)', style: 'easy-to-sing chorus', sound: 'simple vocal spacing', mood: 'friendly, accessible' },
      ...
      { id: 'earworm-chorus', label: 'Earworm Chorus', labelKo: '귀에 남는 후렴', description: 'A chorus designed for strong earworm effect.', descriptionKo: '계속 머릿속에 맴도는 후렴감을 강화합니다. (Earworm Chorus)', style: 'earworm chorus writing', sound: 'sticky melodic contour', mood: 'catchy, addictive' },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'uptempo-bounce', label: 'Uptempo Bounce', labelKo: '업템포 탄력', description: 'Fast, energetic rhythmic lift.', descriptionKo: '빠르고 탄력 있는 업템포 움직임을 더합니다. (Uptempo Bounce)', style: 'uptempo rhythmic bounce', sound: 'energetic drum drive', mood: 'bright, lively' },
      { id: 'rhythmic-development', label: 'Rhythmic Development', labelKo: '리듬감 있는 전개', description: 'Arrangement develops through rhythmic motion.', descriptionKo: '리듬의 변화로 곡 전개를 살리는 스타일입니다. (Rhythmic Development)', style: 'rhythm-led development', sound: 'sectional rhythmic changes', mood: 'moving, dynamic' },
      { id: 'staccato-rhythm', label: 'Staccato Rhythm', labelKo: '끊어치는 리듬', description: 'Sharp, short rhythmic articulation.', descriptionKo: '짧고 또렷하게 끊어치는 리듬감을 더합니다. (Staccato Rhythm)', style: 'staccato rhythmic articulation', sound: 'tight short accents', mood: 'sharp, precise' },
      { id: 'hard-rap-flow', label: 'Hard Rap Flow', labelKo: '하드 랩 플로우', description: 'Harder rap energy with stronger rhythmic attack.', descriptionKo: '강한 어택감의 랩 플로우를 더합니다. (Hard Rap Flow)', style: 'hard rap flow emphasis', sound: 'aggressive rhythmic phrasing', mood: 'intense, bold' },
      { id: 'aggressive-rap', label: 'Aggressive Rap', labelKo: '공격적인 랩', description: 'Forceful rap sections with aggressive phrasing.', descriptionKo: '공격적인 랩 파트를 강화합니다. (Aggressive Rap)', style: 'aggressive rap section energy', sound: 'sharp vocal attack over hard drums', mood: 'angry, powerful' },
      ...
      { id: 'theatrical-idol-shift', label: 'Theatrical Idol Shift', labelKo: '극장형 아이돌 전환', description: 'Idol-pop performance shifts like a theatrical scene.', descriptionKo: '아이돌 무대가 극장처럼 장면 전환되는 스타일입니다. (Theatrical Idol Shift)', style: 'theatrical idol-pop shift', sound: 'stage hits, bright hooks, sudden darker sections', mood: 'dramatic, playful' },
      { id: 'separator-style-shift-horror-dark', kind: 'separator', label: '호러/다크 전환', labelKo: '호러/다크 전환', description: '', descriptionKo: '', promptCore: '' },
      { id: 'horror-pop', label: 'Horror Pop', labelKo: '호러팝', description: 'Pop structure colored with psychological horror tension.', descriptionKo: '팝 구조 위에 심리공포와 불안을 얹는 스타일입니다. (Horror Pop)', style: 'horror-pop tension', sound: 'eerie synth stabs, low pulses, unsettling accents', mood: 'creepy, anxious' },
      { id: 'psycho-horror-shift', label: 'Psychological Horror Shift', labelKo: '심리공포 전환', description: 'A psychological horror turn hidden inside pop performance.', descriptionKo: '밝은 곡 안에 심리공포가 갑자기 드러나는 전환입니다. (Psychological Horror Shift)', style: 'psychological horror transition', sound: 'low drones, eerie accents, sudden silence', mood: 'disturbing, tense' },
      { id: 'dark-trap-switch', label: 'Dark Trap Switch', labelKo: '다크트랩 전환', description: 'Bright pop sections switch into dark trap drops.', descriptionKo: '밝은 구간이 묵직한 다크 트랩으로 꺾이는 전환입니다. (Dark Trap Switch)', style: 'abrupt dark trap switch', sound: 'heavy 808, sharp hi-hats, sudden beat drops', mood: 'tense, menacing' },
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'shuffle-rhythm', label: 'Shuffle Rhythm', labelKo: '셔플 리듬', description: 'Shuffle rhythm with rolling movement.', descriptionKo: '구르는 듯한 셔플 리듬감을 더합니다. (Shuffle Rhythm)', style: 'shuffle rhythmic movement', sound: 'rolling groove feel', mood: 'easygoing, rhythmic' },
      { id: 'bounce-feel', label: 'Bounce Feel', labelKo: '바운스감', description: 'A bouncy, elastic rhythmic feel.', descriptionKo: '몸이 자연스럽게 움직이는 바운스감을 더합니다. (Bounce Feel)', style: 'bouncy rhythmic feel', sound: 'elastic groove and playful accents', mood: 'light, groovy' },
      ...
      { id: 'loose-rap-groove', label: 'Loose Rap Groove', labelKo: '느슨한 랩 그루브', description: 'Relaxed rap rhythm with a loose pocket.', descriptionKo: '느슨하게 흐르는 랩 그루브를 더합니다. (Loose Rap Groove)', style: 'loose rap groove', sound: 'laid-back beat pocket', mood: 'cool, relaxed' },
      { id: 'groovy-flow', label: 'Groovy Flow', labelKo: '그루비한 흐름', description: 'A continuous groove that keeps the track moving.', descriptionKo: '곡 전체를 자연스럽게 밀어주는 그루브 흐름입니다. (Groovy Flow)', style: 'continuous groovy flow', sound: 'smooth rhythmic continuity', mood: 'steady, stylish' },
      { id: 'separator-style-groove-tight-dance', kind: 'separator', label: '타이트/댄스', labelKo: '타이트/댄스', description: '', descriptionKo: '', promptCore: '' },
      { id: 'tight-rhythm', label: 'Tight Rhythm', labelKo: '타이트한 리듬', description: 'Precise rhythm with clean punch.', descriptionKo: '정확하고 선명하게 맞물리는 타이트한 리듬입니다. (Tight Rhythm)', style: 'tight rhythmic precision', sound: 'clean punchy rhythm section', mood: 'controlled, crisp' },
...
export const SOUND_TEXTURE_CYCLES = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'children-choir', label: "Children's Choir", labelKo: '아이들 합창', description: "children's choir - 아이들이 함께 부르는 맑고 순수한 합창입니다.", descriptionKo: "children's choir - 아이들이 함께 부르는 맑고 순수한 합창입니다.", promptCore: "children's choir" },
      ...
      { id: 'call-and-response', label: 'Call and Response', labelKo: '콜앤리스폰스', description: 'call and response - 한쪽이 부르면 다른 쪽이 받아치는 보컬 구조입니다.', descriptionKo: 'call and response - 한쪽이 부르면 다른 쪽이 받아치는 보컬 구조입니다.', promptCore: 'call and response' },
      ...
      { id: 'la-la-chorus', label: 'La-la Chorus', labelKo: '라라라 코러스', description: 'la-la chorus - 라라라처럼 따라 부르기 쉬운 코러스입니다.', descriptionKo: 'la-la chorus - 라라라처럼 따라 부르기 쉬운 코러스입니다.', promptCore: 'la-la chorus' },
