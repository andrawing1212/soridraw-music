...
export const STYLE_CYCLES: SoundStyleCycle[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'vocal-tossed-off', label: 'Tossed-off Vocal Feel', labelKo: '툭 던지는 표현', description: 'Casual vocal phrasing that sounds emotionally understated.', descriptionKo: '감정을 과하게 밀지 않고 툭 놓고 부르는 느낌입니다. (Tossed-off Vocal Feel)', style: 'tossed-off vocal phrasing', sound: 'understated vocal delivery', mood: 'dry, casual' },
      ...
      { id: 'vocal-spoken-singing', label: 'Spoken-singing Feel', labelKo: '말하듯 부름', description: 'Vocal phrasing that sits between speech and melody.', descriptionKo: '대사처럼 말하듯 부르는 표현감입니다. (Spoken-singing Feel)', style: 'spoken-singing vocal style', sound: 'speech-like melodic phrasing', mood: 'conversational, direct' },
      { id: 'vocal-reciting', label: 'Reciting Vocal Feel', labelKo: '읊조리듯 부름', description: 'Poetic vocal phrasing that feels quietly recited.', descriptionKo: '시를 읊조리듯 낮게 흐르는 보컬 표현입니다. (Reciting Vocal Feel)', style: 'reciting vocal phrasing', sound: 'quiet narrative vocal flow', mood: 'poetic, calm' },
      ...
      { id: 'vocal-offbeat-push-pull', label: 'Off-beat Push-pull Feel', labelKo: '엇박자로 밀고 당기는', description: 'Rhythmic vocal phrasing that pushes and pulls around the beat.', descriptionKo: '박자를 살짝 밀고 당기며 리듬감 있게 부르는 표현입니다. (Off-beat Push-pull Feel)', style: 'off-beat vocal phrasing with rhythmic push and pull', sound: 'syncopated vocal timing with tight rhythmic movement', mood: 'witty, groovy' },
      { id: 'vocal-laidback-behind-beat', label: 'Laid-back Vocal Timing', labelKo: '뒤로 살짝 눕혀 부르는', description: 'Relaxed behind-the-beat vocal phrasing with a loose groove.', descriptionKo: '박자보다 살짝 뒤에 기대듯 여유롭게 부르는 표현입니다. (Laid-back Vocal Timing)', style: 'laid-back behind-the-beat vocal phrasing', sound: 'loose vocal timing with relaxed groove', mood: 'cool, relaxed' },
      ...
      { id: 'vocal-rounded-mouthy', label: 'Rounded Mouthy Phrasing', labelKo: '입안에서 굴리듯 부르는', description: 'Rounded vocal phrasing with soft mouth-shaped groove.', descriptionKo: '소리를 입안에서 부드럽게 굴리듯 처리하는 표현입니다. (Rounded Mouthy Phrasing)', style: 'rounded mouthy vocal phrasing with soft groove', sound: 'rounded vowel movement with mellow phrasing', mood: 'sensual, smooth' },
      { id: 'vocal-silky-connected', label: 'Silky Connected Phrasing', labelKo: '부드럽게 이어 부르는', description: 'Silky connected vocal phrasing with smooth line-to-line flow.', descriptionKo: '음과 음을 끊지 않고 매끄럽게 이어 부르는 표현입니다. (Silky Connected Phrasing)', style: 'silky connected vocal phrasing with mellow flow', sound: 'legato vocal connection with smooth transitions', mood: 'warm, flowing' },
      ...
      { id: 'vocal-slurred-ending-phrasing', label: 'Slurred Ending Phrasing', labelKo: '끝음을 흘리는', description: 'A vocal habit that lets phrase endings trail off without a clean finish.', descriptionKo: '문장 끝음을 또렷하게 닫지 않고 흘리듯 마무리하는 습관입니다. (Slurred Ending Phrasing)', style: 'slurred ending vocal phrasing', sound: 'soft trailing word endings', mood: 'loose, weary' },
      { id: 'vocal-unstable-pitch-feel', label: 'Unstable Pitch Feel', labelKo: '음이 살짝 흔들리는', description: 'A slightly unstable pitch feel that makes the voice sound emotionally unsteady.', descriptionKo: '음정이 완전히 고정되지 않고 살짝 흔들리는 불안정한 느낌입니다. (Unstable Pitch Feel)', style: 'slightly unstable pitch vocal feel', sound: 'subtle wavering pitch detail', mood: 'anxious, fragile' },
      { id: 'vocal-off-pitch-feel', label: 'Off-pitch Vocal Feel', labelKo: '음정을 놓치는 듯한', description: 'A deliberately imperfect vocal feel that sounds like some notes are not fully reached.', descriptionKo: '일부 음을 정확히 맞추지 못하는 듯한 서툰 보컬 느낌입니다. (Off-pitch Vocal Feel)', style: 'imperfect off-pitch vocal feel', sound: 'slightly missed note edges', mood: 'awkward, human' },
      { id: 'vocal-careless-humming-feel', label: 'Careless Humming Feel', labelKo: '대충 흥얼거리는', description: 'A casual vocal habit that sounds like loose, careless humming rather than polished singing.', descriptionKo: '힘을 주지 않고 대충 흥얼거리듯 부르는 습관입니다. (Careless Humming Feel)', style: 'careless humming vocal feel', sound: 'loose low-effort humming texture', mood: 'casual, detached' },
      { id: 'vocal-nasal-sick-voice', label: 'Nasal Sick Voice', labelKo: '감기 걸린 듯한', description: 'A nasal, congested vocal color like the singer has a cold.', descriptionKo: '코가 막히거나 감기 걸린 듯 답답하고 탁한 목소리 느낌입니다. (Nasal Sick Voice)', style: 'nasal sick vocal tone', sound: 'congested nasal vocal color', mood: 'tired, muted' },
      { id: 'vocal-mumbled-pronunciation', label: 'Mumbled Pronunciation', labelKo: '발음이 흐릿한', description: 'A vocal habit with blurred pronunciation and words softened inside the mouth.', descriptionKo: '발음을 또렷하게 하지 않고 입안에서 뭉개듯 부르는 느낌입니다. (Mumbled Pronunciation)', style: 'mumbled vocal pronunciation', sound: 'blurred consonants and mouthy word edges', mood: 'shy, withdrawn' },
      { id: 'vocal-fading-word-endings', label: 'Fading Word Endings', labelKo: '말끝이 사라지는', description: 'A vocal habit where the end of each phrase gets smaller and fades away.', descriptionKo: '말끝이 점점 작아지며 사라지는 듯한 보컬 습관입니다. (Fading Word Endings)', style: 'fading word endings', sound: 'vanishing phrase tails', mood: 'uncertain, wistful' },
      { id: 'vocal-short-breath-delivery', label: 'Short-breath Delivery', labelKo: '숨이 모자란 듯한', description: 'A breath-short vocal habit that feels like the singer runs out of air between lines.', descriptionKo: '숨이 부족해서 문장 중간중간 끊기는 듯한 표현입니다. (Short-breath Delivery)', style: 'short-breath vocal delivery', sound: 'breath-starved line breaks', mood: 'nervous, pressured' },
      { id: 'vocal-unconfident-feel', label: 'Unconfident Vocal Feel', labelKo: '자신 없이 부르는', description: 'A small, uncertain vocal habit with cautious and unconfident delivery.', descriptionKo: '확신 없이 조심스럽고 작게 부르는 느낌입니다. (Unconfident Vocal Feel)', style: 'unconfident cautious vocal delivery', sound: 'small hesitant vocal attack', mood: 'timid, vulnerable' },
      ...
      { id: 'vocal-wobbly-pitch-feel', label: 'Wobbly Pitch Feel', labelKo: '삐걱대는 음정', description: 'A wobbly pitch habit with slightly shaky and imperfect note control.', descriptionKo: '음정이 미세하게 흔들리며 불안정하게 들리는 표현입니다. (Wobbly Pitch Feel)', style: 'wobbly pitch vocal feel', sound: 'shaky imperfect note control', mood: 'unstable, raw' },
...
export const STYLE_GROUPS = [
  ...
  { id: 'special-effects', label: 'Special Effects', labelKo: '특수효과', descriptionKo: '메인 보컬 목소리 자체에 특수한 보이스 톤을 더해요.', cycleIds: ['special-effects'] },
