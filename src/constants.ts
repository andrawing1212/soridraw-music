...
export const STYLE_CYCLES: SoundStyleCycle[] = [
  // SORIDRAW_STYLE_GROOVE_SOUND_RECLASS_V9: left-side style categories keep real genre items; groove feel gets its own category; sound/instrument texture items move to Sound.
    ...
    variants: [
      ...
      { id: 'fusion-study-beats', label: 'Study Beats', labelKo: '스터디 비트', description: 'Low-pressure study-beat hybrid with calm focus and soft repetition.', descriptionKo: '차분한 집중감과 저자극 반복 그루브를 장르 색으로 더하는 스터디 비트 하이브리드입니다. (Study Beats)', style: 'Study Beats fusion', sound: 'soft drums, mellow keys, low-pressure loop', mood: 'calm, focused' },
  ...
  },
  {
    ...
    descriptionKo: '기본은 핵심 훅만 유지하고 주변 가사를 이야기 흐름에 맞게 발전시킵니다. 전체 후렴을 반복하려면 ‘고정 후렴’을 선택합니다.',
    variants: [
      { id: 'separator-style-hook-form', kind: 'separator', label: 'Hook Form', labelKo: '훅 형태', description: '', descriptionKo: '', promptCore: '' },
      { id: 'short-hook-repeat', label: 'Short Hook Repeat', labelKo: '짧은 훅 반복', description: 'The same complete compact hook line opens every chorus twice.', descriptionKo: '짧은 완성 훅을 모든 후렴 첫머리에서 같은 문장으로 두 번 연속 반복합니다. (예: “오늘은 달라” → “오늘은 달라”)', style: 'short repeated hook', sound: 'tight hook loop', mood: 'simple, catchy' },
      { id: 'repeated-slogan', label: 'Repeated Slogan', labelKo: '반복되는 구호', description: 'A slogan-like phrase remains recognizable across every chorus and grows in the final return.', descriptionKo: 'Story Context에서 외치기 쉬운 짧은 구호를 만들고 모든 후렴에서 유지하며 마지막 후렴에서 더 강하게 확장합니다. (예: “다시 시작해!”)', style: 'repeated slogan hook', sound: 'chantable phrase repetition', mood: 'bold, performative' },
      { id: 'one-line-hook', label: 'One-line Hook', labelKo: '한 줄 훅', description: 'One complete lyric line becomes the emotional and structural anchor.', descriptionKo: '한 개의 완성된 문장을 곡의 중심 훅으로 삼고 다른 후렴 가사가 그 의미를 받쳐주도록 설계합니다.', style: 'one-line hook focus', sound: 'minimal hook anchor', mood: 'direct, memorable' },
      { id: 'one-word-hook', label: 'One-word Hook', labelKo: '한 단어 훅', description: 'A separate one-token micro hook repeats rhythmically inside every chorus.', descriptionKo: '한 단어·숫자·짧은 음절을 별도 훅으로 만들고 모든 후렴 안에서 리듬감 있게 3~4번 반복합니다. (예: “가자, 가자, 가자”)', style: 'one-word hook focus', sound: 'single-word rhythmic hook', mood: 'minimal, bold' },
      { id: 'melody-hook', label: 'Melody Hook', labelKo: '멜로디 훅', description: 'A compact lyric phrase is shaped for one clear, repeatable melodic contour.', descriptionKo: '짧고 열린 발음의 문구를 선명한 선율에 얹기 쉽게 설계합니다. 실제 선율 기억성은 생성된 음원에서 확인합니다.', style: 'melodic hook focus', sound: 'clear melodic motif', mood: 'singable, polished' },

      { id: 'separator-style-hook-placement', kind: 'separator', label: 'Hook Placement', labelKo: '훅 배치', description: '', descriptionKo: '', promptCore: '' },
      { id: 'chorus-first-line-anchor', label: 'First-line Chorus Anchor', labelKo: '후렴 첫줄 앵커', description: 'Every chorus opens with the same compact anchor line.', descriptionKo: '모든 후렴의 첫 줄에 같은 핵심 문구를 배치해 시작과 동시에 훅을 인식시킵니다.', style: 'chorus first-line anchor', sound: 'immediate hook entrance', mood: 'direct, memorable' },
      { id: 'chorus-end-line-anchor', label: 'End-line Chorus Anchor', labelKo: '후렴 끝줄 앵커', description: 'Every chorus resolves on the same compact anchor line.', descriptionKo: '모든 후렴의 마지막 줄을 같은 핵심 문구로 닫아 끝의 여운 자체를 훅으로 만듭니다.', style: 'chorus end-line anchor', sound: 'hooked closing cadence', mood: 'resolving, memorable' },
      { id: 'hook-preview', label: 'Hook Preview', labelKo: '훅 선공개', description: 'A shorter incomplete fragment appears before the first full chorus.', descriptionKo: '첫 Pre-Chorus 끝에서 훅의 짧은 조각을 먼저 들려주고 첫 Chorus에서 완성된 훅을 공개합니다.', style: 'pre-chorus hook preview', sound: 'teased hook motif before full chorus', mood: 'anticipating, familiar' },
      { id: 'post-chorus-tag', label: 'Post-Chorus Tag', labelKo: '포스트코러스 태그', description: 'A short secondary tag remains immediately after the chorus.', descriptionKo: '후렴 직후 짧은 두 번째 기억 문구를 남깁니다. Post-Chorus가 없으면 기존 Chorus 끝에 붙입니다. (예: “Oh-oh”)', style: 'short post-chorus tag', sound: 'bonus hook after chorus', mood: 'sticky, lingering' },
      { id: 'circular-refrain', label: 'Circular Refrain', labelKo: '순환 리프레인', description: 'The same short line frames each chorus or returns across existing sections.', descriptionKo: '같은 짧은 문구를 서로 떨어진 기존 구간에 다시 배치합니다. Refrain이 있으면 그 구간을 우선하고, 없으면 Intro·핵심 후렴·Outro에서 순환합니다.', style: 'circular returning refrain', sound: 'recurring frame line', mood: 'hypnotic, cohesive' },

      { id: 'separator-style-hook-repeat', kind: 'separator', label: 'Repetition Curve', labelKo: '반복 방식', description: '', descriptionKo: '', promptCore: '' },
      { id: 'fixed-chorus', label: 'Fixed Chorus', labelKo: '고정 후렴', description: 'The complete Chorus 1 lyric body repeats unchanged in Chorus 2 and Final Chorus while performance and production may grow.', descriptionKo: 'Chorus 1의 전체 가사 본문을 Chorus 2와 Final Chorus에서도 그대로 유지합니다. 보컬·화음·편곡 에너지만 확장할 수 있습니다.', style: 'fixed chorus lyric body', sound: 'same chorus lyrics with evolving performance', mood: 'familiar, stable' },
      { id: 'progressive-hook-repeat', label: 'Progressive Hook Repeat', labelKo: '점층 반복', description: 'The hook grows from first introduction to a stronger final payoff.', descriptionKo: '같은 훅을 후렴이 돌아올수록 반복·응답·화음으로 더 크게 키웁니다. (예: 솔로 → 응답 → 합창)', style: 'progressive hook repetition', sound: 'increasing repeat density', mood: 'building, addictive' },
      { id: 'variation-hook-repeat', label: 'Variation Repeat', labelKo: '변형 반복', description: 'The hook identity stays recognizable while a controlled detail changes each return.', descriptionKo: '훅의 리듬과 골격은 유지하고 돌아올 때 핵심 단어·응답만 조금씩 자연스럽게 바꿉니다.', style: 'recognizable hook with controlled variation', sound: 'repeated rhythmic cell with changing detail', mood: 'familiar, evolving' },
      ...
      { id: 'chant-hook', label: 'Chant Hook', labelKo: '챈트 훅', description: 'A short hook is delivered with simple rhythmic accents like a chant.', descriptionKo: '짧은 훅을 박자에 맞춰 끊어 외치는 챈트로 설계합니다. (예: “더 높이! 더 크게!”)', style: 'chant-like hook', sound: 'rhythmic vocal chant accents', mood: 'energetic, bold' },
      { id: 'call-response-hook', label: 'Call-response Hook', labelKo: '콜앤리스폰스 훅', description: 'A lead call and a different answer line create the hook.', descriptionKo: '리드의 질문·호출에 다른 보컬이나 응답형 레이어가 의미가 다른 짧은 문장으로 답합니다. 2인 이상 보컬 또는 응답 레이어가 필요합니다. (예: “갈 준비 됐어?” → “지금 가!”)', style: 'call-response hook movement', sound: 'alternating vocal hook accents', mood: 'interactive, playful' },
      { id: 'echo-response-hook', label: 'Echo-response Hook', labelKo: '메아리 응답 훅', description: 'A lead hook is followed by a shorter echo fragment of the same phrase.', descriptionKo: '리드 훅 뒤에 마지막 단어나 짧은 조각이 메아리처럼 따라옵니다. 공간 효과가 아닌 가사·보컬 응답입니다. (예: “달려가” → “가, 가”)', style: 'echo-response lyric hook', sound: 'short vocal echo answer', mood: 'interactive, sticky' },
      { id: 'easy-sing-chorus', label: 'Easy-sing Chorus', labelKo: '따라 부르는 후렴', description: 'Simple syntax, open vowels, and stable line lengths make the lead chorus easy to join.', descriptionKo: '짧은 문장, 쉬운 어휘, 열린 발음, 일정한 호흡으로 처음 듣는 사람도 따라 부르기 쉽게 만듭니다.', style: 'chorus-only easy singalong hook', sound: 'chorus hook spacing', mood: 'friendly, accessible' },
      ...
      { id: 'split-chorus-ab', label: 'A/B Split Chorus', labelKo: 'A/B 분할 후렴', description: 'Two contrasting halves complete one hook idea.', descriptionKo: 'Chorus A가 상황이나 질문을 제시하고 Chorus B가 응답이나 감정 결론을 완성하도록 두 덩어리로 나눕니다.', style: 'two-part A/B chorus hook', sound: 'contrasting chorus halves', mood: 'dynamic, complete' },
      { id: 'drop-hook', label: 'Drop Hook', labelKo: '드롭 훅', description: 'A compact lyric fragment locks to an existing Drop section or beat impact.', descriptionKo: '기존 Drop이 있으면 그 구간에 짧은 훅을 결합합니다. Drop이 없으면 새 섹션 없이 첫 번째 적합한 핵심 구간 끝에 내장형 드롭 훅으로 배치합니다.', style: 'drop-centered vocal hook', sound: 'compact lyric fragment on beat impact', mood: 'physical, immediate' },
      { id: 'anti-chorus', label: 'Anti-Chorus', labelKo: '안티코러스', description: 'The chorus becomes deliberately smaller or barer than the build.', descriptionKo: 'Pre-Chorus가 상승한 뒤 Chorus는 오히려 짧고 조용하게 비우고 하나의 강한 훅 문장만 남깁니다. 실제 대비는 생성된 음원에서 확인합니다.', style: 'sparse anti-chorus contrast', sound: 'reduced chorus impact with one anchor', mood: 'unexpected, intimate' },
      { id: 'negative-space-hook', label: 'Negative-space Hook', labelKo: '여백 훅', description: 'A short hook is framed by a deliberate breath, pause, or instrumental gap.', descriptionKo: '짧은 훅 앞뒤에 쉼·호흡·연주 여백을 두어 문구를 더 크게 들리게 합니다. 실제 공간감은 생성된 음원에서 확인합니다.', style: 'negative-space hook design', sound: 'hook framed by a brief pause', mood: 'minimal, striking' }
    ],
  },
  {
    id: 'groove-flow',
...
export const SOUND_TEXTURE_CYCLES = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'warm-amp', label: 'Warm Amp Texture', labelKo: '따뜻한 앰프', description: 'warm amp - 앰프에서 나오는 따뜻한 기타 질감입니다. (Indie Rock, Blues, Soft Rock)', descriptionKo: 'warm amp - 앰프에서 나오는 따뜻한 기타 질감입니다. (Indie Rock, Blues, Soft Rock)', promptCore: 'warm guitar amp texture' },
...
export const THEMES: CategoryItem[] = [
  { id: 'family', label: 'Family', labelKo: '가족', description: '가족 안에서 생기는 애정, 책임, 미안함, 익숙함을 다룹니다.' },
  { id: 'season', label: 'Season', labelKo: '계절', description: '계절의 변화가 감정의 온도와 기억을 바꾸는 방식을 다룹니다.' },
  { id: 'confession', label: 'Confession', labelKo: '고백', description: '감춰둔 마음이 드러나려는 관계의 전환점을 다룹니다.' },
  { id: 'hometown', label: 'Hometown', labelKo: '고향', description: '돌아가고 싶은 마음과 이미 달라진 장소의 감정을 다룹니다.' },
  { id: 'alley', label: 'Alley', labelKo: '골목', description: '좁은 길목과 생활감 속에서 생기는 거리와 기억을 다룹니다.' },
  { id: 'longing', label: 'Longing', labelKo: '그리움', description: '멀어진 대상이나 시간에 닿고 싶은 마음을 다룹니다.' },
  { id: 'waiting', label: 'Waiting', labelKo: '기다림', description: '무언가가 오기를 바라는 시간의 결을 다룹니다.' },
  { id: 'dream', label: 'Dream', labelKo: '꿈', description: '바라는 미래나 아직 닿지 못한 가능성을 다룹니다.' },
  { id: 'city', label: 'City', labelKo: '도시', description: '도시 속에서 스치는 사람과 공간, 속도감이 만드는 감정을 다룹니다.' },
  { id: 'drive', label: 'Drive', labelKo: '드라이브', description: '이동하는 시간과 풍경이 감정의 속도를 바꾸는 순간을 다룹니다.' },
  { id: 'encounter', label: 'Encounter', labelKo: '만남', description: '새로운 인연이나 상황이 시작되는 첫 접점을 다룹니다.' },
  { id: 'lingering_attachment', label: 'Lingering Attachment', labelKo: '미련', description: '끝났다고 믿으려 하지만 아직 정리되지 않은 감정을 다룹니다.' },
  { id: 'sea', label: 'Sea', labelKo: '바다', description: '넓은 바다 앞에서 감정이 작아지거나 풀려나는 순간을 다룹니다.' },
  { id: 'night', label: 'Night', labelKo: '밤', description: '밤이라는 시간 속에서 선명해지는 감정과 감춰진 마음을 다룹니다.' },
  { id: 'room', label: 'Room', labelKo: '방', description: '혼자만의 공간에서 감정이 증폭되거나 정리되는 시간을 다룹니다.' },
  { id: 'wandering', label: 'Wandering', labelKo: '방황', description: '방향을 잃은 채 흔들리지만 계속 움직이는 시간을 다룹니다.' },
  { id: 'endurance', label: 'Endurance', labelKo: '버팀', description: '무너지지 않기 위해 오래 버티는 마음을 다룹니다.' },
  { id: 'change', label: 'Change', labelKo: '변화', description: '익숙한 상태에서 벗어나 다른 방향으로 움직이는 순간을 다룹니다.' },
  { id: 'anger', label: 'Anger', labelKo: '분노', description: '억눌린 감정이 터지거나 차갑게 응축되는 순간을 다룹니다.' },
  { id: 'anxiety', label: 'Anxiety', labelKo: '불안', description: '다가올 일이나 불확실한 관계 앞에서 흔들리는 마음을 다룹니다.' },
  { id: 'rain', label: 'Rain', labelKo: '비', description: '비가 만드는 소리와 흐려진 시야, 씻겨 내려가거나 더 짙어지는 감정을 다룹니다.' },
  { id: 'love', label: 'Love', labelKo: '사랑', description: '사랑 자체보다 관계가 변하는 온도와 시선을 중심으로 해석합니다.' },
  { id: 'walk', label: 'Walk', labelKo: '산책', description: '걷는 동안 생각과 감정이 조금씩 움직이는 과정을 다룹니다.' },
  { id: 'dawn', label: 'Dawn', labelKo: '새벽', description: '하루가 끝나고 시작되기 전의 애매한 감정대를 다룹니다.' },
  { id: 'gift', label: 'Gift', labelKo: '선물', description: '주고받는 물건보다 그 안에 담긴 마음과 거리감을 다룹니다.' },
  { id: 'excitement', label: 'Excitement', labelKo: '설렘', description: '새로운 감정이 막 생겨나는 떨림과 기대를 중심으로 합니다.' },
  { id: 'growth', label: 'Growth', labelKo: '성장', description: '변화하며 조금씩 넓어지는 마음과 시간을 다룹니다.' },
  { id: 'small_happiness', label: 'Small Happiness', labelKo: '소확행', description: '일상 속 아주 작은 만족과 마음이 풀리는 순간을 다룹니다.' },
  { id: 'drinking_party', label: 'Drinking Party', labelKo: '술자리', description: '술자리에서 느슨해지는 말과 숨겨진 감정을 다룹니다.' },
  { id: 'time', label: 'Time', labelKo: '시간', description: '흐르는 시간 속에서 변하거나 남아 있는 감정을 다룹니다.' },
  { id: 'safe_place', label: 'Safe Place', labelKo: '안식처', description: '마음이 방어를 내려놓을 수 있는 심리적 공간을 다룹니다.' },
  { id: 'overtime', label: 'Overtime', labelKo: '야근', description: '늦게까지 이어지는 일과 지친 마음의 웃픈 현실감을 다룹니다.' },
  { id: 'childhood', label: 'Childhood', labelKo: '어린시절', description: '어린 시절의 기억과 순수함이 현재의 감정과 만나는 지점을 다룹니다.' },
  { id: 'travel', label: 'Travel', labelKo: '여행', description: '새로운 장소에서 자기 감정이 낯설게 드러나는 경험을 다룹니다.' },
  { id: 'misunderstanding', label: 'Misunderstanding', labelKo: '오해', description: '말과 마음이 어긋나 생기는 균열을 다룹니다.' },
  { id: 'loneliness', label: 'Loneliness', labelKo: '외로움', description: '혼자 남겨진 듯한 감정과 공허한 내부 공간을 다룹니다.' },
  { id: 'friendship', label: 'Friendship', labelKo: '우정', description: '친구 사이의 유대와 함께 보낸 시간을 다룹니다.' },
  { id: 'fate', label: 'Fate', labelKo: '운명', description: '우연과 선택이 겹쳐 피할 수 없는 흐름처럼 느껴지는 관계나 사건을 다룹니다.' },
  { id: 'monday', label: 'Monday', labelKo: '월요일', description: '새로운 한 주가 시작될 때의 피로와 다짐, 현실감을 다룹니다.' },
  { id: 'comfort', label: 'Comfort', labelKo: '위로', description: '지친 마음이 조금씩 가라앉고 다시 숨을 고르는 과정을 다룹니다.' },
  { id: 'breakup', label: 'Breakup', labelKo: '이별', description: '관계가 끝나는 순간과 그 이후의 흔들림을 다룹니다.' },
  { id: 'identity', label: 'Identity', labelKo: '자아', description: '자신이 누구인지 되묻고 다시 정의하려는 내면의 움직임을 다룹니다.' },
  { id: 'freedom', label: 'Freedom', labelKo: '자유', description: '무언가에서 벗어나 자기 호흡을 되찾는 감정을 다룹니다.' },
  { id: 'reunion', label: 'Reunion', labelKo: '재회', description: '다시 마주하는 순간의 기대와 어색함, 변화한 마음을 다룹니다.' },
  { id: 'resistance', label: 'Resistance', labelKo: '저항', description: '외부의 압력이나 내면의 한계에 맞서는 감정을 다룹니다.' },
  { id: 'bus_stop', label: 'Bus Stop', labelKo: '정류장', description: '머무름과 이동 사이에 놓인 기다림의 시간을 다룹니다.' },
  { id: 'weekend', label: 'Weekend', labelKo: '주말', description: '일상에서 잠시 풀려나는 시간과 자유로운 호흡을 다룹니다.' },
  { id: 'subway', label: 'Subway', labelKo: '지하철', description: '이동하는 사람들 사이에서 생기는 고독과 속도감을 다룹니다.' },
  { id: 'obsession', label: 'Obsession', labelKo: '집착', description: '놓지 못하고 반복해서 붙잡는 감정을 다룹니다.' },
  { id: 'crush', label: 'Crush', labelKo: '짝사랑', description: '혼자 간직한 마음의 조심스러움과 들킬 듯 말 듯한 긴장을 다룹니다.' },
  { id: 'youth', label: 'Youth', labelKo: '청춘', description: '청춘의 빛과 불안, 무모함과 아름다움을 함께 다룹니다.' },
  { id: 'memory', label: 'Memory', labelKo: '추억', description: '지나간 기억이 현재 감정에 남기는 흔적을 다룹니다.' },
  { id: 'cafe', label: 'Cafe', labelKo: '카페', description: '잠시 머무르며 마음을 정리하거나 누군가를 기다리는 감정을 다룹니다.' },
  { id: 'after_work', label: 'After Work', labelKo: '퇴근', description: '하루를 끝내고 자기 자신에게 돌아오는 시간을 다룹니다.' },
  { id: 'convenience_store', label: 'Convenience Store', labelKo: '편의점', description: '작은 생활 공간에서 마주치는 현실감과 위안을 다룹니다.' },
  { id: 'eating_alone', label: 'Eating Alone', labelKo: '혼자밥', description: '혼자 보내는 식사 시간의 공허함과 이상한 평온함을 다룹니다.' },
  { id: 'reconciliation', label: 'Reconciliation', labelKo: '화해', description: '상처나 오해를 지나 다시 다가가려는 움직임을 다룹니다.' },
  { id: 'company_life', label: 'Company Life', labelKo: '회사생활', description: '직장 안의 관계와 역할, 피로와 농담이 섞인 현실감을 다룹니다.' },
  { id: 'reminiscence', label: 'Reminiscence', labelKo: '회상', description: '과거를 떠올리며 현재의 감정과 겹쳐 보는 흐름을 다룹니다.' },
  { id: 'regret', label: 'Regret', labelKo: '후회', description: '지나간 선택을 되돌아보며 남는 아쉬움과 자책을 다룹니다.' },
  { id: 'hope', label: 'Hope', labelKo: '희망', description: '아직 끝나지 않았다고 믿는 마음과 앞으로 나아가려는 힘을 다룹니다.' }
];
