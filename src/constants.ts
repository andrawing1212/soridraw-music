// SORIDRAW_SOUND_INSTRUMENT_VOCAL_EXPAND_V296
import {
  CategoryItem,
  GenreGroup,
...
export const STYLE_CYCLES: SoundStyleCycle[] = [
  // SORIDRAW_STYLE_GROOVE_SOUND_RECLASS_V9: left-side style categories keep real genre items; groove feel gets its own category; sound/instrument texture items move to Sound.
    ...
    variants: [
      ...
      { id: 'fusion-korean-traditional', label: 'Korean Traditional Fusion', labelKo: '국악 퓨전', description: 'Korean traditional melodic color blended with modern production.', descriptionKo: '국악 선율감과 현대적인 프로덕션을 섞는 한국적 하이브리드입니다. (Korean Traditional Fusion)', style: 'Korean Traditional Fusion', sound: 'gayageum-like plucks, haegeum-like melodic color, modern drums', mood: 'elegant, cinematic' },

      { id: 'separator-style-hybrid-idol-jpop', kind: 'separator', label: '아이돌 / J-POP', labelKo: '아이돌 / J-POP', description: '', descriptionKo: '', promptCore: '' },
      ...
      { id: 'separator-style-hybrid-hiphop-rap', kind: 'separator', label: '힙합 / 랩', labelKo: '힙합 / 랩', description: '', descriptionKo: '', promptCore: '' },
      { id: 'hip-hop', label: 'Hip-hop', labelKo: '힙합', description: 'Beat-led hip-hop edge and urban rhythm.', descriptionKo: '비트 중심의 힙합 감각을 더합니다. (Hip-hop)', style: 'hip-hop attitude, beat-led motion', sound: 'rhythmic vocal emphasis, urban drums', mood: 'confident, urban' },
      { id: 'boom-bap-style', label: 'Boom Bap', labelKo: '붐뱁', description: 'Classic boom bap drum texture and head-nod groove.', descriptionKo: '클래식한 붐뱁 드럼 질감을 더합니다. (Boom Bap)', style: 'boom bap rhythm, head-nod groove', sound: 'classic drum knock, sample-minded movement', mood: 'raw, classic' },
      { id: 'fusion-jazzy-hiphop', label: 'Jazzy Hip-hop', labelKo: '재지 힙합', description: 'Hip-hop rhythm blended with jazz harmony and mellow swing.', descriptionKo: '힙합 리듬에 재즈 코드와 부드러운 스윙감을 섞습니다. (Jazzy Hip-hop)', style: 'Jazzy Hip-hop fusion', sound: 'jazz chords, boom bap drums, upright bass color', mood: 'mellow, sophisticated' },
      { id: 'lofi-hip-hop-style', label: 'Lo-fi Hip-hop', labelKo: '로파이 힙합', description: 'Lo-fi hip-hop warmth and dusty beat texture.', descriptionKo: '먼지 낀 듯 따뜻한 로파이 비트 질감입니다. (Lo-fi Hip-hop)', style: 'lo-fi hip-hop mood, relaxed groove', sound: 'soft beat texture, warm dust', mood: 'chill, nostalgic' },
      { id: 'fusion-chillhop', label: 'Chillhop', labelKo: '칠홉', description: 'Relaxed hip-hop groove with warm lo-fi musicality.', descriptionKo: '따뜻한 로파이 질감과 여유로운 힙합 그루브를 더합니다. (Chillhop)', style: 'Chillhop fusion', sound: 'soft boom bap drums, warm keys, mellow bass', mood: 'relaxed, cozy' },
      { id: 'trap-style', label: 'Trap', labelKo: '트랩', description: 'Modern trap beat with fast hats and deep bass.', descriptionKo: '빠른 하이햇과 깊은 베이스 중심의 트랩 질감입니다. (Trap)', style: 'trap energy, modern street-level intensity', sound: 'heavy low-end, crisp hats', mood: 'aggressive, dark' },
      { id: 'dark-trap', label: 'Dark Trap', labelKo: '다크 트랩', description: 'Heavy and ominous trap beat texture.', descriptionKo: '묵직하고 불길한 다크 트랩 질감입니다. (Dark Trap)', style: 'dark trap texture', sound: 'heavy 808, sharp hats, ominous low end', mood: 'menacing, unstable' },
      { id: 'drill-mood', label: 'Drill', labelKo: '드릴', description: 'Dark drill-inspired rhythm and tension.', descriptionKo: '어둡고 긴장감 있는 드릴 리듬을 더합니다. (Drill)', style: 'drill-inspired rhythmic tension', sound: 'sliding bass, sharp hats', mood: 'dark, tense' },
      { id: 'cloud-rap', label: 'Cloud Rap', labelKo: '클라우드 랩', description: 'Airy, floating rap beat texture.', descriptionKo: '공중에 떠 있는 듯한 몽환적 랩 비트 질감입니다. (Cloud Rap)', style: 'cloud rap atmosphere', sound: 'airy pads, soft trap rhythm', mood: 'floaty, hazy' },
      { id: 'melodic-rap', label: 'Melodic Rap', labelKo: '멜로딕 랩', description: 'Rap flow blended with melodic phrasing.', descriptionKo: '랩과 멜로디가 섞인 흐름을 더합니다. (Melodic Rap)', style: 'melodic rap flow', sound: 'rap-singing rhythmic melody', mood: 'smooth, modern' },

      { id: 'separator-style-hybrid-jazz-rnb', kind: 'separator', label: '재즈 / R&B', labelKo: '재즈 / R&B', description: '', descriptionKo: '', promptCore: '' },
      { id: 'fusion-jazz-pop', label: 'Jazz Pop', labelKo: '재즈 팝', description: 'Pop structure with jazzy chords and relaxed phrasing.', descriptionKo: '팝 구조에 재즈 코드와 여유로운 프레이징을 더합니다. (Jazz Pop)', style: 'Jazz Pop fusion', sound: 'jazzy chords, soft drums, warm keys', mood: 'stylish, relaxed' },
      { id: 'swing-feel', label: 'Swing Jazz', labelKo: '스윙 재즈', description: 'Swing jazz looseness and rhythmic motion.', descriptionKo: '재즈 특유의 스윙 리듬과 느슨한 움직임을 더합니다. (Swing Jazz)', style: 'swing-aware rhythmic motion', sound: 'loose offbeat accents', mood: 'playful, stylish' },
      { id: 'fusion-smooth-jazz', label: 'Smooth Jazz', labelKo: '스무스 재즈', description: 'Smooth jazz color with soft melodic lines and polished groove.', descriptionKo: '부드러운 선율과 매끈한 그루브가 있는 스무스 재즈 색채입니다. (Smooth Jazz)', style: 'Smooth Jazz fusion', sound: 'smooth electric piano, soft sax-like lead, polished drums', mood: 'smooth, elegant' },
      { id: 'funky-bounce', label: 'Funk', labelKo: '펑크', description: 'Elastic bass and syncopated rhythmic bounce.', descriptionKo: '통통 튀는 베이스와 리드미컬한 탄력감을 더합니다. (Funk)', style: 'syncopated rhythmic bounce', sound: 'elastic bass groove, upbeat snap', mood: 'funky, energetic' },
      { id: 'rnb-groove-bounce', label: 'Modern R&B', labelKo: '모던 R&B', description: 'Smooth modern R&B pocket and flexible groove.', descriptionKo: '부드럽고 유연한 현대 R&B 그루브를 더합니다. (Modern R&B)', style: 'smooth R&B rhythmic pocket', sound: 'laid-back drums and flexible groove', mood: 'smooth, sensual' },
      { id: 'fusion-soul-rnb', label: 'Soul R&B', labelKo: '소울 R&B', description: 'Warm soul-based R&B color with emotional chords and groove.', descriptionKo: '따뜻한 소울 감성과 감정적인 R&B 코드감을 더합니다. (Soul R&B)', style: 'Soul R&B fusion', sound: 'soulful keys, warm bass, relaxed R&B drums', mood: 'warm, soulful' },
      { id: 'fusion-neo-soul', label: 'Neo Soul', labelKo: '네오 소울', description: 'Soul-based harmonic richness with relaxed modern groove.', descriptionKo: '풍부한 소울 화성과 여유로운 현대적 그루브를 더합니다. (Neo Soul)', style: 'Neo Soul fusion', sound: 'warm electric piano, soulful bass, relaxed drums', mood: 'smooth, soulful' },
      { id: 'fusion-pbrnb', label: 'Alternative R&B', labelKo: '얼터너티브 R&B', description: 'Alternative R&B color with atmospheric electronic texture.', descriptionKo: '몽환적인 전자 질감이 섞인 대안적 R&B 색채입니다. (Alternative R&B)', style: 'PBR&B fusion', sound: 'moody synth pads, sparse R&B drums, deep sub bass', mood: 'moody, atmospheric' },

      { id: 'separator-style-hybrid-dance-edm', kind: 'separator', label: '댄스 / EDM', labelKo: '댄스 / EDM', description: '', descriptionKo: '', promptCore: '' },
      { id: 'classic-disco', label: '70s-Disco', labelKo: '70s-디스코', description: '70s disco dance groove with bright rhythmic lift.', descriptionKo: '70s 디스코 특유의 밝고 경쾌한 댄스 그루브입니다. (70s-Disco)', style: '70s disco groove', sound: 'four-on-the-floor drums, bright rhythm guitar', mood: 'uplifting, retro' },
      { id: 'fusion-nu-disco', label: 'Nu-Disco', labelKo: '누 디스코', description: 'Disco groove reinterpreted with modern pop and electronic polish.', descriptionKo: '디스코 그루브를 현대적인 팝/전자 프로덕션으로 보강한 퓨전 장르입니다. (Nu-Disco)', style: 'Nu-Disco fusion', sound: 'slap bass, disco drum pulse, 16th-note funk guitar', mood: 'groovy, stylish' },
      { id: 'fusion-retro-disco', label: 'Retro Disco', labelKo: '레트로 디스코', description: 'Classic disco color with vintage dance-floor energy.', descriptionKo: '빈티지한 디스코 리듬과 댄스 플로어 감성을 더합니다. (Retro Disco)', style: 'Retro Disco fusion', sound: 'four-on-the-floor drums, funky bass, bright strings', mood: 'retro, lively' },
      { id: 'house-style', label: 'House', labelKo: '하우스', description: 'Four-on-the-floor house groove for dance movement.', descriptionKo: '하우스 특유의 4/4 그루브를 더합니다. (House)', style: 'house groove, four-on-the-floor rhythm', sound: 'steady kick, clean dancefloor pulse', mood: 'smooth, energetic' },
      { id: 'fusion-deep-house', label: 'Deep House', labelKo: '딥 하우스', description: 'Warm house groove with deep bass and smooth club texture.', descriptionKo: '깊은 베이스와 부드러운 클럽 질감의 하우스 그루브입니다. (Deep House)', style: 'Deep House fusion', sound: 'deep bass, soft house drums, warm keys', mood: 'smooth, nocturnal' },
      { id: 'fusion-soulful-house', label: 'Soulful House', labelKo: '소울풀 하우스', description: 'House rhythm with soulful chords and warm vocal-friendly color.', descriptionKo: '하우스 리듬에 소울풀한 코드와 따뜻한 보컬 친화 질감을 더합니다. (Soulful House)', style: 'Soulful House fusion', sound: 'soulful keys, warm house groove, smooth bass', mood: 'warm, uplifting' },
      { id: 'fusion-progressive-house', label: 'Progressive House', labelKo: '프로그레시브 하우스', description: 'Expansive house build-up with emotional festival-scale lift.', descriptionKo: '감정적인 빌드업과 확장감 있는 하우스 전개를 더합니다. (Progressive House)', style: 'Progressive House fusion', sound: 'sidechain synths, big builds, four-on-the-floor drums', mood: 'uplifting, expansive' },
      { id: 'fusion-uk-garage', label: 'UK Garage', labelKo: 'UK 개러지', description: 'Shuffling UK garage rhythm with bouncy syncopated drums.', descriptionKo: '셔플감 있는 UK 개러지 리듬과 탄력 있는 드럼 질감입니다. (UK Garage)', style: 'UK Garage fusion', sound: 'shuffling drums, sub bass, chopped vocal rhythm', mood: 'bouncy, stylish' },
      { id: 'fusion-jersey-club', label: 'Jersey Club', labelKo: '저지 클럽', description: 'Fast club bounce with chopped kick patterns and playful energy.', descriptionKo: '잘게 쪼개지는 킥 패턴과 빠른 클럽 바운스를 더합니다. (Jersey Club)', style: 'Jersey Club fusion', sound: 'triplet kick bounce, chopped club drums, vocal chops', mood: 'playful, kinetic' },
      { id: 'fusion-retro-electro', label: 'Retro Electro', labelKo: '레트로 일렉트로', description: 'Old-school electro rhythm with synthetic retro color.', descriptionKo: '올드스쿨 전자 리듬과 레트로 신스 질감을 더합니다. (Retro Electro)', style: 'Retro Electro fusion', sound: 'electro drums, synthetic bass, retro leads', mood: 'mechanical, retro' },
      { id: 'synthpop-sense', label: 'Synth-pop Sense', labelKo: '신스팝 감각', description: 'Synth-pop style melodic electronic color.', descriptionKo: '신스팝 특유의 선명한 멜로디와 전자 감각입니다. (Synth-pop Sense)', style: 'synth-pop sensibility', sound: 'bright synth hooks and clean drum machines', mood: 'catchy, retro-modern' },
      ...
      { id: 'britpop-sense', label: 'Britpop', labelKo: '브릿팝', description: 'Britpop-like melodic band character.', descriptionKo: '브릿팝 특유의 멜로딕한 기타 밴드 감각입니다. (Britpop)', style: 'Britpop', sound: 'jangly guitars and steady drums', mood: 'nostalgic, anthemic' },
      { id: 'soft-rock-band', label: 'Soft Rock Band', labelKo: '소프트 록 밴드', description: 'Soft rock band style with smooth guitars and stable drums.', descriptionKo: '부드러운 기타와 안정적인 드럼이 중심인 소프트 록 밴드 스타일입니다. (Soft Rock Band)', style: 'soft rock band', sound: 'smooth guitars, steady drums', mood: 'warm, easygoing' },
      { id: 'rock', label: 'Rock', labelKo: '록', description: 'Modern rock foundation and band energy.', descriptionKo: '밴드 중심의 기본 록 에너지를 더합니다. (Rock)', style: 'rock band', sound: 'guitar drive, live drum force', mood: 'powerful, energetic' },
      { id: 'pop-punk-band', label: 'Pop Punk Band', labelKo: '팝 펑크 밴드', description: 'Fast pop-punk band style with youthful guitar energy.', descriptionKo: '빠르고 직선적인 기타와 청춘감 있는 보컬 중심의 팝 펑크 밴드 스타일입니다. (Pop Punk Band)', style: 'pop punk band', sound: 'fast guitars, punchy drums', mood: 'youthful, urgent' },
      { id: 'punk-rock', label: 'Punk Rock', labelKo: '펑크 록', description: 'Fast, direct punk rock drive.', descriptionKo: '빠르고 직선적인 펑크 록 에너지입니다. (Punk Rock)', style: 'punk rock', sound: 'fast guitars, punchy drums', mood: 'rebellious, urgent' },
      { id: 'funk-rock-band', label: 'Funk Rock Band', labelKo: '펑크 록 밴드', description: 'Funk-rock band style with tight rhythmic guitar.', descriptionKo: '펑키한 기타 리듬과 밴드 에너지가 결합된 스타일입니다. (Funk Rock Band)', style: 'funk rock band', sound: 'funk guitar, tight drums, live bass', mood: 'groovy, energetic' },
      { id: 'j-rock-band', label: 'J-Rock Band', labelKo: 'J-록 밴드', description: 'Japanese rock band style with fast drums and clear guitar riffs.', descriptionKo: '빠른 드럼과 선명한 기타 리프가 중심인 일본식 록 밴드 스타일입니다. (J-Rock Band)', style: 'J-rock band', sound: 'fast drums, clear guitar riffs', mood: 'bright, driving' },
      ...
      { id: 'fusion-bossa-nova-pop', label: 'Bossa Nova Pop', labelKo: '보사노바 팝', description: 'Bossa nova rhythm blended into a soft pop structure.', descriptionKo: '보사노바 리듬을 부드러운 팝 구조에 섞는 글로벌 스타일입니다. (Bossa Nova Pop)', style: 'Bossa Nova Pop fusion', sound: 'nylon guitar, soft brush rhythm, warm chords', mood: 'gentle, breezy' },
      { id: 'fusion-tropical-house', label: 'Tropical House', labelKo: '트로피컬 하우스', description: 'Light tropical house color with warm plucks and relaxed dance pulse.', descriptionKo: '따뜻한 플럭과 여유로운 댄스 펄스가 있는 트로피컬 하우스 감성입니다. (Tropical House)', style: 'Tropical House fusion', sound: 'tropical plucks, soft house drums, warm bass', mood: 'sunny, relaxed' },
      { id: 'latin-rhythm', label: 'Latin Pop / Reggaeton', labelKo: '라틴 팝 / 레게톤', description: 'Latin-inspired rhythmic swing and percussion.', descriptionKo: '라틴 계열의 리듬감과 퍼커션 움직임을 더합니다. (Latin Pop / Reggaeton)', style: 'Latin rhythmic movement', sound: 'syncopated percussion accents', mood: 'warm, lively' },
      { id: 'fusion-dancehall', label: 'Dancehall', labelKo: '댄스홀', description: 'Dancehall groove with syncopated island rhythm.', descriptionKo: '싱코페이션이 강한 아일랜드 리듬 기반의 댄스홀 그루브입니다. (Dancehall)', style: 'Dancehall fusion', sound: 'dancehall drums, offbeat percussion, warm bass', mood: 'loose, groovy' },
      { id: 'fusion-afrobeats', label: 'Afrobeats', labelKo: '아프로비츠', description: 'Global groove fusion with light percussion and warm rhythmic bounce.', descriptionKo: '가벼운 퍼커션과 따뜻한 리듬 바운스가 있는 글로벌 그루브입니다. (Afrobeats)', style: 'Afrobeats fusion', sound: 'afro percussion, warm bass, syncopated guitar accents', mood: 'sunny, groovy' },
      { id: 'fusion-amapiano', label: 'Amapiano', labelKo: '아마피아노', description: 'South African house-rooted groove with log drum and airy chords.', descriptionKo: '로그 드럼과 공기감 있는 코드가 특징인 남아공 하우스 기반 그루브입니다. (Amapiano)', style: 'Amapiano fusion', sound: 'log drum bass, airy keys, soft house percussion', mood: 'deep, relaxed' },
      { id: 'fusion-moombahton', label: 'Moombahton', labelKo: '뭄바톤', description: 'Moombahton bounce with slowed club rhythm and tropical color.', descriptionKo: '느리게 흔들리는 클럽 리듬과 트로피컬한 바운스를 더합니다. (Moombahton)', style: 'Moombahton fusion', sound: 'moombahton drums, syncopated bass, tropical synth accents', mood: 'bouncy, tropical' },
  ...
  },
  {
    ...
    title: 'Vocal Line',
    titleKo: '보컬 라인',
    description: 'Shapes vocal phrasing, part feeling, and emotional delivery.',
    descriptionKo: '보컬의 표현 방식, 파트감, 감정 전달 방식을 보강해요.',
    variants: [
      { id: 'separator-style-vocal-attitude-tone', kind: 'separator', label: '발성', labelKo: '발성', description: '', descriptionKo: '', promptCore: '' },
      { id: 'vocal-delicate', label: 'Delicate Vocal Expression', labelKo: '섬세한 보컬', description: 'Soft and detailed vocal expression with emotional control.', descriptionKo: '보컬의 결을 섬세하게 살리는 표현감입니다. (Delicate Vocal Expression)', style: 'delicate vocal expression', sound: 'vocal-forward focus with soft dynamics', mood: 'intimate, expressive' },
      { id: 'vocal-whisper-expression', label: 'Whispered Vocal Feel', labelKo: '속삭임 표현', description: 'Breathy, close vocal expression like a whisper.', descriptionKo: '가까이서 속삭이는 듯한 보컬 표현감을 더합니다. (Whispered Vocal Feel)', style: 'whispered vocal expression', sound: 'breathy close-mic vocal texture', mood: 'intimate, quiet' },
      { id: 'vocal-cold-expression', label: 'Cold Vocal Feel', labelKo: '차가운 표현', description: 'Cool and emotionally distant vocal expression.', descriptionKo: '감정을 차갑게 절제한 보컬 표현입니다. (Cold Vocal Feel)', style: 'cold restrained vocal tone', sound: 'clean dry vocal edge', mood: 'distant, cool' },
      { id: 'vocal-indifferent', label: 'Indifferent Vocal Feel', labelKo: '무심한 표현', description: 'Detached vocal expression with minimal emotional pressure.', descriptionKo: '아무렇지 않은 듯 무심하게 부르는 느낌입니다. (Indifferent Vocal Feel)', style: 'indifferent vocal phrasing', sound: 'flat understated vocal texture', mood: 'detached, dry' },
      { id: 'vocal-lazy-expression', label: 'Lazy Vocal Feel', labelKo: '나른한 표현', description: 'Relaxed vocal expression with a slow, loose feel.', descriptionKo: '힘을 빼고 나른하게 흐르는 보컬 표현입니다. (Lazy Vocal Feel)', style: 'lazy relaxed vocal phrasing', sound: 'loose soft vocal movement', mood: 'drowsy, laid-back' },
      { id: 'vocal-rough-expression', label: 'Rough Vocal Feel', labelKo: '거친 표현', description: 'Rough-edged vocal expression with grain and grit.', descriptionKo: '거친 결이 살아있는 보컬 표현감입니다. (Rough Vocal Feel)', style: 'rough gritty vocal expression', sound: 'grainy vocal edge', mood: 'raw, intense' },
      { id: 'vocal-dreamy-expression', label: 'Dreamy Vocal Feel', labelKo: '몽롱한 표현', description: 'Soft, blurred vocal expression with a floating feel.', descriptionKo: '몽롱하게 흐르는 듯한 보컬 표현입니다. (Dreamy Vocal Feel)', style: 'dreamy blurred vocal phrasing', sound: 'soft reverb vocal haze', mood: 'dreamy, floating' },
      { id: 'separator-style-vocal-rhythm-phrasing', kind: 'separator', label: '창법', labelKo: '창법', description: '', descriptionKo: '', promptCore: '' },
      { id: 'call-and-response', label: 'Call and Response', labelKo: '콜앤리스폰스', description: 'Alternating vocal call-and-response movement.', descriptionKo: '한쪽이 부르면 다른 쪽이 받아치는 대화형 보컬 구조입니다. (Call and Response)', style: 'call-and-response vocal structure', sound: 'alternating lead and response vocal phrasing', mood: 'interactive, conversational' },
      { id: 'vocal-laidback-behind-beat', label: 'Laid-back Vocal Timing', labelKo: '레이드백', description: 'Relaxed behind-the-beat vocal phrasing with a loose groove.', descriptionKo: '박자보다 살짝 뒤에 기대듯 여유롭게 부르는 표현입니다. (Laid-back Vocal Timing)', style: 'laid-back behind-the-beat vocal phrasing', sound: 'loose vocal timing with relaxed groove', mood: 'cool, relaxed' },
      { id: 'vocal-broken-sentence-delivery', label: 'Broken Sentence Delivery', labelKo: '스타카토', description: 'A vocal habit that breaks each sentence into short breath-led fragments.', descriptionKo: '문장마다 호흡이 끊기듯 짧게 나눠 부르는 습관입니다. (Broken Sentence Delivery)', style: 'broken sentence vocal delivery', sound: 'short breath-led vocal fragments', mood: 'fragile, hesitant' },
      { id: 'vocal-wobbly-pitch-feel', label: 'Wobbly Pitch Feel', labelKo: '피치크랙', description: 'A wobbly pitch habit with slightly shaky and imperfect note control.', descriptionKo: '음정이 미세하게 흔들리며 불안정하게 들리는 표현입니다. (Wobbly Pitch Feel)', style: 'wobbly pitch vocal feel', sound: 'shaky imperfect note control', mood: 'unstable, raw' },
      { id: 'vocal-tossed-off', label: 'Tossed-off Vocal Feel', labelKo: '툭 던지듯', description: 'Casual vocal phrasing that sounds emotionally understated.', descriptionKo: '감정을 과하게 밀지 않고 툭 놓고 부르는 느낌입니다. (Tossed-off Vocal Feel)', style: 'tossed-off vocal phrasing', sound: 'understated vocal delivery', mood: 'dry, casual' },
      { id: 'vocal-spoken-singing', label: 'Spoken-singing Feel', labelKo: '말하듯이', description: 'Vocal phrasing that sits between speech and melody.', descriptionKo: '대사처럼 말하듯 부르는 표현감입니다. (Spoken-singing Feel)', style: 'spoken-singing vocal style', sound: 'speech-like melodic phrasing', mood: 'conversational, direct' },
      { id: 'vocal-reciting', label: 'Reciting Vocal Feel', labelKo: '낮게 읊조리듯', description: 'Poetic vocal phrasing that feels quietly recited.', descriptionKo: '시를 읊조리듯 낮게 흐르는 보컬 표현입니다. (Reciting Vocal Feel)', style: 'reciting vocal phrasing', sound: 'quiet narrative vocal flow', mood: 'poetic, calm' },
      { id: 'vocal-offbeat-push-pull', label: 'Off-beat Push-pull Feel', labelKo: '박자를 밀고 당기듯', description: 'Rhythmic vocal phrasing that pushes and pulls around the beat.', descriptionKo: '박자를 살짝 밀고 당기며 리듬감 있게 부르는 표현입니다. (Off-beat Push-pull Feel)', style: 'off-beat vocal phrasing with rhythmic push and pull', sound: 'syncopated vocal timing with tight rhythmic movement', mood: 'witty, groovy' },
      { id: 'vocal-raplike-tight', label: 'Rap-like Tight Phrasing', labelKo: '말하듯 잘게 쪼개듯', description: 'Tight spoken-melodic phrasing with rap-like rhythmic detail.', descriptionKo: '말하듯 부르되 랩처럼 리듬을 잘게 쪼개는 표현입니다. (Rap-like Tight Phrasing)', style: 'rap-like spoken vocal phrasing with tight rhythmic delivery', sound: 'tight consonant rhythm and spoken-melodic flow', mood: 'direct, sharp' },
      { id: 'vocal-rounded-mouthy', label: 'Rounded Mouthy Phrasing', labelKo: '입안에서 굴리듯', description: 'Rounded vocal phrasing with soft mouth-shaped groove.', descriptionKo: '소리를 입안에서 부드럽게 굴리듯 처리하는 표현입니다. (Rounded Mouthy Phrasing)', style: 'rounded mouthy vocal phrasing with soft groove', sound: 'rounded vowel movement with mellow phrasing', mood: 'sensual, smooth' },
      { id: 'vocal-silky-connected', label: 'Silky Connected Phrasing', labelKo: '부드럽게 이어가듯', description: 'Silky connected vocal phrasing with smooth line-to-line flow.', descriptionKo: '음과 음을 끊지 않고 매끄럽게 이어 부르는 표현입니다. (Silky Connected Phrasing)', style: 'silky connected vocal phrasing with mellow flow', sound: 'legato vocal connection with smooth transitions', mood: 'warm, flowing' },
      { id: 'vocal-light-rnb-runs', label: 'Light R&B Runs', labelKo: '가볍게 꺾어 흐르듯', description: 'Light R&B-style vocal runs used as tasteful melodic ornamentation.', descriptionKo: '과하지 않은 R&B식 꺾기와 짧은 애드리브가 섞인 표현입니다. (Light R&B Runs)', style: 'light R&B vocal runs with tasteful melodic ornaments', sound: 'short agile runs and soft melisma accents', mood: 'smooth, soulful' },
      { id: 'vocal-sustained-ending', label: 'Sustained Ending Notes', labelKo: '끝음을 오래 붙잡듯', description: 'Controlled sustained phrase endings with stable emotional hold.', descriptionKo: '문장의 끝음을 안정적으로 길게 붙잡아 여운을 주는 표현입니다. (Sustained Ending Notes)', style: 'sustained ending notes with controlled emotional hold', sound: 'long held note endings with controlled sustain', mood: 'emotional, lingering' },
      { id: 'vocal-slurred-ending-phrasing', label: 'Slurred Ending Phrasing', labelKo: '끝음을 흘리듯', description: 'A vocal habit that lets phrase endings trail off without a clean finish.', descriptionKo: '문장 끝음을 또렷하게 닫지 않고 흘리듯 마무리하는 습관입니다. (Slurred Ending Phrasing)', style: 'slurred ending vocal phrasing', sound: 'soft trailing word endings', mood: 'loose, weary' },
      { id: 'vocal-unstable-pitch-feel', label: 'Unstable Pitch Feel', labelKo: '음이 살짝 흔들리듯', description: 'A slightly unstable pitch feel that makes the voice sound emotionally unsteady.', descriptionKo: '음정이 완전히 고정되지 않고 살짝 흔들리는 불안정한 느낌입니다. (Unstable Pitch Feel)', style: 'slightly unstable pitch vocal feel', sound: 'subtle wavering pitch detail', mood: 'anxious, fragile' },
      { id: 'vocal-off-pitch-feel', label: 'Off-pitch Vocal Feel', labelKo: '음정을 살짝 놓치듯', description: 'A deliberately imperfect vocal feel that sounds like some notes are not fully reached.', descriptionKo: '일부 음을 정확히 맞추지 못하는 듯한 서툰 보컬 느낌입니다. (Off-pitch Vocal Feel)', style: 'imperfect off-pitch vocal feel', sound: 'slightly missed note edges', mood: 'awkward, human' },
      { id: 'vocal-careless-humming-feel', label: 'Careless Humming Feel', labelKo: '무심히 흥얼거리듯', description: 'A casual vocal habit that sounds like loose, careless humming rather than polished singing.', descriptionKo: '힘을 주지 않고 대충 흥얼거리듯 부르는 습관입니다. (Careless Humming Feel)', style: 'careless humming vocal feel', sound: 'loose low-effort humming texture', mood: 'casual, detached' },
      { id: 'vocal-nasal-sick-voice', label: 'Nasal Sick Voice', labelKo: '목이 잠긴 듯', description: 'A nasal, congested vocal color like the singer has a cold.', descriptionKo: '코가 막히거나 감기 걸린 듯 답답하고 탁한 목소리 느낌입니다. (Nasal Sick Voice)', style: 'nasal sick vocal tone', sound: 'congested nasal vocal color', mood: 'tired, muted' },
      { id: 'vocal-mumbled-pronunciation', label: 'Mumbled Pronunciation', labelKo: '발음이 흐려지듯', description: 'A vocal habit with blurred pronunciation and words softened inside the mouth.', descriptionKo: '발음을 또렷하게 하지 않고 입안에서 뭉개듯 부르는 느낌입니다. (Mumbled Pronunciation)', style: 'mumbled vocal pronunciation', sound: 'blurred consonants and mouthy word edges', mood: 'shy, withdrawn' },
      { id: 'vocal-fading-word-endings', label: 'Fading Word Endings', labelKo: '말끝이 사라지듯', description: 'A vocal habit where the end of each phrase gets smaller and fades away.', descriptionKo: '말끝이 점점 작아지며 사라지는 듯한 보컬 습관입니다. (Fading Word Endings)', style: 'fading word endings', sound: 'vanishing phrase tails', mood: 'uncertain, wistful' },
      { id: 'vocal-short-breath-delivery', label: 'Short-breath Delivery', labelKo: '숨이 살짝 모자라듯', description: 'A breath-short vocal habit that feels like the singer runs out of air between lines.', descriptionKo: '숨이 부족해서 문장 중간중간 끊기는 듯한 표현입니다. (Short-breath Delivery)', style: 'short-breath vocal delivery', sound: 'breath-starved line breaks', mood: 'nervous, pressured' },
      { id: 'vocal-unconfident-feel', label: 'Unconfident Vocal Feel', labelKo: '자신 없이 머뭇거리듯', description: 'A small, uncertain vocal habit with cautious and unconfident delivery.', descriptionKo: '확신 없이 조심스럽고 작게 부르는 느낌입니다. (Unconfident Vocal Feel)', style: 'unconfident cautious vocal delivery', sound: 'small hesitant vocal attack', mood: 'timid, vulnerable' },
      { id: 'vocal-blank-singalong-feel', label: 'Blank Sing-along Feel', labelKo: '멍하니 따라 부르듯', description: 'A blank, almost automatic sing-along habit with emotionally distant delivery.', descriptionKo: '감정 없이 멍하게 따라 부르는 듯한 보컬 습관입니다. (Blank Sing-along Feel)', style: 'blank sing-along vocal feel', sound: 'flat automatic humming-like delivery', mood: 'numb, detached' },
      { id: 'separator-style-vocal-emotion', kind: 'separator', label: '감정', labelKo: '감정', description: '', descriptionKo: '', promptCore: '' },
      { id: 'vocal-emotional-rise', label: 'Emotional Vocal Rise', labelKo: '감정 고조', description: 'Gradually rising vocal emotion toward a stronger payoff.', descriptionKo: '후반으로 갈수록 감정이 점점 고조되는 보컬 표현입니다. (Emotional Vocal Rise)', style: 'gradual emotional vocal rise', sound: 'building vocal intensity', mood: 'emotional, rising' },
      { id: 'vocal-teary-expression', label: 'Tearful Vocal Feel', labelKo: '울먹이는 표현', description: 'Vocal phrasing that feels close to tears without overacting.', descriptionKo: '과하지 않게 울먹임이 묻어나는 보컬 표현입니다. (Tearful Vocal Feel)', style: 'tearful vocal phrasing', sound: 'slightly trembling vocal detail', mood: 'fragile, aching' },
      { id: 'vocal-held-back', label: 'Held-back Vocal Feel', labelKo: '눌러 참는 표현', description: 'Restrained vocal emotion that feels held inside.', descriptionKo: '감정을 누르고 참는 듯한 보컬 표현입니다. (Held-back Vocal Feel)', style: 'held-back vocal emotion', sound: 'controlled tension in the vocal line', mood: 'restrained, tense' },
      { id: 'vocal-pleading', label: 'Pleading Vocal Feel', labelKo: '애원하는 표현', description: 'Vocal expression with a pleading emotional pull.', descriptionKo: '간절하게 붙잡는 듯한 보컬 표현감입니다. (Pleading Vocal Feel)', style: 'pleading vocal phrasing', sound: 'emotional vocal pull', mood: 'desperate, vulnerable' },
      { id: 'vocal-explosive-emotion', label: 'Explosive Vocal Emotion', labelKo: '폭발적인 감정 표현', description: 'A strong emotional vocal burst for climactic sections.', descriptionKo: '클라이맥스에서 감정이 크게 터지는 보컬 표현입니다. (Explosive Vocal Emotion)', style: 'explosive emotional vocal peak', sound: 'wide dynamic vocal lift', mood: 'intense, cathartic' },
      { id: 'vocal-smiling-expression', label: 'Smiling Vocal Feel', labelKo: '웃는 듯한 표현', description: 'A vocal expression that sounds like smiling through the phrase.', descriptionKo: '웃음을 머금고 부르는 듯한 보컬 표현입니다. (Smiling Vocal Feel)', style: 'smiling vocal phrasing', sound: 'bright subtle vocal lift', mood: 'warm, playful' },
      { id: 'vocal-empty-expression', label: 'Empty Vocal Feel', labelKo: '허무한 표현', description: 'Hollow and resigned vocal expression.', descriptionKo: '비어 있는 듯 허무하게 부르는 표현입니다. (Empty Vocal Feel)', style: 'hollow resigned vocal phrasing', sound: 'thin spacious vocal tone', mood: 'empty, resigned' },
      { id: 'vocal-sarcastic-expression', label: 'Sarcastic Vocal Feel', labelKo: '비꼬는 표현', description: 'A lightly sarcastic vocal edge that sharpens the character.', descriptionKo: '캐릭터의 빈정거림이 느껴지는 보컬 표현입니다. (Sarcastic Vocal Feel)', style: 'sarcastic vocal edge', sound: 'sharp playful vocal inflection', mood: 'witty, prickly' },
      { id: 'vocal-suffocated-expression', label: 'Suffocated Vocal Feel', labelKo: '숨 막히는 표현', description: 'Tight vocal expression that feels breathless and pressured.', descriptionKo: '숨이 막히는 듯 답답한 보컬 표현입니다. (Suffocated Vocal Feel)', style: 'breathless pressured vocal phrasing', sound: 'tight close vocal texture', mood: 'anxious, trapped' },
      { id: 'separator-style-vocal-era-genre', kind: 'separator', label: '시대장르별 보컬', labelKo: '시대장르별 보컬', description: '', descriptionKo: '', promptCore: '' },
      { id: 'vocal-90s-kballad-open-sustain', label: '90s K-Ballad Open Sustain', labelKo: '90년대 K-발라드 고음선', description: 'Classic Korean 90s ballad phrasing with open vowels, long held notes, and sincere emotional lift.', descriptionKo: '90년대 한국 발라드처럼 열린 발음과 긴 고음, 진심 어린 감정선을 살리는 창법입니다. 파워 발라드나 드라마틱한 후렴에 잘 어울립니다. (90s K-Ballad Open Sustain)', style: 'classic 90s Korean ballad vocal lift with open sustained high notes', sound: 'open vowel belting, long sustain, sincere vibrato', mood: 'dramatic, sincere, nostalgic' },
      { id: 'vocal-90s-dance-pop-crisp', label: '90s Dance-pop Vocal Attack', labelKo: '90년대 댄스팝 보컬', description: 'Bright and punchy 90s dance-pop vocal phrasing with crisp diction and energetic hook attack.', descriptionKo: '90년대 댄스팝처럼 또렷하고 힘 있게 박자를 치고 들어가는 보컬 표현입니다. 빠른 댄스곡과 단체 훅에 잘 어울립니다. (90s Dance-pop Vocal Attack)', style: 'bright punchy 90s dance-pop vocal phrasing with crisp hook attack', sound: 'crisp diction, energetic pop attack, tight chorus lift', mood: 'upbeat, bold, retro' },
      { id: 'vocal-2000s-kindie-playful-dreamy', label: '2000s K-Indie Vocal Feel', labelKo: '2000년대 K-인디 감성', description: 'Playful but dreamy 2000s Korean indie-pop vocal phrasing with airy sweetness.', descriptionKo: '2000년대 한국 인디팝처럼 장난스럽지만 몽환적으로 흘러가는 보컬 표현입니다. 공기감 있는 여성 보컬이나 산뜻한 밴드팝에 잘 어울립니다. (2000s K-Indie Vocal Feel)', style: '2000s K-indie playful but dreamy vocal phrasing', sound: 'airy sweet indie-pop vocal lift with light nostalgic color', mood: 'playful, dreamy, nostalgic' },
      { id: 'vocal-2000s-cyworld-ballad', label: '2000s Cyworld Ballad Feel', labelKo: '2000년대 싸이월드 발라드', description: 'Glossy 2000s Korean sentimental ballad phrasing with soft piano-pop emotion and clean melodic delivery.', descriptionKo: '2000년대 싸이월드 감성 발라드처럼 깨끗하고 감성적인 멜로디 라인을 살리는 표현입니다. 피아노, 스트링, 추억형 가사에 잘 어울립니다. (2000s Cyworld Ballad Feel)', style: 'glossy 2000s Korean sentimental ballad phrasing', sound: 'clean melodic delivery, soft piano-pop emotion, nostalgic gloss', mood: 'sentimental, nostalgic, tender' },
      { id: 'vocal-2000s-rnb-duo-soft', label: '2000s R&B Duo Softness', labelKo: '2000년대 R&B 듀오 감성', description: 'Soft 2000s Korean R&B duo phrasing with airy harmony, gentle runs, and smooth emotional blend.', descriptionKo: '2000년대 R&B 듀오처럼 부드러운 하모니와 공기감, 짧은 꺾기가 섞인 표현입니다. 남녀 듀엣이나 여성 듀오에 잘 어울립니다. (2000s R&B Duo Softness)', style: 'smooth 2000s Korean R&B duo phrasing with airy harmony', sound: 'soft harmony blend, gentle R&B runs, smooth vocal overlap', mood: 'romantic, smooth, intimate' },
      { id: 'vocal-2000s-husky-rnb', label: '2000s Husky R&B Feel', labelKo: '2000년대 허스키 R&B', description: 'Mellow 2000s R&B phrasing with husky warmth, low-mid glide, and restrained groove.', descriptionKo: '2000년대 R&B처럼 허스키한 온기와 낮은 그루브를 살려 부르는 표현입니다. 차분한 R&B, 시티팝, 밤 분위기에 잘 어울립니다. (2000s Husky R&B Feel)', style: 'husky mellow 2000s R&B vocal phrasing with warm low-mid glide', sound: 'warm husky glide, mellow groove, restrained R&B tone', mood: 'mature, smooth, late-night' },
      { id: 'vocal-2010s-idol-hook', label: '2010s Idol Hook Delivery', labelKo: '2010년대 아이돌 훅', description: 'Polished K-pop idol hook delivery with clear diction, bright lift, and catchy chorus focus.', descriptionKo: '2010년대 아이돌 팝처럼 발음이 선명하고 후렴 훅이 잘 살아나는 표현입니다. 밝은 후렴, 그룹 보컬, 댄스팝에 잘 어울립니다. (2010s Idol Hook Delivery)', style: 'polished 2010s K-pop idol hook delivery with bright catchy lift', sound: 'clear diction, glossy chorus lift, synchronized pop energy', mood: 'bright, catchy, confident' },
      { id: 'vocal-2010s-acoustic-indie', label: '2010s Acoustic Indie Intimacy', labelKo: '2010년대 어쿠스틱 인디', description: 'Close and honest acoustic indie vocal phrasing with small-room warmth and natural softness.', descriptionKo: '2010년대 어쿠스틱 인디처럼 가까운 방 안에서 담담하게 부르는 듯한 표현입니다. 통기타, 작은 밴드, 일상형 가사에 잘 어울립니다. (2010s Acoustic Indie Intimacy)', style: 'intimate 2010s acoustic indie vocal phrasing with small-room sincerity', sound: 'close-mic softness, natural breath, warm acoustic room', mood: 'honest, gentle, everyday' },
      { id: 'vocal-2020s-hyperpop-gloss', label: '2020s Hyperpop Vocal Gloss', labelKo: '2020년대 하이퍼팝 보컬', description: 'Glossy modern hyperpop-style vocal phrasing with clipped hooks, bright processing, and playful digital energy.', descriptionKo: '2020년대 하이퍼팝처럼 밝고 잘게 잘리는 디지털 보컬 표현입니다. 글리치, 빠른 팝, 과장된 훅에 잘 어울립니다. (2020s Hyperpop Vocal Gloss)', style: 'glossy 2020s hyperpop vocal phrasing with clipped bright hooks', sound: 'bright processed vocal chops, tight digital phrasing, playful pitch color', mood: 'hyper, playful, futuristic' },
      { id: 'vocal-breezy-retro-pop', label: 'Breezy Retro-pop Feel', labelKo: '레트로 팝처럼 산뜻한', description: 'Light breezy retro-pop vocal phrasing with sweet clarity.', descriptionKo: '레트로 팝처럼 맑고 산뜻하게 흘러가는 보컬 표현입니다. (Breezy Retro-pop Feel)', style: 'breezy retro-pop vocal phrasing with sweet clarity', sound: 'light clear vocal lift with soft pop sparkle', mood: 'bright, nostalgic' },
      { id: 'vocal-citypop-smooth-groove', label: 'City-pop Smooth Groove', labelKo: '시티팝 보컬 그루브', description: 'Relaxed city-pop vocal phrasing with smooth groove, clean nostalgia, and light rhythmic swing.', descriptionKo: '시티팝처럼 힘을 빼고 리듬에 부드럽게 올라타는 보컬 표현입니다. 밤거리, 드라이브, 레트로 밴드 사운드에 잘 어울립니다. (City-pop Smooth Groove)', style: 'smooth city-pop vocal phrasing with relaxed nostalgic groove', sound: 'clean nostalgic vocal shine, light rhythmic swing, smooth pop glide', mood: 'urban, relaxed, nostalgic' },
      { id: 'vocal-trotpop-light-bend', label: 'Trot-pop Light Bend', labelKo: '트로트팝 꺾기 감성', description: 'Light trot-pop phrasing with tasteful Korean ggeok-gi, playful bends, and catchy emotional lift.', descriptionKo: '트로트팝처럼 과하지 않은 꺾기와 흥을 살리는 표현입니다. 세미트로트, 코믹형, 중독성 있는 후렴에 잘 어울립니다. (Trot-pop Light Bend)', style: 'light trot-pop vocal bend phrasing with tasteful Korean ggeok-gi', sound: 'playful vocal bends, catchy emotional lift, clear trot-pop inflection', mood: 'playful, sentimental, catchy' },
      { id: 'vocal-jpop-anime-opening', label: 'J-Pop Anime Opening Lift', labelKo: 'J-Pop 애니 오프닝 창법', description: 'Energetic J-pop anime opening-style delivery with clear high hooks, dramatic lift, and forward motion.', descriptionKo: 'J-Pop 애니 오프닝처럼 선명한 고음 훅과 앞으로 달려가는 에너지를 살리는 표현입니다. 빠른 전개와 밝은 록/팝에 잘 어울립니다. (J-Pop Anime Opening Lift)', style: 'energetic J-pop anime opening vocal delivery with clear high hook lift', sound: 'bright high hook, dramatic vocal lift, forward driving melody', mood: 'energetic, hopeful, dramatic' },
      { id: 'vocal-lofi-hushed', label: 'Lo-fi Hushed Vocal Feel', labelKo: '로파이 허밍 보컬', description: 'Quiet lo-fi vocal phrasing with hushed volume, soft grain, and intimate low-energy delivery.', descriptionKo: '로파이처럼 작게 흥얼거리듯 낮은 볼륨으로 부르는 표현입니다. 공부용, 새벽, 카세트 질감에 잘 어울립니다. (Lo-fi Hushed Vocal Feel)', style: 'hushed lo-fi vocal phrasing with intimate low-volume delivery', sound: 'soft grain, low-volume vocal, close sleepy humming', mood: 'calm, intimate, late-night' }
    ],
  },
  {
    id: 'special-effects',
    ...
    titleKo: '특수 효과',
    description: 'Adds special voice-tone processing to the main vocal character.',
    descriptionKo: '메인 보컬 목소리 자체에 특수한 보이스 톤과 실험적 질감을 더해요.',
    variants: [
      { id: 'separator-style-special-voice-tone', kind: 'separator', label: 'Voice Tone', labelKo: '보이스 톤', description: '', descriptionKo: '', promptCore: '' },
      { id: 'voice-auto-tuned', label: 'Auto-Tuned Voice', labelKo: '오토튠 보이스', description: 'Pitch-corrected modern pop voice color with clean digital tuning.', descriptionKo: '음정이 매끈하게 보정된 현대 팝/트랩 계열의 보이스 톤입니다. (Auto-Tuned Voice)', style: 'Auto-Tuned Voice texture', sound: 'subtle pitch-corrected voice color', mood: 'modern, polished' },
      { id: 'voice-hard-tuned', label: 'Hard-Tuned Voice', labelKo: '하드튠 보이스', description: 'Strongly audible tuning with a deliberately synthetic vocal edge.', descriptionKo: '튠이 일부러 드러나는 강한 기계적 보이스 톤입니다. (Hard-Tuned Voice)', style: 'Hard-Tuned Voice effect', sound: 'hard pitch-locked voice texture', mood: 'synthetic, bold' },
      { id: 'voice-vocoder', label: 'Vocoder Voice', labelKo: '보코더 보이스', description: 'Electronic voice tone blended with synth-like harmonic color.', descriptionKo: '신스와 목소리가 합쳐진 전자적인 보이스 톤입니다. (Vocoder Voice)', style: 'Vocoder Voice color', sound: 'synth-filtered voice harmonics', mood: 'futuristic, electronic' },
      { id: 'voice-robotic', label: 'Robotic Voice', labelKo: '로봇 보이스', description: 'Mechanical voice tone with restrained, machine-like emotion.', descriptionKo: '기계처럼 딱딱하고 감정이 절제된 보이스 톤입니다. (Robotic Voice)', style: 'Robotic Voice tone', sound: 'mechanical voice articulation', mood: 'cold, synthetic' },
      { id: 'voice-glitch', label: 'Glitch Voice', labelKo: '글리치 보이스', description: 'Digitally broken voice tone with small cuts and unstable edges.', descriptionKo: '중간중간 깨지고 끊기는 디지털 오류감의 보이스 톤입니다. (Glitch Voice)', style: 'Glitch Voice texture', sound: 'broken digital voice fragments', mood: 'unstable, experimental' },
      { id: 'voice-warped-tape', label: 'Warped Tape Voice', labelKo: '테이프 워프 보이스', description: 'Voice tone that wobbles like stretched or warped tape.', descriptionKo: '테이프가 늘어진 듯 흔들리고 불안정한 보이스 톤입니다. (Warped Tape Voice)', style: 'Warped Tape Voice instability', sound: 'pitch-wavering tape voice color', mood: 'nostalgic, unstable' },
      { id: 'voice-radio', label: 'Radio Voice', labelKo: '라디오 보이스', description: 'Narrow vintage voice tone like an old radio transmission.', descriptionKo: '오래된 라디오처럼 좁고 빈티지하게 들리는 보이스 톤입니다. (Radio Voice)', style: 'Radio Voice filter', sound: 'narrow vintage radio voice color', mood: 'retro, distant' },
      { id: 'voice-telephone', label: 'Telephone Voice', labelKo: '전화기 보이스', description: 'Thin and distant voice tone like a phone call.', descriptionKo: '전화기 너머처럼 얇고 멀게 들리는 보이스 톤입니다. (Telephone Voice)', style: 'Telephone Voice filter', sound: 'thin band-limited voice color', mood: 'distant, intimate' },
      { id: 'voice-megaphone', label: 'Megaphone Voice', labelKo: '메가폰 보이스', description: 'Rough projected voice tone like a street megaphone.', descriptionKo: '확성기처럼 거칠고 밖으로 튀어나오는 보이스 톤입니다. (Megaphone Voice)', style: 'Megaphone Voice projection', sound: 'harsh megaphone voice edge', mood: 'raw, urgent' },
      { id: 'voice-ghost', label: 'Ghost Voice', labelKo: '유령 보이스', description: 'Faint voice tone that feels distant, hollow, and floating.', descriptionKo: '멀리서 떠도는 듯 희미하고 공허한 보이스 톤입니다. (Ghost Voice)', style: 'Ghost Voice texture', sound: 'hollow distant voice haze', mood: 'haunting, airy' },
      { id: 'voice-dream-blurred', label: 'Dream-Blurred Voice', labelKo: '드림 블러 보이스', description: 'Softly smeared voice tone that feels half-remembered or dreamlike.', descriptionKo: '꿈속에서 들리는 듯 흐릿하고 몽환적인 보이스 톤입니다. (Dream-Blurred Voice)', style: 'Dream-Blurred Voice color', sound: 'soft smeared voice haze', mood: 'dreamy, blurred' },
      { id: 'voice-underwater', label: 'Underwater Voice', labelKo: '언더워터 보이스', description: 'Muffled voice tone as if heard underwater.', descriptionKo: '물속에서 들리는 듯 먹먹하고 둥글게 막힌 보이스 톤입니다. (Underwater Voice)', style: 'Underwater Voice muffling', sound: 'muffled submerged voice color', mood: 'submerged, surreal' },
      { id: 'voice-hologram', label: 'Hologram Voice', labelKo: '홀로그램 보이스', description: 'Futuristic voice tone that feels translucent and unstable.', descriptionKo: '실체 없이 빛처럼 흔들리는 미래적인 보이스 톤입니다. (Hologram Voice)', style: 'Hologram Voice shimmer', sound: 'translucent digital voice shimmer', mood: 'futuristic, weightless' },
      { id: 'voice-broken-speaker', label: 'Broken-Speaker Voice', labelKo: '깨진 스피커 보이스', description: 'Distorted voice tone like an overloaded or damaged speaker.', descriptionKo: '낡은 스피커처럼 찢어지고 과부하된 보이스 톤입니다. (Broken-Speaker Voice)', style: 'Broken-Speaker Voice distortion', sound: 'cracked speaker voice grit', mood: 'rough, damaged' },
      { id: 'voice-cracked-radio', label: 'Cracked-Radio Voice', labelKo: '크랙 라디오 보이스', description: 'Voice tone with radio noise, cracks, and unstable transmission.', descriptionKo: '잡음 섞인 라디오처럼 갈라지고 끊기는 보이스 톤입니다. (Cracked-Radio Voice)', style: 'Cracked-Radio Voice texture', sound: 'noisy cracked radio voice color', mood: 'retro, broken' },
      { id: 'voice-cyborg', label: 'Cyborg Voice', labelKo: '사이보그 보이스', description: 'Hybrid human-machine voice tone with controlled emotion.', descriptionKo: '인간성과 기계성이 섞인 절제된 보이스 톤입니다. (Cyborg Voice)', style: 'Cyborg Voice tone', sound: 'human-machine blended voice texture', mood: 'controlled, futuristic' },
      { id: 'voice-demon-whisper', label: 'Demon-Whisper Voice', labelKo: '악마 속삭임 보이스', description: 'Dark low whisper voice tone with an eerie distorted edge.', descriptionKo: '낮고 어둡게 뒤틀린 섬뜩한 속삭임 보이스 톤입니다. (Demon-Whisper Voice)', style: 'Demon-Whisper Voice texture', sound: 'dark distorted whisper voice', mood: 'eerie, ominous' },
      { id: 'voice-angelic-reverb', label: 'Angelic-Reverb Voice', labelKo: '천사 잔향 보이스', description: 'Bright voice tone with a long sacred reverb glow.', descriptionKo: '밝고 긴 잔향이 감도는 신성한 보이스 톤입니다. (Angelic-Reverb Voice)', style: 'Angelic-Reverb Voice glow', sound: 'bright sacred voice reverb', mood: 'ethereal, radiant' },
      { id: 'voice-pixelated', label: 'Pixelated Voice', labelKo: '픽셀 보이스', description: 'Digital voice tone broken into small pixel-like grains.', descriptionKo: '픽셀처럼 잘게 부서지는 디지털 보이스 톤입니다. (Pixelated Voice)', style: 'Pixelated Voice texture', sound: 'pixel-broken digital voice grains', mood: 'digital, playful' },
      { id: 'voice-granular', label: 'Granular Voice', labelKo: '그래뉼러 보이스', description: 'Experimental voice tone fragmented into tiny granular particles.', descriptionKo: '목소리가 작은 입자로 흩어지는 실험적인 보이스 톤입니다. (Granular Voice)', style: 'Granular Voice fragmentation', sound: 'grain-scattered vocal particles', mood: 'experimental, fragmented' }
    ],
  },
  {
    id: 'era-texture',
    title: 'Era Texture',
    titleKo: '시대 질감',
    description: 'Adds production colors and mix textures from different eras.',
    descriptionKo: '70s부터 2020s까지 시대별 사운드와 믹스 질감을 더해요.',
    variants: [
      // SORIDRAW_ERA_PREFIX_V12: 시대 질감 prefix layer. 기존 항목은 유지하고 장르 앞에 붙는 시대 레이어만 추가.
      { id: 'separator-style-era-prefix', kind: 'separator', label: 'Chronological Era', labelKo: '연대별', description: '', descriptionKo: '', promptCore: '' },
      { id: 'era-prefix-60s', label: '60s', labelKo: '60년대', description: 'Adds a 60s prefix before the main genre.', descriptionKo: '빈티지 소울, 록앤롤, 초기 팝의 따뜻한 아날로그 시대감입니다. (60s)', style: '60s', sound: 'warm vintage recording color', mood: 'classic, nostalgic' },
      { id: 'era-prefix-70s', label: '70s', labelKo: '70년대', description: 'Adds a 70s prefix before the main genre.', descriptionKo: '소울, 펑크, 디스코 기반의 따뜻하고 라이브한 시대감입니다. (70s)', style: '70s', sound: 'analog warmth, live groove', mood: 'vintage, warm' },
      { id: 'era-prefix-late-70s', label: 'late 70s', labelKo: '70년대 후반', description: 'Adds a late 70s prefix before the main genre.', descriptionKo: '디스코 전성기와 아날로그 그루브가 강한 레트로 시대감입니다. (late 70s)', style: 'late 70s', sound: 'disco-era polish, analog rhythm color', mood: 'retro, lively' },
      { id: 'era-prefix-early-80s', label: 'early 80s', labelKo: '80년대 초반', description: 'Adds an early 80s prefix before the main genre.', descriptionKo: '아날로그에서 디지털 신스로 넘어가는 초기 80년대 팝 감각입니다. (early 80s)', style: 'early 80s', sound: 'early digital synths, analog drums', mood: 'retro, clean' },
      { id: 'era-prefix-mid-80s', label: 'mid 80s', labelKo: '80년대 중반', description: 'Adds a mid 80s prefix before the main genre.', descriptionKo: 'DX 계열 건반, 글로시한 신스, 네온 팝 질감이 강한 시대감입니다. (mid 80s)', style: 'mid 80s', sound: 'DX-style keys, glossy synths', mood: 'neon, polished' },
      { id: 'era-prefix-late-80s', label: 'late 80s', labelKo: '80년대 후반', description: 'Adds a late 80s prefix before the main genre.', descriptionKo: '밝은 신스팝, 게이트 드럼, 세련된 80년대 후반 팝 질감입니다. (late 80s)', style: 'late 80s', sound: 'bright synth pop polish, gated drum feel', mood: 'nostalgic, glossy' },
      { id: 'era-prefix-early-90s', label: 'early 90s', labelKo: '90년대 초반', description: 'Adds an early 90s prefix before the main genre.', descriptionKo: '뉴잭스윙, 초기 R&B, 선명한 디지털 팝 리듬감입니다. (early 90s)', style: 'early 90s', sound: 'swingbeat drums, warm digital keys', mood: 'fresh, nostalgic' },
      { id: 'era-prefix-mid-90s', label: 'mid 90s', labelKo: '90년대 중반', description: 'Adds a mid 90s prefix before the main genre.', descriptionKo: '재지한 코드, 샘플 드럼, 부드러운 R&B/힙합 시대감입니다. (mid 90s)', style: 'mid 90s', sound: 'sampled drums, smooth R&B color', mood: 'mellow, urban' },
      { id: 'era-prefix-late-90s', label: 'late 90s', labelKo: '90년대 후반', description: 'Adds a late 90s prefix before the main genre.', descriptionKo: '라디오 팝, 댄스팝, 밝은 디지털 포인트가 섞인 시대감입니다. (late 90s)', style: 'late 90s', sound: 'polished pop mix, bright digital accents', mood: 'nostalgic, energetic' },
      { id: 'era-prefix-early-2000s', label: 'early 2000s', labelKo: '2000년대 초반', description: 'Adds an early 2000s prefix before the main genre.', descriptionKo: 'Y2K 팝, 글로시한 신스, 반짝이는 디지털 프로덕션 감각입니다. (early 2000s)', style: 'early 2000s', sound: 'glossy digital pop texture', mood: 'Y2K, shiny' },
      { id: 'era-prefix-y2k', label: 'Y2K', labelKo: 'Y2K', description: 'Adds a Y2K prefix before the main genre.', descriptionKo: '2000년대 초반의 반짝이는 디지털 팝, 틴팝, 링톤 감각입니다. (Y2K)', style: 'Y2K', sound: 'glossy digital synths, shiny pop drums', mood: 'shiny, nostalgic' },
      { id: 'era-prefix-mid-2000s', label: 'mid 2000s', labelKo: '2000년대 중반', description: 'Adds a mid 2000s prefix before the main genre.', descriptionKo: '깨끗한 라디오 팝 믹스와 선명한 디지털 드럼 시대감입니다. (mid 2000s)', style: 'mid 2000s', sound: 'radio pop polish, clean digital drums', mood: 'clear, nostalgic' },
      { id: 'era-prefix-late-2000s', label: 'late 2000s', labelKo: '2000년대 후반', description: 'Adds a late 2000s prefix before the main genre.', descriptionKo: '클럽팝 신스, 압축감 있는 라디오 믹스, 밝은 에너지의 시대감입니다. (late 2000s)', style: 'late 2000s', sound: 'club-pop synths, compressed radio mix', mood: 'bright, energetic' },
      { id: 'era-prefix-early-2010s', label: 'early 2010s', labelKo: '2010년대 초반', description: 'Adds an early 2010s prefix before the main genre.', descriptionKo: 'EDM 팝 빌드업과 페스티벌형 신스 리드가 강한 시대감입니다. (early 2010s)', style: 'early 2010s', sound: 'EDM-pop build, shiny synth lead', mood: 'festival, bright' },
      { id: 'era-prefix-mid-2010s', label: 'mid 2010s', labelKo: '2010년대 중반', description: 'Adds a mid 2010s prefix before the main genre.', descriptionKo: '트로피컬 팝, 깔끔한 사이드체인, 세련된 여름감의 시대감입니다. (mid 2010s)', style: 'mid 2010s', sound: 'tropical pop polish, clean sidechain', mood: 'sleek, summery' },
      { id: 'era-prefix-late-2010s', label: 'late 2010s', labelKo: '2010년대 후반', description: 'Adds a late 2010s prefix before the main genre.', descriptionKo: '미니멀 트랩팝 드럼과 정제된 보컬 공간감이 강한 시대감입니다. (late 2010s)', style: 'late 2010s', sound: 'minimal trap-pop drums, polished vocal space', mood: 'modern, restrained' },
      { id: 'era-prefix-early-2020s', label: 'early 2020s', labelKo: '2020년대 초반', description: 'Adds an early 2020s prefix before the main genre.', descriptionKo: '클린한 모던 팝 믹스와 단단한 디지털 저역의 시대감입니다. (early 2020s)', style: 'early 2020s', sound: 'clean modern pop mix, digital low-end', mood: 'modern, crisp' },
      { id: 'era-prefix-modern', label: 'modern', labelKo: '모던', description: 'Adds a modern prefix before the main genre.', descriptionKo: '현재형 팝 프로덕션처럼 깨끗하고 선명한 최신 믹스 감각입니다. (modern)', style: 'modern', sound: 'clean modern production', mood: 'current, polished' },
      { id: 'separator-style-era-genre-texture', kind: 'separator', label: 'Genre Era Texture', labelKo: '장르별 시대감', description: '', descriptionKo: '', promptCore: '' },
      { id: '70s-vintage-soul', label: '70s Vintage Soul', labelKo: '70s 빈티지 소울', description: 'Warm 70s soul-inspired production texture.', descriptionKo: '70년대 소울 감성의 따뜻한 빈티지 질감입니다. (70s Vintage Soul)', style: '70s vintage soul texture', sound: 'warm bass, analog drums, soulful keys', mood: 'warm, nostalgic' },
      { id: '80s-retro-synth', label: '80s Retro Synth', labelKo: '80s 레트로 신스', description: '80s-inspired synth and gated rhythm color.', descriptionKo: '80년대식 신스와 레트로 리듬 질감입니다. (80s Retro Synth)', style: '80s retro synth texture', sound: 'analog synths, gated drums, neon pads', mood: 'retro, cinematic' },
      { id: '90s-new-jack', label: '90s New Jack Swing', labelKo: '90s 뉴잭스윙', description: '90s new jack swing groove and pop-R&B rhythm.', descriptionKo: '90년대 뉴잭스윙 특유의 팝/R&B 리듬감입니다. (90s New Jack Swing)', style: '90s new jack swing groove', sound: 'swingbeat drums, bright keys, punchy rhythm', mood: 'fresh, rhythmic' },
      { id: '90s-rnb', label: '90s R&B Warmth', labelKo: '90s R&B 감성', description: 'Smooth 90s R&B warmth and vocal-friendly production.', descriptionKo: '90년대 R&B 특유의 부드럽고 따뜻한 감성입니다. (90s R&B Warmth)', style: '90s R&B smoothness', sound: 'warm chords, smooth drums, soulful bass', mood: 'smooth, nostalgic' },
      { id: '2000s-y2k-pop', label: '2000s Y2K Pop', labelKo: '2000s Y2K 팝', description: 'Glossy 2000s pop polish and digital brightness.', descriptionKo: '2000년대 Y2K 팝의 반짝이는 디지털 질감입니다. (2000s Y2K Pop)', style: '2000s Y2K pop polish', sound: 'glossy synths, crisp drums, bright hooks', mood: 'shiny, nostalgic' },
      { id: '2010s-edm-pop', label: '2010s EDM Pop', labelKo: '2010s EDM 팝', description: '2010s EDM-pop build and festival-ready shine.', descriptionKo: '2010년대 EDM 팝의 빌드업과 화려한 드롭감입니다. (2010s EDM Pop)', style: '2010s EDM pop energy', sound: 'big builds, sidechain synths, festival drops', mood: 'energetic, bright' },
      { id: '2010s-idol-pop', label: '2010s Idol Pop', labelKo: '2010s 아이돌 팝', description: '2010s idol-pop polish and section contrast.', descriptionKo: '2010년대 아이돌 팝의 세련된 구성과 섹션 대비감입니다. (2010s Idol Pop)', style: '2010s idol-pop polish', sound: 'sharp section changes, polished synths, addictive hooks', mood: 'bright, energetic' },
      { id: '2020s-hyperpop', label: '2020s Hyperpop Texture', labelKo: '2020s 하이퍼팝 질감', description: 'Hyperpop-inspired bright distortion and digital exaggeration.', descriptionKo: '2020년대 하이퍼팝의 과장된 디지털 질감입니다. (2020s Hyperpop Texture)', style: '2020s hyperpop texture', sound: 'pitched vocals, bright distortion, glitchy synths', mood: 'hyper, synthetic' },
      { id: '2020s-minimal-pop', label: '2020s Minimal Pop', labelKo: '2020s 미니멀 팝', description: 'Clean 2020s minimal pop production.', descriptionKo: '2020년대식 간결하고 세련된 미니멀 팝 질감입니다. (2020s Minimal Pop)', style: '2020s minimal pop polish', sound: 'clean drums, sparse synths, focused vocal space', mood: 'modern, restrained' },
      { id: 'separator-style-era-media-texture', kind: 'separator', label: 'Era Device Texture', labelKo: '시대 기기 질감', description: '', descriptionKo: '', promptCore: '' },
      { id: 'retro-radio', label: 'Retro Radio Texture', labelKo: '복고풍 라디오 질감', description: 'Old radio-like warm filter and nostalgic noise.', descriptionKo: '오래된 라디오처럼 따뜻하고 필터링된 질감입니다. (Retro Radio Texture)', style: 'retro radio texture', sound: 'filtered mids, soft noise, vintage broadcast warmth', mood: 'nostalgic, intimate' },
      { id: 'cassette-tape', label: 'Cassette Tape Texture', labelKo: '카세트 테이프 질감', description: 'Cassette warmth, wobble, and gentle hiss.', descriptionKo: '카세트 특유의 따뜻함과 흔들림, 히스 노이즈입니다. (Cassette Tape Texture)', style: 'cassette tape texture', sound: 'tape hiss, soft wobble, analog warmth', mood: 'lo-fi, nostalgic' },
      { id: 'analog-vintage', label: 'Analog Vintage', labelKo: '아날로그 빈티지', description: 'Analog warmth and vintage production color.', descriptionKo: '아날로그 장비 특유의 따뜻한 빈티지 질감입니다. (Analog Vintage)', style: 'analog vintage production', sound: 'soft saturation, warm harmonic color', mood: 'warm, classic' },
      { id: 'digital-y2k', label: 'Digital Y2K Texture', labelKo: '디지털 Y2K 질감', description: 'Early digital pop texture and Y2K brightness.', descriptionKo: '초기 디지털 팝의 밝고 인공적인 Y2K 질감입니다. (Digital Y2K Texture)', style: 'digital Y2K texture', sound: 'thin bright synths, crisp digital drums', mood: 'shiny, nostalgic' },
      { id: 'retro-game-sound', label: 'Retro Game Sound', labelKo: '레트로 게임 사운드', description: 'Retro game-inspired chiptune and pixel-like sound.', descriptionKo: '레트로 게임처럼 픽셀감 있는 전자음 질감입니다. (Retro Game Sound)', style: 'retro game sound texture', sound: 'chiptune leads, square waves, playful bleeps', mood: 'playful, nostalgic' },
      { id: 'old-mp3-texture', label: 'Old MP3 Texture', labelKo: '구형 MP3 질감', description: 'Compressed digital texture like old MP3 files.', descriptionKo: '구형 MP3처럼 압축감이 느껴지는 디지털 질감입니다. (Old MP3 Texture)', style: 'old MP3 compression texture', sound: 'compressed highs, narrow digital texture', mood: 'nostalgic, rough' },
      { id: 'separator-style-era-retro-mood', kind: 'separator', label: 'Era Culture Mood', labelKo: '시대 상황 / 문화감', description: '', descriptionKo: '', promptCore: '' },
      { id: 'cyworld-2000s', label: '2000s Cyworld Sentiment', labelKo: '2000s 싸이월드 감성', description: 'Korean 2000s internet-era sentimental pop mood.', descriptionKo: '2000년대 싸이월드 시절의 감성적인 대중가요 질감입니다. (2000s Cyworld Sentiment)', style: '2000s Korean internet-era sentiment', sound: 'soft piano, glossy strings, sentimental pop polish', mood: 'nostalgic, sentimental' },
      { id: 'early-internet', label: 'Early Internet Feel', labelKo: '초기 인터넷 감성', description: 'Early web-era digital nostalgia and amateur gloss.', descriptionKo: '초기 인터넷 시대의 어설프지만 반짝이는 디지털 감성입니다. (Early Internet Feel)', style: 'early internet nostalgia', sound: 'light digital textures, quirky synthetic accents', mood: 'nostalgic, quirky' },
      { id: 'neon-retro', label: 'Neon Retro Feel', labelKo: '네온 레트로 감성', description: 'Neon-lit retro-futurist pop color.', descriptionKo: '네온빛이 감도는 레트로 퓨처 감성입니다. (Neon Retro Feel)', style: 'neon retro-futurist texture', sound: 'glowing synths, polished retro drums', mood: 'stylish, nocturnal' },
      { id: 'era-prefix-neo-retro', label: 'neo-retro', labelKo: '네오 레트로', description: 'Adds a neo-retro prefix before the main genre.', descriptionKo: '복고 질감을 현대적인 믹스와 팝 프로덕션으로 재해석한 감각입니다. (neo-retro)', style: 'neo-retro', sound: 'retro color with modern polish', mood: 'stylish, nostalgic' },
      { id: 'era-prefix-future-retro', label: 'future-retro', labelKo: '퓨처 레트로', description: 'Adds a future-retro prefix before the main genre.', descriptionKo: '과거의 레트로 신스와 미래적인 전자 질감이 함께 있는 감각입니다. (future-retro)', style: 'future-retro', sound: 'retro synths, futuristic digital sheen', mood: 'futuristic, retro' },
      { id: 'era-prefix-retro-futuristic', label: 'retro-futuristic', labelKo: '레트로 퓨처', description: 'Adds a retro-futuristic prefix before the main genre.', descriptionKo: '복고적 상상력과 SF적인 미래 질감이 섞인 시네마틱 감각입니다. (retro-futuristic)', style: 'retro-futuristic', sound: 'neon synths, sci-fi retro polish', mood: 'cinematic, futuristic' },
      { id: 'era-prefix-timeless', label: 'timeless', labelKo: '타임리스', description: 'Adds a timeless feel before the main genre.', descriptionKo: '특정 시대에 묶이지 않는 클래식하고 오래가는 균형감입니다. (timeless)', style: 'timeless', sound: 'classic balanced production', mood: 'classic, universal' },
    ],
  },
  {
    id: 'stage-shift',
    ...
    titleKo: '전환 연출',
    description: 'Adds transition direction such as emotional shifts, scene changes, and contrast points.',
    descriptionKo: '곡 중간이나 후반에 흐름, 감정, 장면이 바뀌는 포인트를 더해요.',
    variants: [
      { id: 'separator-style-shift-slow', kind: 'separator', label: '서서히 전환', labelKo: '서서히 전환', description: '', descriptionKo: '', promptCore: '' },
      { id: 'slow-emotional-shift', label: 'Slow Emotional Shift', labelKo: '느린 감정 전환', description: 'A slow emotional change that turns the song gradually.', descriptionKo: '감정이 천천히 바뀌며 곡의 방향이 서서히 달라지는 전환입니다. (Slow Emotional Shift)', style: 'slow emotional transition', sound: 'gradual harmonic shading, softened section change', mood: 'subtle, reflective' },
      { id: 'gentle-bridge-shift', label: 'Gentle Bridge Shift', labelKo: '잔잔한 브릿지 전환', description: 'A calm bridge that changes the emotional angle without a hard impact.', descriptionKo: '강한 충격 없이 브릿지에서 잔잔하게 흐름을 바꾸는 전환입니다. (Gentle Bridge Shift)', style: 'gentle bridge transition', sound: 'soft bridge lift, light arrangement change', mood: 'tender, restrained' },
      { id: 'gradual-rise', label: 'Gradual Rise', labelKo: '서서히 고조', description: 'A gradual rise that builds energy step by step.', descriptionKo: '에너지가 한 번에 터지지 않고 단계적으로 차오르는 전환입니다. (Gradual Rise)', style: 'gradual rising transition', sound: 'slow layering and steady lift', mood: 'growing, patient' },
      { id: 'gradual-development', label: 'Gradual Development', labelKo: '점층적 전개', description: 'A progressive arrangement that grows in layers over time.', descriptionKo: '섹션이 진행될수록 층이 쌓이듯 커지는 점층적 전개입니다. (Gradual Development)', style: 'gradual layered development', sound: 'progressive layering, widening arrangement', mood: 'expanding, controlled' },
      { id: 'fade-transition', label: 'Fade Transition', labelKo: '페이드 전환', description: 'A soft transition using fade, release, or gentle dissolve.', descriptionKo: '페이드되거나 부드럽게 풀리면서 다음 구간으로 넘어가는 전환입니다. (Fade Transition)', style: 'soft fade transition', sound: 'fading tail, gentle dissolve, smooth crossfade feel', mood: 'floating, calm' },
      { id: 'improv-feel', label: 'Improvisational Feel', labelKo: '즉흥 연주감', description: 'Loose interplay and spontaneous instrumental motion.', descriptionKo: '즉흥적으로 주고받는 연주감을 더합니다. (Improvisational Feel)', style: 'improvisational interplay', sound: 'loose instrumental responses', mood: 'free, lively' },
      { id: 'separator-style-shift-strong', kind: 'separator', label: '강하게 전환', labelKo: '강하게 전환', description: '', descriptionKo: '', promptCore: '' },
      { id: 'modern-edm', label: 'EDM Build-up', labelKo: 'EDM 빌드업', description: 'Modern EDM build and polished drop energy.', descriptionKo: '현대적인 EDM 빌드업과 드롭감을 더합니다. (EDM Build-up)', style: 'modern EDM build-up and drops', sound: 'sharp builds, sidechain impact', mood: 'high energy, powerful' },
      { id: 'climax-band-up', label: 'Climax Band-up', labelKo: '클라이맥스 밴드업', description: 'Band arrangement grows toward a bigger climax.', descriptionKo: '후반 클라이맥스로 밴드가 점점 커지는 전개입니다. (Climax Band-up)', style: 'climax band build-up', sound: 'growing drums and guitars', mood: 'rising, cathartic' },
      { id: 'hard-rap-flow', label: 'Hard Rap Flow', labelKo: '강한 랩 전환', description: 'Harder rap energy with stronger rhythmic attack.', descriptionKo: '강한 어택감의 랩 전환을 더합니다. (Hard Rap Flow)', style: 'hard rap flow emphasis', sound: 'aggressive rhythmic phrasing', mood: 'intense, bold' },
      { id: 'aggressive-rap', label: 'Aggressive Rap', labelKo: '공격적 랩 전환', description: 'Forceful rap sections with aggressive phrasing.', descriptionKo: '공격적인 랩 파트로 전환감을 강화합니다. (Aggressive Rap)', style: 'aggressive rap section energy', sound: 'sharp vocal attack over hard drums', mood: 'angry, powerful' },
      { id: 'sudden-switch-structure', label: 'Sudden Switch Structure', labelKo: '급전환 구조', description: 'Abrupt switches between contrasting sections.', descriptionKo: '서로 다른 구간이 갑자기 전환되는 구조입니다. (Sudden Switch Structure)', style: 'sudden switch structure', sound: 'sharp section cuts and contrast', mood: 'unstable, surprising' },
      { id: 'reverse-drop', label: 'Reversal Drop', labelKo: '반전 드롭', description: 'A drop that reverses the expected mood.', descriptionKo: '예상과 다른 방향으로 터지는 반전 드롭입니다. (Reversal Drop)', style: 'reversal drop structure', sound: 'surprise drop and contrast impact', mood: 'shocking, dynamic' },
      { id: 'dramatic-drop', label: 'Dramatic Drop', labelKo: '극적 드롭', description: 'Sudden explosive drops and impact moments.', descriptionKo: '갑작스러운 드롭으로 극적인 충격을 만드는 스타일입니다. (Dramatic Drop)', style: 'dramatic drop-driven transition', sound: 'abrupt drops, strong transient impact', mood: 'explosive, theatrical' },
      { id: 'separator-style-shift-character-contrast', kind: 'separator', label: '감정 반전', labelKo: '감정 반전', description: '', descriptionKo: '', promptCore: '' },
      { id: 'bright-to-dark', label: 'Bright to Dark', labelKo: '밝음에서 어둠으로', description: 'A bright surface turns into dark emotional pressure.', descriptionKo: '밝은 분위기가 어두운 압박감으로 뒤집히는 전환입니다. (Bright to Dark)', style: 'bright-to-dark contrast', sound: 'major-to-minor shift, darker beat entry', mood: 'surprising, ominous' },
      { id: 'sweet-to-aggressive', label: 'Sweet to Aggressive', labelKo: '달콤함에서 공격성으로', description: 'Sweet melody turns into aggressive vocal or beat energy.', descriptionKo: '달콤한 멜로디가 공격적인 보컬/비트로 뒤집힙니다. (Sweet to Aggressive)', style: 'sweet-to-aggressive switch', sound: 'soft hook shifting into hard rap or trap drop', mood: 'volatile, exciting' },
      { id: 'cute-to-madness', label: 'Cute to Madness', labelKo: '귀여움에서 광기로', description: 'Cute energy snaps into unstable madness.', descriptionKo: '귀여운 느낌이 불안한 광기와 공격성으로 뒤집힙니다. (Cute to Madness)', style: 'cute-to-madness switch', sound: 'sugary hook snapping into aggressive rap or distorted drop', mood: 'playful, menacing' },
      { id: 'dual-persona-shift', label: 'Dual Persona Shift', labelKo: '이중 페르소나 전환', description: 'Two contrasting personas alternate in the same track.', descriptionKo: '한 곡 안에서 두 개의 페르소나가 오가는 전환입니다. (Dual Persona Shift)', style: 'dual-persona transition', sound: 'contrasting vocal and beat sections', mood: 'split, theatrical' },
      { id: 'theatrical-idol-shift', label: 'Theatrical Idol Shift', labelKo: '극장식 아이돌 전환', description: 'Idol-pop performance shifts like a theatrical scene.', descriptionKo: '아이돌 무대가 극장처럼 장면 전환되는 연출입니다. (Theatrical Idol Shift)', style: 'theatrical idol-pop shift', sound: 'stage hits, bright hooks, sudden darker sections', mood: 'dramatic, playful' },
      { id: 'separator-style-shift-scene-impact', kind: 'separator', label: '장면 충격', labelKo: '장면 충격', description: '', descriptionKo: '', promptCore: '' },
      { id: 'horror-pop', label: 'Horror Pop', labelKo: '공포 분위기 전환', description: 'Pop structure colored with psychological horror tension.', descriptionKo: '팝 구조 위에 공포 분위기와 불안을 얹는 전환입니다. (Horror Pop)', style: 'horror-pop tension', sound: 'eerie synth stabs, low pulses, unsettling accents', mood: 'creepy, anxious' },
      { id: 'psycho-horror-shift', label: 'Psychological Horror Shift', labelKo: '심리 공포 전환', description: 'A psychological horror turn hidden inside pop performance.', descriptionKo: '밝은 곡 안에 심리공포가 갑자기 드러나는 전환입니다. (Psychological Horror Shift)', style: 'psychological horror transition', sound: 'low drones, eerie accents, sudden silence', mood: 'disturbing, tense' },
      { id: 'dark-trap-switch', label: 'Dark Trap Switch', labelKo: '어두운 트랩 전환', description: 'Bright pop sections switch into dark trap drops.', descriptionKo: '밝은 구간이 묵직하고 어두운 트랩으로 꺾이는 전환입니다. (Dark Trap Switch)', style: 'abrupt dark trap switch', sound: 'heavy 808, sharp hi-hats, sudden beat drops', mood: 'tense, menacing' },
      { id: 'stage-collapse', label: 'Stage Collapse', labelKo: '무대 붕괴감', description: 'A polished stage performance collapses into chaos.', descriptionKo: '완성된 무대가 점점 혼돈으로 무너지는 느낌입니다. (Stage Collapse)', style: 'stage-performance collapse', sound: 'crowd chants, broken transitions, distorted stage accents', mood: 'chaotic, theatrical' },
      { id: 'lights-collapse', label: 'Lighting Collapse', labelKo: '조명 붕괴감', description: 'Stage lights feel like they collapse into darkness.', descriptionKo: '무대 조명이 무너져 어둠으로 내려앉는 느낌입니다. (Lighting Collapse)', style: 'stage-light collapse imagery', sound: 'blinding hits falling into dark low-end', mood: 'dramatic, unsettling' },
      { id: 'crowd-shift', label: 'Crowd Shift', labelKo: '관객 함성 전환', description: 'Crowd energy becomes part of the transition.', descriptionKo: '관객 함성이 곡 전환의 일부처럼 작동합니다. (Crowd Shift)', style: 'crowd-energy transition', sound: 'crowd chants, arena shouts, sudden cuts', mood: 'performative, intense' },
      { id: 'chaotic-stage-shift', label: 'Chaotic Stage Shift', labelKo: '혼돈 무대 전환', description: 'Fast unstable transitions between performance states.', descriptionKo: '서로 다른 무대 상태가 빠르게 전환되는 혼돈형 스타일입니다. (Chaotic Stage Shift)', style: 'chaotic stage-shift structure', sound: 'sudden cuts, rhythmic shocks, crowd energy', mood: 'chaotic, unpredictable' }
    ],
  },
  {
    id: 'space-texture',
    title: 'Space Texture',
    titleKo: '공간 질감',
    description: 'Adds distance, place, ambience, and reverb-like spatial color.',
    descriptionKo: '소리의 거리감, 장소감, 잔향처럼 들리는 공간을 더해요.',
    variants: [
      { id: 'separator-style-space-specific-place', kind: 'separator', label: '특정 장소', labelKo: '특정 장소', description: '', descriptionKo: '', promptCore: '' },
      { id: 'car-interior', label: 'Car Interior Intimacy', labelKo: '차 안 밀폐감', description: 'Closed and intimate sound like singing inside a car.', descriptionKo: '차 안에서 부르는 듯한 밀폐되고 가까운 공간감입니다. (Car Interior Intimacy)', style: 'car-interior intimate space', sound: 'tight dry vocal room with soft reflections', mood: 'private, close' },
      { id: 'tunnel-echo', label: 'Tunnel Echo', labelKo: '터널 메아리', description: 'tunnel echo - Long tunnel reflections with a moving echo tail.', descriptionKo: '터널 안에서 울리는 긴 메아리와 이동감 있는 반사음입니다. (tunnel echo)', style: 'tunnel echo space', sound: 'long metallic echoes', mood: 'lonely, cinematic' },
      { id: 'bathroom-reverb', label: 'Bathroom Reverb', labelKo: '욕실 울림', description: 'Small tiled-room reverb with bright reflections.', descriptionKo: '욕실 타일에 반사되는 듯한 밝고 작은 울림입니다. (Bathroom Reverb)', style: 'bathroom reverb texture', sound: 'short bright room reflections', mood: 'raw, intimate' },
      { id: 'live-hall-space', label: 'Live Hall Space', labelKo: '공연장 라이브감', description: 'Open live hall space with audience-like depth.', descriptionKo: '공연장처럼 넓게 열리는 라이브 공간감입니다. (Live Hall Space)', style: 'live hall spatial energy', sound: 'room depth, live ambience', mood: 'open, performative' },
      { id: 'live-stage-energy', label: 'Live Stage Energy', labelKo: '라이브 무대감', description: 'Live stage ambience with open performance energy.', descriptionKo: '라이브 무대에서 연주하는 듯한 현장감을 더합니다. (Live Stage Energy)', style: 'live stage energy', sound: 'stage ambience, open room energy', mood: 'alive, open' },
      { id: 'alley-reverb', label: 'Alley Reverb', labelKo: '골목 잔향', description: 'Narrow street reflections with late-night air.', descriptionKo: '좁은 골목에서 울리는 듯한 늦은 밤의 잔향감입니다. (Alley Reverb)', style: 'narrow alley reverb', sound: 'short urban reflections', mood: 'nocturnal, intimate' },
      { id: 'club-space', label: 'Club Room Energy', labelKo: '클럽 울림', description: 'Dense low-end room feel like a small club.', descriptionKo: '작은 클럽 안에서 저음이 차오르는 듯한 공간감입니다. (Club Room Energy)', style: 'club-room spatial pressure', sound: 'dense low-end reflections', mood: 'physical, immersive' },
      { id: 'airport-announcement', label: 'Airport Announcement Feel', labelKo: '공항 방송감', description: 'A public-address sense with distant movement.', descriptionKo: '공항 안내방송처럼 멀고 이동감 있는 공간 질감입니다. (Airport Announcement Feel)', style: 'airport PA spatial texture', sound: 'distant announcement-like ambience', mood: 'transient, wistful' },
      { id: 'cathedral-hall', label: 'Cathedral Hall Reverb', labelKo: '성당 홀 울림', description: 'Large sacred hall reverb with long decay.', descriptionKo: '성당 홀처럼 길고 성스러운 울림을 더합니다. (Cathedral Hall Reverb)', style: 'cathedral hall reverb', sound: 'long lush decay', mood: 'sacred, grand' },
      { id: 'rooftop-night-air', label: 'Rooftop Night Air', labelKo: '옥상 밤공기', description: 'Open rooftop atmosphere with night air and city distance.', descriptionKo: '도시가 멀리 내려다보이는 옥상 밤공기 같은 질감입니다. (Rooftop Night Air)', style: 'rooftop night atmosphere', sound: 'wide air, distant city ambience', mood: 'lonely, open' },
      { id: 'separator-style-space-real', kind: 'separator', label: '현실 공간', labelKo: '현실 공간', description: '', descriptionKo: '', promptCore: '' },
      { id: 'dawn-street-air', label: 'Dawn Street Air', labelKo: '새벽 거리 공기', description: 'Cool open air texture like singing on an empty dawn street.', descriptionKo: '새벽 거리의 차갑고 빈 공기가 느껴지는 공간 질감입니다. (Dawn Street Air)', style: 'empty dawn street atmosphere', sound: 'cool open ambience', mood: 'quiet, lonely' },
      { id: 'basement-damp', label: 'Damp Basement Texture', labelKo: '지하실 습기감', description: 'Dark, humid, enclosed room texture.', descriptionKo: '지하실처럼 어둡고 습한 폐쇄감이 느껴지는 질감입니다. (Damp Basement Texture)', style: 'damp basement texture', sound: 'dark enclosed reflections', mood: 'heavy, uneasy' },
      { id: 'empty-room-reverb', label: 'Empty Room Reverb', labelKo: '빈 방의 잔향', description: 'Sparse room reflections with emotional emptiness.', descriptionKo: '빈 방에 혼자 남은 듯한 휑한 잔향감입니다. (Empty Room Reverb)', style: 'empty-room reverb', sound: 'sparse room tail', mood: 'hollow, still' },
      { id: 'room-reverb', label: 'Room Reverb', labelKo: '작은 방 울림', description: 'room reverb - 작은 방에서 울리는 친밀한 리버브입니다.', descriptionKo: '작은 방에서 울리는 친밀한 리버브입니다. (room reverb)', style: 'room reverb texture', sound: 'short room reflections', mood: 'intimate, close' },
      { id: 'wide-reverb', label: 'Wide Reverb', labelKo: '넓은 리버브', description: 'wide reverb - 공간을 크게 넓히는 리버브입니다.', descriptionKo: '공간을 크게 넓히는 리버브입니다. (wide reverb)', style: 'wide reverb space', sound: 'wide reverb tail', mood: 'open, spacious' },
      { id: 'rain-ambience', label: 'Rain Ambience', labelKo: '비 오는 공간감', description: 'rain ambience - 비 오는 배경의 촉촉한 공간감입니다.', descriptionKo: '비 오는 배경의 촉촉한 공간감입니다. (rain ambience)', style: 'rain ambience space', sound: 'rainy background ambience', mood: 'wet, quiet' },
      { id: 'city-ambience', label: 'City Ambience', labelKo: '도시 소음 질감', description: 'urban ambience - 도시의 소음과 공기가 섞인 배경감입니다.', descriptionKo: '도시의 소음과 공기가 섞인 배경감입니다. (urban ambience)', style: 'urban ambience texture', sound: 'city background noise', mood: 'urban, lived-in' },
      { id: 'ocean-ambience', label: 'Ocean Ambience', labelKo: '바다 배경 질감', description: 'ocean ambience - 파도와 바다 공기가 느껴지는 배경감입니다.', descriptionKo: '파도와 바다 공기가 느껴지는 배경감입니다. (ocean ambience)', style: 'ocean ambience space', sound: 'wave background ambience', mood: 'coastal, open' },
      { id: 'distant-voice', label: 'Distant Voice Feel', labelKo: '멀리서 들리는 느낌', description: 'A faraway vocal image with emotional distance.', descriptionKo: '멀리서 들려오는 듯한 거리감 있는 보컬 공간입니다. (Distant Voice Feel)', style: 'distant vocal image', sound: 'far reverb, softened presence', mood: 'remote, nostalgic' },
      { id: 'phone-filter', label: 'Over-the-phone Texture', labelKo: '전화기 너머', description: 'Filtered vocal texture like a voice coming through a phone.', descriptionKo: '전화기 너머에서 들리는 듯한 필터 처리된 질감입니다. (Over-the-phone Texture)', style: 'telephone-filtered vocal texture', sound: 'narrow-band filtered voice', mood: 'distant, nostalgic' },
      { id: 'radio-texture', label: 'Radio Texture', labelKo: '라디오 질감', description: 'Broadcast-like warmth and slight analog noise.', descriptionKo: '라디오 방송처럼 따뜻하고 살짝 노이즈가 있는 질감입니다. (Radio Texture)', style: 'radio-broadcast texture', sound: 'analog noise, softened midrange', mood: 'nostalgic, warm' },
      { id: 'separator-style-space-surreal', kind: 'separator', label: '비현실 공간', labelKo: '비현실 공간', description: '', descriptionKo: '', promptCore: '' },
      { id: 'space-echo-orbit', label: 'Outer-space Reverb', labelKo: '우주 잔향감', description: 'A distant, weightless spatial feel like sound floating in space.', descriptionKo: '우주 공간에 소리가 떠 있는 듯한 넓고 차가운 잔향감입니다. (Outer-space Reverb)', style: 'outer-space spatial texture', sound: 'wide reverb, distant ambience', mood: 'lonely, weightless' },
      { id: 'underwater-muffle', label: 'Underwater Muffle', labelKo: '수중 먹먹함', description: 'Muffled sound texture as if heard underwater.', descriptionKo: '물속에서 듣는 듯 먹먹하고 둔탁한 공간 질감입니다. (Underwater Muffle)', style: 'underwater muffled atmosphere', sound: 'low-pass filtered ambience, softened transients', mood: 'submerged, dreamy' },
  ...
  },
  {
    ...
    titleKo: '서사 연출',
    description: 'Adds story-driven direction such as OST emotion, scene scale, and cinematic build.',
    descriptionKo: 'OST, 장면감, 웅장한 전개처럼 곡의 이야기 연출을 더해요.',
    variants: [
      { id: 'separator-style-theme-ost-scene', kind: 'separator', label: 'OST/장면감', labelKo: 'OST/장면감', description: '', descriptionKo: '', promptCore: '' },
      { id: 'ost-emotion', label: 'OST Emotion', labelKo: 'OST 감성', description: 'Drama or film OST-like emotional development.', descriptionKo: '드라마나 영화 OST 같은 감정 전개를 더합니다. (OST Emotion)', style: 'OST-like emotional development', sound: 'theme-driven melodic lift', mood: 'emotional, narrative' },
      { id: 'narrative-atmosphere', label: 'Narrative Atmosphere', labelKo: '서사적인 분위기', description: 'Story-like atmosphere with a clear emotional arc.', descriptionKo: '이야기처럼 느껴지는 서사적 분위기입니다. (Narrative Atmosphere)', style: 'narrative atmosphere', sound: 'theme motifs and paced development', mood: 'story-driven, immersive' },
      ...
      { id: 'scene-transition', label: 'Scene Transition', labelKo: '장면 전환감', description: 'Arrangement that feels like scene changes in a film.', descriptionKo: '영화 장면이 바뀌듯 전환되는 느낌입니다. (Scene Transition)', style: 'scene-transition arrangement', sound: 'sectional cinematic shifts', mood: 'dynamic, visual' },
      ...
      { id: 'dramatic-strings', label: 'Dramatic Strings', labelKo: '극적인 스트링', description: 'Dramatic string movement for emotional height.', descriptionKo: '감정을 높이는 극적인 스트링 움직임입니다. (Dramatic Strings)', style: 'dramatic string writing', sound: 'rising string lines', mood: 'emotional, cinematic' },
      { id: 'orchestral-hit', label: 'Orchestral Hits', labelKo: '오케스트라 히트', description: 'Orchestral impact hits for dramatic moments.', descriptionKo: '극적인 순간에 오케스트라 히트감을 더합니다. (Orchestral Hits)', style: 'orchestral impact moments', sound: 'brass and string hits', mood: 'dramatic, intense' },
      { id: 'large-scale-sound', label: 'Large-scale Sound', labelKo: '스케일 큰 사운드', description: 'Large-scale arrangement and wide sonic image.', descriptionKo: '크고 넓게 펼쳐지는 대형 사운드입니다. (Large-scale Sound)', style: 'large-scale sonic image', sound: 'wide layers and big dynamic spread', mood: 'epic, spacious' },
      { id: 'grand-development', label: 'Grand Development', labelKo: '웅장한 전개', description: 'Large and expansive arrangement growth.', descriptionKo: '스케일이 커지는 웅장한 전개감입니다. (Grand Development)', style: 'grand arrangement development', sound: 'expanding layers and wide dynamics', mood: 'epic, powerful' },
      ...
      { id: 'trailer-feel', label: 'Trailer Feel', labelKo: '영화 예고편 느낌', description: 'Trailer-like build with bold impacts.', descriptionKo: '영화 예고편처럼 강한 빌드업과 임팩트를 줍니다. (Trailer Feel)', style: 'trailer-like dramatic build', sound: 'impact hits, risers, big drums', mood: 'intense, suspenseful' },
      { id: 'heroic-rise', label: 'Heroic Rise', labelKo: '영웅적 상승감', description: 'Heroic upward lift and triumphant scale.', descriptionKo: '영웅적으로 차오르는 상승감을 더합니다. (Heroic Rise)', style: 'heroic rising development', sound: 'bright brass, rising drums, wide chords', mood: 'heroic, uplifting' },
      { id: 'tragic-climax', label: 'Tragic Climax', labelKo: '비극적 클라이맥스', description: 'A climactic moment colored by tragedy.', descriptionKo: '비극적인 감정이 터지는 클라이맥스입니다. (Tragic Climax)', style: 'tragic climax focus', sound: 'minor swelling layers', mood: 'tragic, intense' }
    ],
  },
  {
    id: 'hook-addiction',
    ...
    descriptionKo: '후렴, 훅, 반복 라인의 중독성과 기억성을 강화해요.',
    variants: [
      ...
      { id: 'repeated-slogan', label: 'Repeated Slogan', labelKo: '반복되는 구호', description: 'A slogan-like phrase repeats as a hook device.', descriptionKo: '구호처럼 반복되는 문구로 훅을 만듭니다. (Repeated Slogan)', style: 'repeated slogan hook', sound: 'chantable phrase repetition', mood: 'bold, performative' },
      { id: 'addictive-repeat', label: 'Addictive Repetition', labelKo: '중독성 있는 반복', description: 'Repetitive hook phrases that build familiarity.', descriptionKo: '짧고 반복적인 훅으로 중독성을 더합니다. (Addictive Repetition)', style: 'addictive repeated hook phrases', sound: 'loop-friendly hook rhythm', mood: 'catchy, hypnotic' },
  ...
  },
  {
    ...
    title: 'Groove Rhythm',
    titleKo: '리듬감',
    description: 'Adds rhythmic movement such as beat patterns, groove, bounce, and loops.',
    descriptionKo: '곡을 움직이는 박자, 그루브, 바운스, 루프 흐름을 더해요.',
    variants: [
      { id: 'separator-style-rhythm-tight', kind: 'separator', label: 'Beat', labelKo: '박자', description: '', descriptionKo: '', promptCore: '' },
      { id: 'straight-beat', label: 'Straight Beat', labelKo: '정박 리듬', description: 'A straight, stable beat with clean timing.', descriptionKo: '흔들림 없이 정박으로 꽂히는 안정적인 리듬입니다. (Straight Beat)', style: 'straight beat rhythm', sound: 'stable kick-snare timing, clean pulse', mood: 'steady, clear' },
      { id: 'offbeat-rhythm', label: 'Offbeat Rhythm', labelKo: '엇박 리듬', description: 'Rhythm that accents the offbeats for a pushed or playful feel.', descriptionKo: '정박 사이를 살짝 비껴 치며 긴장감과 움직임을 주는 리듬입니다. (Offbeat Rhythm)', style: 'offbeat rhythmic accents', sound: 'offbeat accents, syncopated hits', mood: 'playful, moving' },
      { id: 'syncopated-rhythm', label: 'Syncopated Rhythm', labelKo: '당김음 리듬', description: 'Syncopated rhythm that pulls accents ahead of expectation.', descriptionKo: '강세를 예상보다 앞이나 사이에 두어 당기는 느낌을 만드는 리듬입니다. (Syncopated Rhythm)', style: 'syncopated rhythmic phrasing', sound: 'pushed accents, syncopated percussion', mood: 'groovy, lively' },
      { id: 'staccato-rhythm', label: 'Staccato Rhythm', labelKo: '스타카토 리듬', description: 'Sharp, short rhythmic articulation.', descriptionKo: '음 하나하나를 짧고 또렷하게 끊어 주는 리듬입니다. (Staccato Rhythm)', style: 'staccato rhythmic articulation', sound: 'tight short accents', mood: 'sharp, precise' },
      { id: 'dense-rhythm', label: 'Cutting Rhythm', labelKo: '끊어치는 리듬', description: 'A rhythm that cuts the flow with clear rhythmic breaks.', descriptionKo: '흐름 중간을 툭툭 끊어 치며 긴장감과 선명한 박자감을 만드는 리듬입니다. (Cutting Rhythm)', style: 'cutting rhythmic accents', sound: 'short rhythmic cuts, clipped percussion hits', mood: 'sharp, punchy' },
      { id: 'half-time-rhythm', label: 'Half-time Rhythm', labelKo: '하프타임 리듬', description: 'A rhythm that feels slower and heavier by stretching the pulse.', descriptionKo: '박자가 넓게 느껴져 느리고 묵직하게 가라앉는 리듬입니다. (Half-time Rhythm)', style: 'half-time rhythmic feel', sound: 'wide snare spacing, heavy laid-back pulse', mood: 'heavy, spacious' },
      { id: 'double-time-rhythm', label: 'Double-time Rhythm', labelKo: '더블타임 리듬', description: 'A rhythm that feels twice as fast without necessarily changing the song tempo.', descriptionKo: '곡의 실제 템포보다 두 배 빠르게 움직이는 듯한 긴장감 있는 리듬입니다. (Double-time Rhythm)', style: 'double-time rhythmic feel', sound: 'fast hi-hats, rapid rhythmic motion', mood: 'urgent, energetic' },
      { id: 'three-beat-flow', label: 'Gentle Three-beat', labelKo: '잔잔한 3박자', description: 'A gentle waltz-like three-beat flow with rounded motion.', descriptionKo: '하나-둘-셋으로 잔잔하게 흔들리는 왈츠 같은 3박자 흐름입니다. (Gentle Three-beat)', style: 'gentle three-beat waltz-like flow', sound: 'rounded 3-beat pulse, gentle sway', mood: 'romantic, flowing' },
      { id: 'six-eight-flow', label: 'Rolling 6/8 Beat', labelKo: '출렁이는 6/8박자', description: 'A rolling 6/8 feel with two large waves per bar.', descriptionKo: '여섯 박이 두 덩어리로 출렁이며 물결처럼 밀려오는 6/8박자 흐름입니다. (Rolling 6/8 Beat)', style: 'rolling 6/8 rhythmic flow', sound: 'rolling compound pulse, two-wave movement', mood: 'emotional, sweeping' },
      { id: 'irregular-meter-rhythm', label: 'Irregular Meter Rhythm', labelKo: '변박 리듬', description: 'An irregular meter feel with intentionally shifting pulse.', descriptionKo: '박자의 길이가 일정하지 않게 바뀌며 독특한 긴장감을 주는 리듬입니다. (Irregular Meter Rhythm)', style: 'irregular meter rhythm', sound: 'shifting pulse, uneven rhythmic pattern', mood: 'unpredictable, tense' },
      { id: 'tight-rhythm', label: 'Solid Rhythm', labelKo: '단단한 리듬', description: 'A firm rhythm with clean punch and stable timing.', descriptionKo: '박자가 흐트러지지 않고 단단하게 받쳐주는 리듬입니다. (Solid Rhythm)', style: 'solid tight rhythm', sound: 'clean punchy rhythm section', mood: 'controlled, firm' },
      { id: 'restrained-rhythm', label: 'Restrained Rhythm', labelKo: '절제된 리듬', description: 'A controlled rhythm that keeps power without overplaying.', descriptionKo: '과하게 몰아치지 않고 힘을 아껴 정돈하는 리듬입니다. (Restrained Rhythm)', style: 'restrained controlled rhythm', sound: 'minimal tight drums, controlled accents', mood: 'focused, restrained' },
      { id: 'separator-style-rhythm-groove', kind: 'separator', label: '그루브', labelKo: '그루브', description: '', descriptionKo: '', promptCore: '' },
      { id: 'loose-groove', label: 'Loose Groove', labelKo: '느슨한 그루브', description: 'Relaxed groove that sits behind the beat.', descriptionKo: '박자 뒤에 느슨하게 걸치는 그루브감을 더합니다. (Loose Groove)', style: 'loose laid-back groove', sound: 'behind-the-beat rhythm', mood: 'relaxed, chill' },
      { id: 'groovy-flow', label: 'Groovy Flow', labelKo: '흐르는 그루브', description: 'A continuous groove that keeps the track moving.', descriptionKo: '곡 전체를 자연스럽게 밀어주는 흐르는 그루브입니다. (Groovy Flow)', style: 'continuous groovy flow', sound: 'smooth rhythmic continuity', mood: 'steady, stylish' },
      { id: 'lazy-groove', label: 'Lazy Groove', labelKo: '나른한 그루브', description: 'A lazy groove with relaxed weight and warm drag.', descriptionKo: '살짝 뒤로 기대는 듯한 나른한 리듬 그루브입니다. (Lazy Groove)', style: 'lazy laid-back groove', sound: 'relaxed pocket, warm rhythmic drag', mood: 'lazy, warm' },
      { id: 'sticky-groove', label: 'Sticky Groove', labelKo: '끈적한 그루브', description: 'A sticky groove with sensual weight and slow pull.', descriptionKo: '리듬이 끈적하게 달라붙는 듯한 진한 그루브입니다. (Sticky Groove)', style: 'sticky sensual groove', sound: 'thick bass pocket, slow rhythmic pull', mood: 'sensual, deep' },
      { id: 'night-air-groove', label: 'Night-air Groove', labelKo: '밤공기 그루브', description: 'A late-night groove with soft movement and air.', descriptionKo: '밤공기처럼 부드럽고 여유롭게 흐르는 그루브입니다. (Night-air Groove)', style: 'night-air groove feel', sound: 'soft late-night rhythm, airy groove', mood: 'nocturnal, smooth' },
      { id: 'loose-rap-groove', label: 'Loose Rap Groove', labelKo: '랩 그루브', description: 'Relaxed rap rhythm with a loose pocket.', descriptionKo: '랩 플로우가 자연스럽게 얹히는 말맛 있는 그루브입니다. (Loose Rap Groove)', style: 'loose rap groove', sound: 'laid-back beat pocket', mood: 'cool, relaxed' },
      { id: 'separator-style-rhythm-bounce', kind: 'separator', label: '바운스', labelKo: '바운스', description: '', descriptionKo: '', promptCore: '' },
      { id: 'bounce-feel', label: 'Bounce Feel', labelKo: '소프트 바운스', description: 'A bouncy, elastic rhythmic feel.', descriptionKo: '몸이 자연스럽게 움직이는 부드러운 바운스감을 더합니다. (Bounce Feel)', style: 'bouncy rhythmic feel', sound: 'elastic groove and playful accents', mood: 'light, groovy' },
      { id: 'playful-bounce', label: 'Playful Bounce', labelKo: '장난스런 바운스', description: 'A playful bounce with light, witty movement.', descriptionKo: '가볍고 장난스럽게 튀는 리듬 바운스입니다. (Playful Bounce)', style: 'playful rhythmic bounce', sound: 'light bounce accents, witty rhythmic taps', mood: 'playful, bright' },
      { id: 'shuffle-rhythm', label: 'Shuffle Rhythm', labelKo: '셔플 바운스', description: 'Shuffle rhythm with rolling movement.', descriptionKo: '구르는 듯한 셔플 바운스감을 더합니다. (Shuffle Rhythm)', style: 'shuffle rhythmic movement', sound: 'rolling groove feel', mood: 'easygoing, rhythmic' },
      { id: 'step-bounce', label: 'Step Bounce', labelKo: '스텝 바운스', description: 'A stepping bounce that feels like walking to the beat.', descriptionKo: '걸음처럼 박자를 밟으며 움직이는 스텝 바운스입니다. (Step Bounce)', style: 'step-like rhythmic bounce', sound: 'stepping kick accents, light percussion movement', mood: 'active, stylish' },
      { id: 'uptempo-bounce', label: 'Uptempo Bounce', labelKo: '업템포 바운스', description: 'Fast, energetic rhythmic lift.', descriptionKo: '빠르고 탄력 있는 업템포 움직임을 더합니다. (Uptempo Bounce)', style: 'uptempo rhythmic bounce', sound: 'energetic drum drive', mood: 'bright, lively' },
      { id: 'dance', label: 'Dance Rhythm', labelKo: '댄스 리듬', description: 'Rhythm and performance-centered dance movement.', descriptionKo: '리듬과 퍼포먼스 중심의 댄스감을 더합니다. (Dance Rhythm)', style: 'dance-focused pulse', sound: 'immediate rhythmic energy', mood: 'performance-ready' },
      { id: 'separator-style-rhythm-loop', kind: 'separator', label: '루프', labelKo: '루프', description: '', descriptionKo: '', promptCore: '' },
      { id: 'minimal-loop', label: 'Minimal Loop', labelKo: '미니멀 루프', description: 'A sparse repeating rhythm that keeps the track focused.', descriptionKo: '불필요한 장식을 줄이고 반복감만 선명하게 남기는 루프입니다. (Minimal Loop)', style: 'minimal repeating loop', sound: 'sparse drums, steady pulse, light repetition', mood: 'focused, restrained' },
      { id: 'fusion-study-beats', label: 'Study Beats', labelKo: '스터디 비트', description: 'Low-pressure beat style for calm focus and soft repetition.', descriptionKo: '차분한 집중감과 반복 그루브를 주는 저자극 비트 스타일입니다. (Study Beats)', style: 'Study Beats fusion', sound: 'soft drums, mellow keys, low-pressure loop', mood: 'calm, focused' },
      { id: 'rhythmic-development', label: 'Rhythmic Development', labelKo: '진행 루프', description: 'Arrangement develops through rhythmic motion.', descriptionKo: '반복되는 리듬이 조금씩 변하며 곡을 앞으로 밀어주는 루프입니다. (Rhythmic Development)', style: 'rhythm-led development', sound: 'sectional rhythmic changes', mood: 'moving, dynamic' },
      { id: 'dreamy-loop', label: 'Dreamy Loop', labelKo: '몽환 루프', description: 'A soft repeating loop with a hazy, dreamlike pull.', descriptionKo: '몽환적으로 반복되며 곡을 부드럽게 감싸는 루프입니다. (Dreamy Loop)', style: 'dreamy repeating loop', sound: 'soft looped pulse, hazy repetition', mood: 'dreamy, floating' },
      { id: 'hypnotic-loop', label: 'Hypnotic Loop', labelKo: '최면 루프', description: 'A trance-like loop that slowly pulls the listener inward.', descriptionKo: '반복이 쌓이면서 점점 빠져드는 듯한 최면성 루프입니다. (Hypnotic Loop)', style: 'hypnotic loop movement', sound: 'steady repeating pulse, subtle rhythmic cycle', mood: 'entrancing, immersive' },
      { id: 'drive-loop', label: 'Drive Loop', labelKo: '드라이브 루프', description: 'A forward-driving loop with steady motion.', descriptionKo: '곡을 앞으로 계속 밀어주는 추진력 있는 루프입니다. (Drive Loop)', style: 'driving rhythmic loop', sound: 'steady drum loop, forward pulse', mood: 'moving, persistent' },
    ],
  }];
...
export const STYLE_GROUPS = [
  ...
  { id: 'era-texture', label: 'Era Texture', labelKo: '시대 질감', descriptionKo: '70s부터 2020s까지 시대별 사운드와 믹스 질감을 더해요.', cycleIds: ['era-texture'] },
  { id: 'stage-shift', label: 'Transition Direction', labelKo: '전환 연출', descriptionKo: '곡 중간이나 후반에 흐름, 감정, 장면이 바뀌는 포인트를 더해요.', cycleIds: ['stage-shift'] },
  ...
  { id: 'hook-addiction', label: 'Hook Line', labelKo: '후렴 라인', descriptionKo: '후렴, 훅, 반복 라인의 중독성과 기억성을 강화해요.', cycleIds: ['hook-addiction'] },
...
export const SOUND_TEXTURE_CYCLES = [
...

  {
    ...
    title: 'Drums',
    titleKo: '드럼',
    description: 'Drum elements such as kicks, snares, hi-hats, and playing feel.',
    descriptionKo: '킥, 스네어, 하이햇과 드럼 연주 질감을 정해요.',
    variants: [
  ...
  },
  {
    ...
    title: 'Bass',
    titleKo: '베이스',
    description: 'Low-end weight, bounce, and bass movement.',
    descriptionKo: '저역의 무게, 탄력, 움직임을 정해요.',
    variants: [
  ...
  },
  {
    ...
    title: 'Guitar',
    titleKo: '기타',
    description: 'Acoustic and electric guitar tones and playing textures.',
    descriptionKo: '어쿠스틱/일렉 기타의 톤과 연주 질감을 더해요.',
    variants: [
      ...
      { id: 'mandolin', label: 'Mandolin', labelKo: '만돌린', description: 'mandolin - 밝고 잘게 튀는 플럭 현악기입니다. (Folk, Country, Bluegrass, Acoustic Pop)', descriptionKo: 'mandolin - 밝고 잘게 튀는 플럭 현악기입니다. (Folk, Country, Bluegrass, Acoustic Pop)', promptCore: 'mandolin' },
      { id: 'ukulele', label: 'Ukulele', labelKo: '우쿨렐레', description: 'ukulele - 작고 가벼운 여름빛 어쿠스틱 현악기입니다. (Tropical Pop, Acoustic Pop, Cute Pop)', descriptionKo: 'ukulele - 작고 가벼운 여름빛 어쿠스틱 현악기입니다. (Tropical Pop, Acoustic Pop, Cute Pop)', promptCore: 'ukulele' },
      { id: 'banjo', label: 'Banjo', labelKo: '밴조', description: 'banjo - 튀고 경쾌한 블루그래스/컨트리 현악기입니다. (Bluegrass, Country, Americana)', descriptionKo: 'banjo - 튀고 경쾌한 블루그래스/컨트리 현악기입니다. (Bluegrass, Country, Americana)', promptCore: 'banjo' },
      { id: 'twelve-string-guitar', label: '12-string Guitar', labelKo: '12현 기타', description: '12-string guitar - 반짝이고 넓게 울리는 포크/브릿팝 기타입니다. (Folk Rock, Britpop, Acoustic Pop)', descriptionKo: '12-string guitar - 반짝이고 넓게 울리는 포크/브릿팝 기타입니다. (Folk Rock, Britpop, Acoustic Pop)', promptCore: '12-string guitar' },
  ...
  },
  {
    ...
    title: 'Keys',
    titleKo: '건반',
    description: 'Piano, electric piano, organ, and other keyboard colors.',
    descriptionKo: '피아노, EP, 오르간 같은 건반 색을 더해요.',
    variants: [
      ...
      { id: 'clavinet', label: 'Clavinet', labelKo: '클라비넷', description: 'clavinet - 짧고 쫀득하게 튀는 펑크 건반입니다. (Funk, Disco, P-Funk, City Pop)', descriptionKo: 'clavinet - 짧고 쫀득하게 튀는 펑크 건반입니다. (Funk, Disco, P-Funk, City Pop)', promptCore: 'clavinet' },
      ...
      { id: 'church-organ', label: 'Church Organ', labelKo: '처치 오르간', description: 'church organ - 성당과 교회 공간처럼 웅장하게 울리는 오르간입니다. (Church Hymn, Gothic, Cinematic, Classical)', descriptionKo: 'church organ - 성당과 교회 공간처럼 웅장하게 울리는 오르간입니다. (Church Hymn, Gothic, Cinematic, Classical)', promptCore: 'church organ' },
      ...
      { id: 'harpsichord', label: 'Harpsichord', labelKo: '하프시코드', description: 'harpsichord - 바로크풍의 고풍스럽고 딱딱한 건반 소리입니다. (Baroque Pop, Classical, Gothic Pop)', descriptionKo: 'harpsichord - 바로크풍의 고풍스럽고 딱딱한 건반 소리입니다. (Baroque Pop, Classical, Gothic Pop)', promptCore: 'harpsichord' },
      { id: 'toy-piano', label: 'Toy Piano', labelKo: '토이 피아노', description: 'toy piano - 장난감처럼 작고 귀여운 피아노 소리입니다. (Cute Pop, Fantasy Pop, Lo-fi, Children Song)', descriptionKo: 'toy piano - 장난감처럼 작고 귀여운 피아노 소리입니다. (Cute Pop, Fantasy Pop, Lo-fi, Children Song)', promptCore: 'toy piano' },
  ...
  },
  {
    ...
    title: 'Synth',
    titleKo: '신스',
    description: 'Electronic textures such as leads, pads, plucks, and arps.',
    descriptionKo: '리드, 패드, 플럭, 아르페지오 같은 전자 질감을 더해요.',
    variants: [
      ...
      { id: 'soft-lead-synth', label: 'Soft Lead Synth', labelKo: '부드러운 리드 신스', description: 'soft lead synth - 약하고 부드럽게 멜로디를 이끄는 리드 신스입니다. (Ballad, Chill Pop, Dream Pop)', descriptionKo: 'soft lead synth - 약하고 부드럽게 멜로디를 이끄는 리드 신스입니다. (Ballad, Chill Pop, Dream Pop)', promptCore: 'soft lead synth' },
      { id: 'bright-lead-synth', label: 'Bright Lead Synth', labelKo: '밝은 리드 신스', description: 'bright lead synth - 밝고 선명하게 훅을 이끄는 리드 신스입니다. (K-Pop, J-Pop, Future Bass)', descriptionKo: 'bright lead synth - 밝고 선명하게 훅을 이끄는 리드 신스입니다. (K-Pop, J-Pop, Future Bass)', promptCore: 'bright lead synth' },
      { id: 'warm-lead-synth', label: 'Warm Lead Synth', labelKo: '따뜻한 리드 신스', description: 'warm lead synth - 따뜻하고 둥글게 멜로디를 감싸는 리드 신스입니다. (City Pop, Synth-pop, Retro Pop)', descriptionKo: 'warm lead synth - 따뜻하고 둥글게 멜로디를 감싸는 리드 신스입니다. (City Pop, Synth-pop, Retro Pop)', promptCore: 'warm lead synth' },
      { id: 'dreamy-lead-synth', label: 'Dreamy Lead Synth', labelKo: '몽환 리드 신스', description: 'dreamy lead synth - 흐릿하고 몽환적으로 떠오르는 리드 신스입니다. (Dream Pop, Chillwave, Fantasy Pop)', descriptionKo: 'dreamy lead synth - 흐릿하고 몽환적으로 떠오르는 리드 신스입니다. (Dream Pop, Chillwave, Fantasy Pop)', promptCore: 'dreamy lead synth' },
      { id: 'retro-lead-synth', label: 'Retro Lead Synth', labelKo: '레트로 리드 신스', description: 'retro lead synth - 80s 감성이 나는 복고적인 리드 신스입니다. (Synthwave, 80s Pop, Retrowave)', descriptionKo: 'retro lead synth - 80s 감성이 나는 복고적인 리드 신스입니다. (Synthwave, 80s Pop, Retrowave)', promptCore: 'retro lead synth' },
      { id: 'saw-lead-synth', label: 'Saw Lead Synth', labelKo: '쏘우 리드 신스', description: 'saw lead synth - 두껍고 강하게 뻗는 saw 파형 리드 신스입니다. (EDM, Trance, Festival Pop)', descriptionKo: 'saw lead synth - 두껍고 강하게 뻗는 saw 파형 리드 신스입니다. (EDM, Trance, Festival Pop)', promptCore: 'saw lead synth' },
      { id: 'square-lead-synth', label: 'Square Lead Synth', labelKo: '스퀘어 리드 신스', description: 'square lead synth - 네모파 특유의 게임/레트로 느낌을 주는 리드 신스입니다. (Chiptune, Game BGM, Retro Pop)', descriptionKo: 'square lead synth - 네모파 특유의 게임/레트로 느낌을 주는 리드 신스입니다. (Chiptune, Game BGM, Retro Pop)', promptCore: 'square lead synth' },
      { id: 'aggressive-lead-synth', label: 'Aggressive Lead Synth', labelKo: '공격적인 리드 신스', description: 'aggressive lead synth - 강하고 날카롭게 전면을 밀어붙이는 리드 신스입니다. (EDM, Hyperpop, Hard Synth)', descriptionKo: 'aggressive lead synth - 강하고 날카롭게 전면을 밀어붙이는 리드 신스입니다. (EDM, Hyperpop, Hard Synth)', promptCore: 'aggressive lead synth' },
      { id: 'portamento-lead-synth', label: 'Portamento Lead Synth', labelKo: '포르타멘토 리드 신스', description: 'portamento lead synth - 음이 미끄러지듯 연결되는 글라이드 리드 신스입니다. (Synth Funk, Retro Pop, EDM)', descriptionKo: 'portamento lead synth - 음이 미끄러지듯 연결되는 글라이드 리드 신스입니다. (Synth Funk, Retro Pop, EDM)', promptCore: 'portamento lead synth' },
      ...
      { id: 'warm-synth-layer', label: 'Warm Synth Layer', labelKo: '따뜻한 신스 레이어', description: 'warm synth layer - 따뜻하게 감싸는 신스 배경층입니다. (City Pop, R&B, Ballad, Synth-pop)', descriptionKo: 'warm synth layer - 따뜻하게 감싸는 신스 배경층입니다. (City Pop, R&B, Ballad, Synth-pop)', promptCore: 'warm synth layer' },
      { id: 'cold-synth-layer', label: 'Cold Synth Layer', labelKo: '차가운 신스 레이어', description: 'cold synth layer - 차갑고 건조하게 깔리는 신스 배경층입니다. (Cyber Pop, Minimal Pop, Dark EDM)', descriptionKo: 'cold synth layer - 차갑고 건조하게 깔리는 신스 배경층입니다. (Cyber Pop, Minimal Pop, Dark EDM)', promptCore: 'cold synth layer' },
      { id: 'wide-synth-layer', label: 'Wide Synth Layer', labelKo: '와이드 신스 레이어', description: 'wide synth layer - 좌우로 넓게 펼쳐지는 신스 배경층입니다. (Dream Pop, Synthwave, Cinematic, Ambient Pop)', descriptionKo: 'wide synth layer - 좌우로 넓게 펼쳐지는 신스 배경층입니다. (Dream Pop, Synthwave, Cinematic, Ambient Pop)', promptCore: 'wide synth layer' },
      { id: 'dreamy-synth-layer', label: 'Dreamy Synth Layer', labelKo: '몽환 신스 레이어', description: 'dreamy synth layer - 흐릿하고 몽환적으로 감싸는 신스 배경층입니다. (Dream Pop, Chillwave, Lo-fi Pop)', descriptionKo: 'dreamy synth layer - 흐릿하고 몽환적으로 감싸는 신스 배경층입니다. (Dream Pop, Chillwave, Lo-fi Pop)', promptCore: 'dreamy synth layer' },
      { id: 'retro-synth-layer', label: 'Retro Synth Layer', labelKo: '레트로 신스 레이어', description: 'retro synth layer - 80s/복고 감성으로 깔리는 신스 배경층입니다. (Synthwave, City Pop, Retro Pop)', descriptionKo: 'retro synth layer - 80s/복고 감성으로 깔리는 신스 배경층입니다. (Synthwave, City Pop, Retro Pop)', promptCore: 'retro synth layer' },
      { id: 'glitch-synth-layer', label: 'Glitch Synth Layer', labelKo: '글리치 신스 레이어', description: 'glitch synth layer - 깨진 디지털 질감이 섞인 신스 배경층입니다. (Hyperpop, Glitch Pop, Experimental)', descriptionKo: 'glitch synth layer - 깨진 디지털 질감이 섞인 신스 배경층입니다. (Hyperpop, Glitch Pop, Experimental)', promptCore: 'glitch synth layer' },
    ],
  },
  {
    ...
    title: 'Strings',
    titleKo: '현악',
    description: 'String sections and solo strings for emotion and scale.',
    descriptionKo: '스트링과 솔로 현악으로 감정선과 스케일을 더해요.',
    variants: [
  ...
  },
  {
    ...
    title: 'Winds',
    titleKo: '관악',
    description: 'Brass and woodwind colors for melody and accents.',
    descriptionKo: '브라스와 목관 계열의 선율감과 포인트를 더해요.',
    variants: [
      ...
      { id: 'harmonica', label: 'Harmonica', labelKo: '하모니카', description: 'harmonica - 쓸쓸하고 사람 냄새 나는 블루스/포크 리드 악기입니다. (Blues, Folk, Country, K-Folk)', descriptionKo: 'harmonica - 쓸쓸하고 사람 냄새 나는 블루스/포크 리드 악기입니다. (Blues, Folk, Country, K-Folk)', promptCore: 'harmonica' },
      { id: 'recorder', label: 'Recorder', labelKo: '리코더', description: 'recorder - 서툴고 귀여운 동요/레트로 느낌의 목관 악기입니다. (Children Song, Cute Pop, Fantasy Pop)', descriptionKo: 'recorder - 서툴고 귀여운 동요/레트로 느낌의 목관 악기입니다. (Children Song, Cute Pop, Fantasy Pop)', promptCore: 'recorder' },
      { id: 'melodica', label: 'Melodica', labelKo: '멜로디카', description: 'melodica - 소박하고 장난기 있는 입으로 부는 건반형 리드 악기입니다. (Indie Pop, Lo-fi, Reggae, Acoustic Pop)', descriptionKo: 'melodica - 소박하고 장난기 있는 입으로 부는 건반형 리드 악기입니다. (Indie Pop, Lo-fi, Reggae, Acoustic Pop)', promptCore: 'melodica' },
      { id: 'ocarina', label: 'Ocarina', labelKo: '오카리나', description: 'ocarina - 동화적이고 판타지한 짧은 선율의 관악기입니다. (Game BGM, Fantasy, Healing Music)', descriptionKo: 'ocarina - 동화적이고 판타지한 짧은 선율의 관악기입니다. (Game BGM, Fantasy, Healing Music)', promptCore: 'ocarina' },
      { id: 'clarinet', label: 'Clarinet', labelKo: '클라리넷', description: 'clarinet - 부드럽고 둥근 목관 선율입니다. (Jazz, Classical, Cinematic, Cute Pop)', descriptionKo: 'clarinet - 부드럽고 둥근 목관 선율입니다. (Jazz, Classical, Cinematic, Cute Pop)', promptCore: 'clarinet' },
      { id: 'oboe', label: 'Oboe', labelKo: '오보에', description: 'oboe - 얇고 애절하게 파고드는 클래식 목관 선율입니다. (Classical, OST, Cinematic Ballad)', descriptionKo: 'oboe - 얇고 애절하게 파고드는 클래식 목관 선율입니다. (Classical, OST, Cinematic Ballad)', promptCore: 'oboe' },
      { id: 'bassoon', label: 'Bassoon', labelKo: '바순', description: 'bassoon - 낮고 익살스러운 캐릭터감을 주는 목관 악기입니다. (Classical, Comedy, OST, Musical)', descriptionKo: 'bassoon - 낮고 익살스러운 캐릭터감을 주는 목관 악기입니다. (Classical, Comedy, OST, Musical)', promptCore: 'bassoon' },
  ...
  },
  {
    ...
    title: 'Percussion',
    titleKo: '타악',
    description: 'Percussion and impact sounds that decorate the rhythm.',
    descriptionKo: '퍼커션과 타격음으로 리듬 장식을 더해요.',
    variants: [
  ...
  },
  {
    ...
    title: 'World',
    titleKo: '월드악기',
    description: 'Traditional and regional instrument colors from different cultures.',
    descriptionKo: '전통/지역 악기 색채를 더해요.',
    variants: [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'separator-vocal-choir-chorus', kind: 'separator', label: 'Choir / Chorus', labelKo: '합창 / 코러스', description: '', descriptionKo: '', promptCore: '' },
      ...
      { id: 'kids-choir', label: 'Kids Choir', labelKo: '키즈 합창', description: 'kids choir - 더 어리고 밝은 아이들 목소리의 합창입니다.', descriptionKo: 'kids choir - 더 어리고 밝은 아이들 목소리의 합창입니다.', promptCore: 'kids choir' },
      { id: 'children-choir', label: "Children's Choir", labelKo: '어린이 합창', description: "children's choir - 정돈된 어린이 합창단처럼 맑고 순수한 합창입니다.", descriptionKo: "children's choir - 정돈된 어린이 합창단처럼 맑고 순수한 합창입니다.", promptCore: "children's choir" },
      { id: 'youth-choir', label: 'Youth Choir', labelKo: '청소년 합창', description: 'youth choir - 밝고 또렷한 청소년 단체 보컬입니다.', descriptionKo: 'youth choir - 밝고 또렷한 청소년 단체 보컬입니다.', promptCore: 'youth choir' },
      { id: 'whisper-choir', label: 'Whisper Choir', labelKo: '속삭임 합창', description: 'whisper choir - 여러 목소리가 낮게 속삭이듯 깔리는 합창 질감입니다.', descriptionKo: 'whisper choir - 여러 목소리가 낮게 속삭이듯 깔리는 합창 질감입니다.', promptCore: 'whisper choir' },
      { id: 'humming-choir', label: 'Humming Choir', labelKo: '허밍 합창', description: 'humming choir - 가사 없이 허밍으로 부드럽게 깔리는 합창입니다.', descriptionKo: 'humming choir - 가사 없이 허밍으로 부드럽게 깔리는 합창입니다.', promptCore: 'humming choir' },
      { id: 'la-la-chorus', label: 'Singalong Chorus', labelKo: '싱어롱 코러스', description: 'singalong chorus - 라라라 고정이 아니라 따라 부르기 쉬운 코러스 흐름입니다.', descriptionKo: 'singalong chorus - 라라라 고정이 아니라 따라 부르기 쉬운 코러스 흐름입니다.', promptCore: 'singalong chorus' },
      { id: 'separator-vocal-chant-shout', kind: 'separator', label: 'Chant / Shout', labelKo: '챈트 / 샤우트', description: '', descriptionKo: '', promptCore: '' },
      ...
      { id: 'group-chant', label: 'Group Chant', labelKo: '그룹 챈트', description: 'group chant - 곡 안에서 소규모 단체가 함께 외치는 보컬 포인트입니다.', descriptionKo: 'group chant - 곡 안에서 소규모 단체가 함께 외치는 보컬 포인트입니다.', promptCore: 'group chant' },
      { id: 'vocal-shouts', label: 'Vocal Shouts', labelKo: '보컬 샤우트', description: 'vocal shouts - 짧게 외치는 응원/펑크성 보컬 포인트입니다.', descriptionKo: 'vocal shouts - 짧게 외치는 응원/펑크성 보컬 포인트입니다.', promptCore: 'vocal shouts' },
      { id: 'separator-vocal-stack-sample', kind: 'separator', label: 'Harmony / Sample', labelKo: '화음 / 샘플', description: '', descriptionKo: '', promptCore: '' },
      { id: 'layered-harmonies', label: 'Layered Harmonies', labelKo: '겹겹이 쌓는 화음', description: 'layered harmonies - 여러 겹으로 쌓아 올리는 보컬 화음입니다.', descriptionKo: 'layered harmonies - 여러 겹으로 쌓아 올리는 보컬 화음입니다.', promptCore: 'layered harmonies' },
      { id: 'stacked-vocals', label: 'Stacked Vocals', labelKo: '두꺼운 보컬 스택', description: 'stacked vocals - 팝 후렴처럼 두껍게 쌓은 보컬 레이어입니다.', descriptionKo: 'stacked vocals - 팝 후렴처럼 두껍게 쌓은 보컬 레이어입니다.', promptCore: 'stacked vocals' },
  ...
  },
  {
    ...
    title: 'Texture FX',
    titleKo: '질감 효과',
    description: 'Background texture effects such as noise, reverb, risers, and impacts.',
    descriptionKo: '노이즈, 리버브, 전환음 같은 배경 질감을 더해요.',
    variants: [
...
export const MOODS: CategoryItem[] = [
  { 
      ...
      description: '섬세하고 진한 감정 표현이 살아나는 분위기로 몰입감 있는 무드를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Rich, immersive, raw depth', 
      arrangement: 'dynamic build, expressive peaks' 
    },
  { 
      id: 'hollow', label: 'Hollow', labelKo: '공허한', 
      description: '마음 한쪽이 비어 있는 듯한 거리감과 허전한 여백을 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Hollow, empty, distant', 
      arrangement: 'open space, restrained low movement' 
    },
  { 
      id: 'cute_mood', label: 'Cute', labelKo: '귀여운', 
      description: '귀엽고 깜찍하며 발랄한 매력을 담아 작고 밝게 튀는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '리듬의 탄력과 흐름이 살아 있는 질감으로 자연스럽게 몸을 타는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Elastic, rhythmic, pocketed', 
      arrangement: 'groovy pocket, consistent drive' 
    },
  { 
      id: 'glossy', label: 'Glossy', labelKo: '글로시', 
      description: '윤기 있고 반짝이는 세련된 표면감으로 현대적인 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Glossy, polished, sparkling', 
      arrangement: 'polished lift, sparkling accents' 
    },
  { 
      id: 'strange', label: 'Strange', labelKo: '기묘한', 
      description: '낯설고 묘한 긴장감으로 strange하고 curious한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Strange, uncanny, curious', 
      arrangement: 'curious pauses, eerie small shifts' 
    },
  { 
      id: 'tense', label: 'Tense', labelKo: '긴장된', 
      description: '서서히 조여오는 긴장감으로 날카롭고 불안정한 무드감을 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Sharp, anxious, high-tension', 
      arrangement: 'tight pacing, sudden shifts' 
    },
  { 
      id: 'romantic', label: 'Romantic', labelKo: '낭만적', 
      description: '감미롭고 설레는 정서가 흐르는 분위기로 로맨틱한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Lush, sweet, intimate', 
      arrangement: 'smooth flow, graceful builds' 
    },
  { 
      id: 'cheeky_deadpan', label: 'Cheeky Deadpan', labelKo: '능청미', 
      description: '능청스럽고 뻔뻔한 듯한 유머로 말맛 있는 코믹한 무드를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '따뜻함과 쓸쓸함이 함께 남는 복합적인 무드와 질감을 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Complex, mixed colors', 
      arrangement: 'balanced, contrasting dynamics' 
    },
  { 
      id: 'restrained', label: 'Restrained', labelKo: '담담한', 
      description: '감정을 과하게 드러내지 않고 차분히 눌러 담는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '차갑고 세련된 도시의 결을 담아 현대적 분위기를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Sleek, urban, metropolitan', 
      arrangement: 'modern pulse, sharp transitions' 
    },
  { 
      id: 'fairytale', label: 'Fairytale', labelKo: '동화적인', 
      description: '순수하고 이야기책 같은 정서로 맑고 동화적인 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Fairytale-like, innocent, magical', 
      arrangement: 'gentle storybook progression' 
    },
  { 
      id: 'dreamy_soft', label: 'Dreamy', labelKo: '드리미', 
      description: '소리 질감이 꿈결처럼 부드럽고 몽환적으로 떠 있는 흐릿한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '온기 있게 감싸는 질감으로 부드럽고 포근한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Soft, thick, cozy', 
      arrangement: 'warm structure, harmonic support' 
    },
  { 
      id: 'lofi', label: 'Lo-fi', labelKo: '로파이', 
      description: '먼지 낀 듯 낮은 해상도와 친밀한 빈티지 질감의 무드를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Lo-fi, dusty, intimate', 
      arrangement: 'simple loop feel, close texture' 
    },
  { 
      id: 'relaxing', label: 'Relaxing', labelKo: '릴렉스', 
      description: '편안함과 칠한 여유를 함께 담아 힘을 빼고 자연스럽게 흘러가는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '반짝이고 신기한 사건감으로 magical하고 설레는 분위기를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Magical, sparkling, wonder-filled', 
      arrangement: 'sparkling lifts, magical transitions' 
    },
  { 
      id: 'zen', label: 'Zen', labelKo: '명상적인', 
      description: '비움과 정적이 느껴지는 절제된 분위기로 맑고 고요한 질감을 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Spacious, meditative stillness', 
      arrangement: 'minimalist, significant space' 
    },
  { 
      id: 'hypnotic', label: 'Hypnotic', labelKo: '몰입감', 
      description: '반복과 흐름 속에 빨려 들어가듯 깊이 몰입되는 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Swirling, hypnotic, trance-like', 
      arrangement: 'repetitive, evolving layers' 
    },
  { 
      id: 'soft_tender', label: 'Soft Tender', labelKo: '몽글한', 
      description: '부드럽고 말랑하게 피어나는 따뜻한 감정의 질감을 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Soft, tender, gently warm', 
      arrangement: 'rounded flow, gentle lift' 
    },
  { 
      id: 'moody', label: 'Moody', labelKo: '무디', 
      description: '감정의 결이 짙게 배어 있는 분위기로 깊고 미묘한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Thick, moody, shifting', 
      arrangement: 'shifting structure, emotive turns' 
    },
  { 
      id: 'minimalist', label: 'Minimalist', labelKo: '미니멀', 
      description: '불필요한 요소를 덜어낸 절제된 질감으로 깔끔한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Bare, minimalist, essential', 
      arrangement: 'simple, focused elements' 
    },
  { 
      id: 'bright', label: 'Bright', labelKo: '밝은', 
      description: '환하게 열리는 인상으로 선명하고 가벼운 분위기를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Clear, airy, luminous', 
      arrangement: 'uplifting, forward structure' 
    },
  { 
      id: 'swelling', label: 'Swelling', labelKo: '벅찬', 
      description: '감정이 차오르며 후반으로 갈수록 크게 벅차오르는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Swelling, emotional, overwhelming', 
      arrangement: 'gradual build, final emotional bloom' 
    },
  { 
      id: 'uneasy', label: 'Uneasy', labelKo: '불안한', 
      description: '안정되지 못하고 흔들리는 긴장감으로 불안한 감정의 결을 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Uneasy, unstable, tense', 
      arrangement: 'uneven pacing, unresolved transitions' 
    },
  { 
      id: 'sorrowful', label: 'Sorrowful', labelKo: '비통한', 
      description: '가슴이 찢어질 듯한 슬픔과 비통한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Grieving, heartbreaking', 
      arrangement: 'no climaxes, mourning pace' 
    },
  { 
      id: 'nostalgic', label: 'Nostalgic', labelKo: '빈티지', 
      description: '빈티지한 추억감과 레트로한 아날로그 질감으로 지나간 시간의 무드를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '차갑게 스며드는 미묘한 긴장감과 서늘한 공기를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Cold, subtle tension', 
      arrangement: 'cool textures, restrained tension' 
    },
  { 
      id: 'sophisticated', label: 'Sophisticated', labelKo: '세련된', 
      description: '정교하고 다듬어진 인상으로 도시적이고 세련된 무드를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Polished, urban, refined', 
      arrangement: 'elegant structure, intricate' 
    },
  { 
      id: 'soulful', label: 'Soulful', labelKo: '소울풀', 
      description: '보컬과 감정 표현에 깊은 온도와 진한 표현력을 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Soulful, expressive, warm', 
      arrangement: 'expressive peaks, warm harmonic support' 
    },
  { 
      id: 'smooth', label: 'Smooth', labelKo: '스무스', 
      description: '부드럽고 매끄럽게 이어지는 세련된 흐름으로 걸림 없는 질감을 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '슬픔과 상실감이 또렷하게 느껴지는 감정 중심의 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Fragile mourning, heavy weight', 
      arrangement: 'slow, minimal ornaments' 
    },
  { 
      id: 'cinematic', label: 'Cinematic', labelKo: '시네마틱', 
      description: '장면이 그려지듯 입체적으로 펼쳐지는 무드와 스케일감을 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Epic, grand, wide-screen', 
      arrangement: 'dynamic arc, narrative' 
    },
  { 
      id: 'cool', label: 'Cool', labelKo: '시원한', 
      description: '맑고 선선하게 트인 인상으로 차갑고 세련된 무드를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Sharp, clear, icy', 
      arrangement: 'detached flow, crisp sections' 
    },
  { 
      id: 'mysterious', label: 'Mysterious', labelKo: '신비로운', 
      description: '정체를 알 수 없는 끌림과 신비한 공기로 mysterious한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Mysterious, mystical, enchanting', 
      arrangement: 'mystical textures, subtle reveals' 
    },
  { 
      id: 'coziness', label: 'Coziness', labelKo: '아늑한', 
      description: '작고 포근한 공간에 머무는 듯한 따뜻하고 친밀한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Close-up, warm, intimate', 
      arrangement: 'small-space, close-mic feel' 
    },
  { 
      id: 'wistful', label: 'Wistful', labelKo: '아련한', 
      description: '희미한 여운과 조용한 쓸쓸함, 고독한 거리감을 함께 담아 아련한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '조심스럽고 다정하지만 어딘가 아픈 애틋한 감정선을 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '공간감과 여운이 넓게 퍼지는 배경감 중심의 분위기를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '묵직하고 짙게 가라앉는 분위기로 어둡고 깊은 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Heavy, somber, shadows', 
      arrangement: 'slow-drag, weighted sections' 
    },
  { 
      id: 'upbeat', label: 'Upbeat', labelKo: '업비트', 
      description: '경쾌하게 밀고 나가는 에너지로 가볍고 활발한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Crisp, driving, high-energy', 
      arrangement: 'energetic pulse, forward momentum' 
    },
  { 
      id: 'quirky', label: 'Quirky', labelKo: '엉뚱한', 
      description: '예상 밖의 전개와 엉뚱한 매력으로 독특하고 귀여운 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Quirky, unexpected, oddball', 
      arrangement: 'unexpected accents, quirky shifts' 
    },
  { 
      id: 'airy', label: 'Airy', labelKo: '에어리', 
      description: '가볍고 열린 공기감으로 숨이 트이는 듯한 밝은 여백을 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Airy, light, open', 
      arrangement: 'open space, light movement' 
    },
  { 
      id: 'ethereal', label: 'Ethereal', labelKo: '에테리얼', 
      description: '현실에서 살짝 떠 있는 듯한 가볍고 신비로운 초현실적 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '한마디로 정의하기 어려운 미묘함과 신비감을 섞어 오묘한 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '쓸쓸하고 가라앉은 감정선을 중심으로 무게감 있는 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Lonely, fragile, blue', 
      arrangement: 'slow flow, lingering notes' 
    },
  { 
      id: 'comic_but_sad', label: 'Comic But Sad', labelKo: '웃픈', 
      description: '웃기지만 어딘가 짠한 감정을 섞어 funny yet bittersweet한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '금방이라도 무너질 듯 흔들리는 섬세하고 위태로운 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '가볍게 장난치듯 톡톡 튀는 감정으로 playful한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Playful, mischievous, lighthearted', 
      arrangement: 'bouncy accents, playful breaks' 
    },
  { 
      id: 'calm', label: 'Calm', labelKo: '차분한', 
      description: '차분하고 평화롭게 정돈된 감정선으로 고요하고 안정적인 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
  ...
  { 
      ...
      description: '현실의 규칙이 살짝 어긋난 듯한 비현실적이고 dreamlike한 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Surreal, unreal, dreamlike', 
      arrangement: 'off-kilter space, unreal transitions' 
    },
  { 
      id: 'healing', label: 'Healing', labelKo: '치유되는', 
      description: '상처를 감싸듯 부드럽게 스며드는 분위기로 위로감 있는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Warm, comforting, therapeutic', 
      arrangement: 'gentle flow, nurturing transitions' 
    },
  { 
      id: 'infectious', label: 'Infectious', labelKo: '캐치한', 
      description: '한 번 들으면 귀에 맴도는 강한 인상으로 반복적인 몰입감을 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Catchy, repetitive, magnetic', 
      arrangement: 'infectious, memorable hooks' 
    },
  { 
      id: 'comedic', label: 'Comedic', labelKo: '코믹한', 
      description: '가볍고 유쾌한 코미디 감각으로 상황을 재미있게 풀어내는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Comedic, playful, humorous', 
      arrangement: 'comic timing, short playful stops' 
    },
  { 
      id: 'cheerful', label: 'Cheerful', labelKo: '쾌활한', 
      description: '밝고 경쾌하게 튀어 오르는 에너지로 생기 있는 무드를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Bouncy, playful energy', 
      arrangement: 'energetic flow, lively accents' 
    },
  { 
      id: 'powerful', label: 'Powerful', labelKo: '파워풀', 
      description: '강한 추진력과 존재감으로 힘 있게 밀어붙이는 분위기를 만듭니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Bold, grand, massive', 
      arrangement: 'high-impact, strong emphasis' 
    },
  { 
      id: 'fantasy', label: 'Fantasy', labelKo: '판타지', 
      description: '현실에서 벗어난 이야기 세계관처럼 환상적이고 imaginative한 무드를 더합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Fantasy-like, magical, storybook', 
      arrangement: 'storybook arc, magical color shifts' 
    },
  { 
      id: 'funky', label: 'Funky', labelKo: '펑키', 
      description: '톡톡 튀는 리듬감과 개성 있는 질감으로 활기찬 분위기를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
      mood: 'Sharp, funky, rhythmic snap', 
      arrangement: 'syncopated, energetic drive' 
    },
  { 
      id: 'hopeful', label: 'Hopeful', labelKo: '희망찬', 
      description: '앞으로 나아가는 기대감이 느껴지는 밝고 상승감 있는 무드를 형성합니다 곡의 내용 소재나 사건을 새로 만들지 않고, 이야기의 공기·감정 온도·보컬 태도·전개 압력만 조절합니다.', 
...
export const THEMES: CategoryItem[] = [
  { id: 'family', label: 'Family', labelKo: '가족', description: '가족 안에서 생기는 애정, 책임, 미안함, 익숙함을 다룹니다. 따뜻함 하나로 고정하지 않고 말하지 못한 마음, 생활감, 돌봄, 세대 차이, 오래된 기억으로 해석합니다.' },
  { id: 'season', label: 'Season', labelKo: '계절', description: '계절의 변화가 감정의 온도와 기억을 바꾸는 방식을 다룹니다. 계절 풍경에 고정하지 않고 공기, 빛, 냄새, 옷깃, 다시 돌아오는 감각으로 해석합니다.' },
  { id: 'confession', label: 'Confession', labelKo: '고백', description: '감춰둔 마음이 드러나려는 관계의 전환점을 다룹니다. 말로 전하는 장면에만 고정하지 않고 침묵, 행동, 선택, 거리감, 타이밍의 변화로 해석합니다.' },
  { id: 'hometown', label: 'Hometown', labelKo: '고향', description: '돌아가고 싶은 마음과 이미 달라진 장소의 감정을 다룹니다. 고향 그리움에만 고정하지 않고 냄새, 말투, 거리감, 떠난 사람의 시선으로 풀어냅니다.' },
  { id: 'alley', label: 'Alley', labelKo: '골목', description: '좁은 길목과 생활감 속에서 생기는 거리와 기억을 다룹니다. 골목 풍경에만 고정하지 않고 우연, 망설임, 돌아가는 길, 익숙한 냄새로 해석합니다.' },
  { id: 'longing', label: 'Longing', labelKo: '그리움', description: '멀어진 대상이나 시간에 닿고 싶은 마음을 다룹니다. 직접적인 그리움 표현보다 빈자리, 반복되는 기억, 남은 감각, 닿지 않는 거리감으로 해석합니다.' },
  { id: 'waiting', label: 'Waiting', labelKo: '기다림', description: '무언가가 오기를 바라는 시간의 결을 다룹니다. 사람을 기다리는 장면에만 고정하지 않고 변화, 대답, 용기, 계절, 결심, 우연을 기다리는 감정으로 확장합니다.' },
  { id: 'dream', label: 'Dream', labelKo: '꿈', description: '바라는 미래나 아직 닿지 못한 가능성을 다룹니다. 희망적인 목표에만 고정하지 않고 환상, 불안, 상상, 포기하지 못한 장면, 멀리 있는 빛으로 해석합니다.' },
  { id: 'city', label: 'City', labelKo: '도시', description: '도시 속에서 스치는 사람과 공간, 속도감이 만드는 감정을 다룹니다. 네온 밤거리에만 고정하지 않고 익명성, 소음, 이동, 외로움과 활기를 함께 풉니다.' },
  { id: 'drive', label: 'Drive', labelKo: '드라이브', description: '이동하는 시간과 풍경이 감정의 속도를 바꾸는 순간을 다룹니다. 드라이브 풍경에만 고정하지 않고 떠남, 망설임, 해방, 동행, 침묵으로 해석합니다.' },
  { id: 'encounter', label: 'Encounter', labelKo: '만남', description: '새로운 인연이나 상황이 시작되는 첫 접점을 다룹니다. 사람과 사람의 만남뿐 아니라 장소, 기억, 기회, 사건이 처음 열리는 순간으로 확장해 해석합니다.' },
  { id: 'lingering_attachment', label: 'Lingering Attachment', labelKo: '미련', description: '끝났다고 믿으려 하지만 아직 정리되지 않은 감정을 다룹니다. 특정 연락 장면에 고정하지 않고 사람, 장소, 물건, 습관, 계절감, 몸의 반응으로 표현할 수 있습니다.' },
  { id: 'sea', label: 'Sea', labelKo: '바다', description: '넓은 바다 앞에서 감정이 작아지거나 풀려나는 순간을 다룹니다. 해방감에만 고정하지 않고 그리움, 고요, 압도감, 정리, 다시 시작하는 마음으로 해석합니다.' },
  { id: 'night', label: 'Night', labelKo: '밤', description: '밤이라는 시간 속에서 선명해지는 감정과 감춰진 마음을 다룹니다. 어둠 자체보다 낮에는 숨겼던 생각, 느려지는 시간, 혼자 남은 감각으로 해석합니다.' },
  { id: 'room', label: 'Room', labelKo: '방', description: '혼자만의 공간에서 감정이 증폭되거나 정리되는 시간을 다룹니다. 방 안 장면에 고정하지 않고 내부 독백, 숨겨둔 행동, 멈춘 시간, 자기와 마주하는 순간으로 해석합니다.' },
  { id: 'wandering', label: 'Wandering', labelKo: '방황', description: '방향을 잃은 채 흔들리지만 계속 움직이는 시간을 다룹니다. 길 잃음 자체보다 선택하지 못함, 잠시 멈춤, 다시 걷는 몸, 불확실한 마음의 흐름으로 해석합니다.' },
  { id: 'endurance', label: 'Endurance', labelKo: '버팀', description: '무너지지 않기 위해 오래 버티는 마음을 다룹니다. 강한 의지보다 지친 상태에서도 놓지 않는 작은 행동, 반복되는 하루, 숨을 고르는 힘으로 해석합니다.' },
  { id: 'change', label: 'Change', labelKo: '변화', description: '익숙한 상태에서 벗어나 다른 방향으로 움직이는 순간을 다룹니다. 극적인 변신보다 흔들림, 결심 전후의 공기, 작은 선택이 만들어내는 감정의 이동으로 해석합니다.' },
  { id: 'anger', label: 'Anger', labelKo: '분노', description: '억눌린 감정이 터지거나 차갑게 응축되는 순간을 다룹니다. 소리치는 장면에만 고정하지 않고 냉정한 말투, 끊어진 호흡, 눌린 에너지, 행동의 날카로움으로 표현합니다.' },
  { id: 'anxiety', label: 'Anxiety', labelKo: '불안', description: '다가올 일이나 불확실한 관계 앞에서 흔들리는 마음을 다룹니다. 막연한 불안보다 몸의 긴장, 반복 확인, 좁아지는 생각, 작은 신호에 흔들리는 상태로 해석합니다.' },
  { id: 'rain', label: 'Rain', labelKo: '비', description: '비가 만드는 소리와 흐려진 시야, 씻겨 내려가거나 더 짙어지는 감정을 다룹니다. 슬픔에만 고정하지 않고 고요함, 해방감, 기억의 번짐으로 풉니다.' },
  { id: 'love', label: 'Love', labelKo: '사랑', description: '사랑 자체보다 관계가 변하는 온도와 시선을 중심으로 해석합니다. 장면은 특정 고백 상황에 고정하지 않고 가까워짐, 머뭇거림, 돌봄, 거리감, 선택의 변화로 자유롭게 풀어냅니다.' },
  { id: 'walk', label: 'Walk', labelKo: '산책', description: '걷는 동안 생각과 감정이 조금씩 움직이는 과정을 다룹니다. 산책 풍경에만 고정하지 않고 머뭇거림, 정리, 도망, 회복, 방향 전환으로 풉니다.' },
  { id: 'dawn', label: 'Dawn', labelKo: '새벽', description: '하루가 끝나고 시작되기 전의 애매한 감정대를 다룹니다. 고요함에만 고정하지 않고 피로, 결심, 후회, 작은 회복, 아직 이름 붙지 않은 마음으로 풉니다.' },
  { id: 'gift', label: 'Gift', labelKo: '선물', description: '주고받는 물건보다 그 안에 담긴 마음과 거리감을 다룹니다. 따뜻함에만 고정하지 않고 고르던 시간, 말하지 못한 의미, 부담, 기억으로 해석합니다.' },
  { id: 'excitement', label: 'Excitement', labelKo: '설렘', description: '새로운 감정이 막 생겨나는 떨림과 기대를 중심으로 합니다. 만남, 장소, 몸의 반응, 작은 변화, 리듬감 등으로 다양하게 장면화할 수 있습니다.' },
  { id: 'growth', label: 'Growth', labelKo: '성장', description: '변화하며 조금씩 넓어지는 마음과 시간을 다룹니다. 성공 서사에 고정하지 않고 서툰 시도, 넘어짐, 알아차림, 관계의 변화, 이전의 나를 지나가는 과정으로 풉니다.' },
  { id: 'small_happiness', label: 'Small Happiness', labelKo: '소확행', description: '일상 속 아주 작은 만족과 마음이 풀리는 순간을 다룹니다. 귀여운 행복에만 고정하지 않고 반복된 하루 안의 작은 보상, 숨 돌림, 사소한 빛으로 해석합니다.' },
  { id: 'drinking_party', label: 'Drinking Party', labelKo: '술자리', description: '술자리에서 느슨해지는 말과 숨겨진 감정을 다룹니다. 취한 고백에 고정하지 않고 어색함, 농담, 관계의 균열, 뒤늦게 나오는 진심으로 풉니다.' },
  { id: 'time', label: 'Time', labelKo: '시간', description: '흐르는 시간 속에서 변하거나 남아 있는 감정을 다룹니다. 시간의 흐름을 설명하기보다 기다림, 늦음, 반복, 멈춘 듯한 순간, 지나간 뒤의 깨달음으로 풉니다.' },
  { id: 'safe_place', label: 'Safe Place', labelKo: '안식처', description: '마음이 방어를 내려놓을 수 있는 심리적 공간을 다룹니다. 특정 장소에 고정하지 않고 사람, 습관, 소리, 시간대, 스스로에게 돌아오는 감각으로 해석합니다.' },
  { id: 'overtime', label: 'Overtime', labelKo: '야근', description: '늦게까지 이어지는 일과 지친 마음의 웃픈 현실감을 다룹니다. 회사 풍경에만 고정하지 않고 무너진 리듬, 농담으로 버티는 태도, 조용한 피로로 해석합니다.' },
  { id: 'childhood', label: 'Childhood', labelKo: '어린시절', description: '어린 시절의 기억과 순수함이 현재의 감정과 만나는 지점을 다룹니다. 향수에만 고정하지 않고 잃어버린 감각, 오래된 약속, 아직 남아 있는 어린 마음으로 풉니다.' },
  { id: 'travel', label: 'Travel', labelKo: '여행', description: '새로운 장소에서 자기 감정이 낯설게 드러나는 경험을 다룹니다. 여행의 설렘에만 고정하지 않고 도피, 발견, 이방감, 회복, 관계의 변화로 풉니다.' },
  { id: 'misunderstanding', label: 'Misunderstanding', labelKo: '오해', description: '말과 마음이 어긋나 생기는 균열을 다룹니다. 다툼 장면에 고정하지 않고 침묵, 잘못 읽은 신호, 서로 다른 기억, 늦게 알아차린 진심으로 풀어냅니다.' },
  { id: 'loneliness', label: 'Loneliness', labelKo: '외로움', description: '혼자 남겨진 듯한 감정과 공허한 내부 공간을 다룹니다. 단순한 쓸쓸함보다 주변은 움직이는데 나만 멈춘 듯한 감각, 거리감, 무표정한 일상으로 풀어냅니다.' },
  { id: 'friendship', label: 'Friendship', labelKo: '우정', description: '친구 사이의 유대와 함께 보낸 시간을 다룹니다. 밝은 추억뿐 아니라 서로를 지탱한 순간, 장난, 거리감, 성장, 다시 이어지는 마음으로 확장합니다.' },
  { id: 'fate', label: 'Fate', labelKo: '운명', description: '우연과 선택이 겹쳐 피할 수 없는 흐름처럼 느껴지는 관계나 사건을 다룹니다. 운명적 만남에 고정하지 않고 반복되는 징후, 이상한 끌림, 되돌아오는 순간으로 해석합니다.' },
  { id: 'monday', label: 'Monday', labelKo: '월요일', description: '새로운 한 주가 시작될 때의 피로와 다짐, 현실감을 다룹니다. 월요병에만 고정하지 않고 다시 버티려는 마음, 반복의 무게, 작은 리셋으로 해석합니다.' },
  { id: 'comfort', label: 'Comfort', labelKo: '위로', description: '지친 마음이 조금씩 가라앉고 다시 숨을 고르는 과정을 다룹니다. 직접 위로하는 말보다 함께 있어 주는 공기, 작은 온기, 무너진 마음을 받쳐주는 장면으로 풉니다.' },
  { id: 'breakup', label: 'Breakup', labelKo: '이별', description: '관계가 끝나는 순간과 그 이후의 흔들림을 다룹니다. 이별 장면 하나에 고정하지 않고 정리, 부정, 받아들임, 남겨진 습관, 변화한 거리감으로 풀어냅니다.' },
  { id: 'identity', label: 'Identity', labelKo: '자아', description: '자신이 누구인지 되묻고 다시 정의하려는 내면의 움직임을 다룹니다. 선언보다 흔들림, 비교, 선택, 거울 같은 순간, 이름 붙일 수 없는 감정으로 풀어냅니다.' },
  { id: 'freedom', label: 'Freedom', labelKo: '자유', description: '무언가에서 벗어나 자기 호흡을 되찾는 감정을 다룹니다. 탈출 장면에만 고정하지 않고 내려놓음, 선택, 몸이 가벼워지는 감각, 새로운 방향으로 확장합니다.' },
  { id: 'reunion', label: 'Reunion', labelKo: '재회', description: '다시 마주하는 순간의 기대와 어색함, 변화한 마음을 다룹니다. 극적인 재회뿐 아니라 다시 읽히는 기억, 돌아온 감각, 달라진 거리감으로 해석합니다.' },
  { id: 'resistance', label: 'Resistance', labelKo: '저항', description: '외부의 압력이나 내면의 한계에 맞서는 감정을 다룹니다. 싸움 장면에 고정하지 않고 버티는 태도, 거부하는 말투, 꺾이지 않는 리듬, 조용한 반항으로 풉니다.' },
  { id: 'bus_stop', label: 'Bus Stop', labelKo: '정류장', description: '머무름과 이동 사이에 놓인 기다림의 시간을 다룹니다. 정류장 풍경에만 고정하지 않고 지나가는 선택, 놓친 타이밍, 잠깐의 기대감으로 풉니다.' },
  { id: 'weekend', label: 'Weekend', labelKo: '주말', description: '일상에서 잠시 풀려나는 시간과 자유로운 호흡을 다룹니다. 휴식 장면에만 고정하지 않고 늦은 시작, 미뤄둔 마음, 느슨한 관계, 작은 모험으로 풀어냅니다.' },
  { id: 'subway', label: 'Subway', labelKo: '지하철', description: '이동하는 사람들 사이에서 생기는 고독과 속도감을 다룹니다. 지하철 장면에만 고정하지 않고 스치는 관계, 반복된 출퇴근, 잠깐의 상상으로 해석합니다.' },
  { id: 'obsession', label: 'Obsession', labelKo: '집착', description: '놓지 못하고 반복해서 붙잡는 감정을 다룹니다. 집착을 단순한 과장으로 쓰지 않고 반복 행동, 좁아지는 시야, 스스로도 멈추지 못하는 내면의 압박으로 해석합니다.' },
  { id: 'crush', label: 'Crush', labelKo: '짝사랑', description: '혼자 간직한 마음의 조심스러움과 들킬 듯 말 듯한 긴장을 다룹니다. 특정 연락 장면에 고정하지 않고 시선, 행동, 거리, 습관, 우연한 순간으로 해석할 수 있습니다.' },
  { id: 'youth', label: 'Youth', labelKo: '청춘', description: '청춘의 빛과 불안, 무모함과 아름다움을 함께 다룹니다. 찬란함 하나로 고정하지 않고 실패, 속도, 우정, 사랑, 미래 앞의 흔들림으로 해석합니다.' },
  { id: 'memory', label: 'Memory', labelKo: '추억', description: '지나간 기억이 현재 감정에 남기는 흔적을 다룹니다. 회상 자체보다 기억이 되살아나는 계기, 왜곡된 장면, 남은 감각, 현재의 선택에 미치는 영향으로 해석합니다.' },
  { id: 'cafe', label: 'Cafe', labelKo: '카페', description: '잠시 머무르며 마음을 정리하거나 누군가를 기다리는 감정을 다룹니다. 감성적인 공간에만 고정하지 않고 소음, 거리감, 말의 타이밍, 혼자 있는 시간을 포함합니다.' },
  { id: 'after_work', label: 'After Work', labelKo: '퇴근', description: '하루를 끝내고 자기 자신에게 돌아오는 시간을 다룹니다. 퇴근길에 고정하지 않고 풀리는 긴장, 남은 말, 혼자만의 회복, 하루의 잔상으로 풉니다.' },
  { id: 'convenience_store', label: 'Convenience Store', labelKo: '편의점', description: '작은 생활 공간에서 마주치는 현실감과 위안을 다룹니다. 편의점 자체보다 늦은 시간의 선택, 작은 소비, 우연한 만남, 혼자 버티는 마음으로 풉니다.' },
  { id: 'eating_alone', label: 'Eating Alone', labelKo: '혼자밥', description: '혼자 보내는 식사 시간의 공허함과 이상한 평온함을 다룹니다. 외로움에만 고정하지 않고 스스로를 돌보는 행동, 생활의 리듬, 작은 위안으로 해석합니다.' },
  { id: 'reconciliation', label: 'Reconciliation', labelKo: '화해', description: '상처나 오해를 지나 다시 다가가려는 움직임을 다룹니다. 사과 장면에만 고정하지 않고 마음이 풀리는 과정, 작은 행동, 다시 맞춰지는 호흡으로 해석합니다.' },
  { id: 'company_life', label: 'Company Life', labelKo: '회사생활', description: '직장 안의 관계와 역할, 피로와 농담이 섞인 현실감을 다룹니다. 단순 풍자에만 고정하지 않고 눈치, 책임, 반복, 작은 자존심으로 풀어냅니다.' },
  { id: 'reminiscence', label: 'Reminiscence', labelKo: '회상', description: '과거를 떠올리며 현재의 감정과 겹쳐 보는 흐름을 다룹니다. 회상 장면 자체보다 기억이 현재의 말투, 행동, 공간, 소리 위에 스며드는 방식으로 풉니다.' },
  { id: 'regret', label: 'Regret', labelKo: '후회', description: '지나간 선택을 되돌아보며 남는 아쉬움과 자책을 다룹니다. 후회하는 말보다 늦게 깨달은 행동, 놓친 타이밍, 바꿀 수 없는 결과와 남은 여운으로 해석합니다.' },
  { id: 'hope', label: 'Hope', labelKo: '희망', description: '아직 끝나지 않았다고 믿는 마음과 앞으로 나아가려는 힘을 다룹니다. 밝은 응원만이 아니라 작게 버티는 태도, 다시 선택하는 용기, 미세한 빛의 변화로 표현합니다.' }
];
...
export const GENRE_HIERARCHY: GenreGroupItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'R&B',
        labelKo: '알앤비',
        description: '감미로운 보컬과 세련된 그루브를 중심으로 감정을 표현하는 장르입니다.',
        children: [
  ...
  },
  {
    ...
    label: 'Rock & Metal',
    labelKo: '록 & 메탈',
    description: '기타, 베이스, 드럼의 강렬한 사운드와 메탈의 묵직한 에너지를 함께 다루는 카테고리입니다.',
    children: [
      {
        id: 'rock',
        label: 'Rock',
        labelKo: '록',
        description: '밴드 사운드와 기타 중심의 에너지로 감정과 태도를 표현하는 장르입니다.',
        children: [
      ...
      },
      {
        ...
        label: 'Metal',
        labelKo: '메탈',
        description: '강한 리프, 무거운 드럼, 공격적인 에너지로 극적인 힘을 만드는 장르입니다.',
        children: [
  ...
  },
  {
    ...
    label: 'Electronic',
    labelKo: '일렉트로닉',
    description: '신디사이저, 디지털 비트, 클럽 그루브, 베이스 사운드를 중심으로 한 전자음악 카테고리입니다.',
    children: [
      {
        id: 'edm',
        label: 'Club / EDM',
        labelKo: '클럽/EDM',
        description: '클럽과 페스티벌에서 강한 에너지와 리듬감을 만드는 전자음악 계열입니다.',
        children: [
      ...
      },
      {
        ...
        label: 'Synth / Bass',
        labelKo: '신스/베이스',
        description: '신스 질감, 베이스 드롭, 글리치와 레트로 전자 사운드를 중심으로 한 계열입니다.',
        children: [
  ...
  },
  {
    ...
    label: 'Jazz & Folk',
    labelKo: '재즈 & 포크',
    description: '재즈의 즉흥성과 포크/컨트리의 어쿠스틱 감성을 함께 다루는 카테고리입니다.',
    children: [
      {
        id: 'jazz',
        label: 'Jazz',
      ...
      },
      {
        ...
        label: 'Folk & Country',
        labelKo: '포크 & 컨트리',
        description: '어쿠스틱 악기와 진솔한 서사를 중심으로 따뜻한 감성을 전달하는 장르군입니다.',
        children: [
  ...
  },
  {
    ...
    label: 'World Music',
    labelKo: '월드 뮤직',
    description: '세계 각 지역의 전통 악기, 민속 리듬, 지역적 색채를 독립적으로 다루는 카테고리입니다.',
    children: [
      {
        id: 'world_music_folk',
        label: 'World / Traditional',
        labelKo: '월드/전통',
        description: '세계 각국의 전통 선율과 민속적 색채를 중심으로 한 장르군입니다.',
        children: [
      ...
      },
      {
        ...
        label: 'Global Rhythm',
        labelKo: '글로벌 리듬',
        description: '라틴, 레게, 아프로 리듬처럼 지역 리듬과 댄스 그루브가 중심인 장르군입니다.',
        children: [
  ...
  },
  {
    ...
    label: 'Classical & Theme Music',
    labelKo: '클래식 & 테마음악',
    description: '클래식 성악, 오케스트라, 장면용 테마와 배경음악을 함께 다루는 카테고리입니다.',
    children: [
      {
        id: 'classical',
        label: 'Classical / Vocal',
        labelKo: '클래식·성악',
        description: '클래식 악기, 합창, 오페라처럼 극적이고 예술적인 음악 계열입니다.',
        children: [
      ...
      },
      {
        ...
        label: 'Theme Music',
        labelKo: '테마곡',
        description: '게임, 장면, 서사를 위한 테마형 음악 계열입니다. 멜로디와 장면성이 중심입니다.',
        children: [
          { id: 'orchestral_score', label: 'Orchestral Score', labelKo: '오케스트럴 스코어', description: '오케스트라의 웅장한 사운드로 극의 서사와 감동을 완성하는 테마 음악입니다.' },
          { id: 'hybrid_epic', label: 'Hybrid Epic', labelKo: '하이브리드 에픽', description: '전자음과 오케스트라가 결합된 압도적이고 웅장한 스케일의 테마 사운드입니다.' },
          { id: 'synth_score', label: 'Synth Score', labelKo: '신시사이저 스코어', description: '신시사이저의 독특한 질감으로 미래적이거나 긴장감 있는 장면을 만듭니다.' },
          ...
          { id: 'fantasy_bgm', label: 'Fantasy Theme', labelKo: '판타지 테마', description: '벨, 패드, 코러스 질감으로 마법적이고 환상적인 공간을 만드는 테마 음악입니다.' },
          { id: 'dark_fantasy', label: 'Dark Fantasy', labelKo: '다크 판타지', description: '어두운 현악, 낮은 드론, 신비로운 코러스가 결합된 판타지 테마입니다.' },
          { id: 'mystery_bgm', label: 'Mystery Theme', labelKo: '미스터리 테마', description: '작은 피아노, 서늘한 패드, 미세한 효과음으로 의문과 긴장감을 만드는 테마입니다.' },
      ...
      {
        id: 'instrumental_bgm',
        label: 'Instrumental BGM',
        labelKo: '연주 BGM',
        description: '공부, 휴식, 카페, 자연, 명상처럼 배경에 깔리는 무보컬 연주 BGM 계열입니다.',
        children: [
          { id: 'lofi_study', label: 'Lo-Fi Study', labelKo: '로파이 스터디', description: '테이프 노이즈, 부드러운 키와 룸톤 중심의 공부/작업용 무보컬 BGM입니다.' },
          { id: 'cafe_bgm', label: 'Cafe BGM', labelKo: '카페 BGM', description: '부드러운 피아노와 따뜻한 룸톤으로 카페처럼 편안하고 집중하기 좋은 무보컬 BGM입니다.' },
          { id: 'nature_ambience', label: 'Nature Ambience', labelKo: '자연 앰비언스', description: '숲, 바람, 물소리 같은 자연 배경음과 부드러운 패드가 어우러진 무보컬 앰비언스입니다.' },
          { id: 'healing_piano', label: 'Healing Piano', labelKo: '힐링 피아노', description: '단순하고 따뜻한 피아노 선율로 안정감과 위로를 주는 무보컬 연주 BGM입니다.' },
          { id: 'ambient', label: 'Ambient', labelKo: '앰비언트', description: '멜로디보다 공간, 질감, 잔향을 중심으로 분위기를 만드는 무보컬 배경음악입니다.' },
          { id: 'minimalism', label: 'Minimalism', labelKo: '미니멀리즘', description: '단순한 패턴의 반복과 절제로 세련되고 집중력 있는 연주 BGM입니다.' },
          { id: 'piano_solo', label: 'Piano Solo', labelKo: '피아노 솔로', description: '피아노의 맑고 섬세한 선율로 장면의 감성을 만드는 무보컬 연주곡입니다.' },
          { id: 'string_ensemble', label: 'String Ensemble', labelKo: '스트링 합주', description: '현악기들의 조화로운 울림으로 서정적이고 극적인 분위기를 연출하는 연주 BGM입니다.' },
        ]
      }
    ]
  }
...
export const GENRE_INSTRUMENT_PROFILES: Record<string, GenreInstrumentProfile> = {
  ...
  // Added profiles for reorganized and newly added genres
  italian_pop: { instruments: ['melodic piano', 'warm strings', 'clean pop drums', 'accordion color'], rhythm: ['romantic European pop flow'], texture: ['polished melodic warmth'] },
  underground_hiphop: { instruments: ['dusty drums', 'sample chops', 'raw bass', 'vinyl texture'], rhythm: ['head-nod underground groove'], texture: ['raw street texture'] },
  comedy_hiphop: { instruments: ['bouncy drums', 'quirky samples', 'funky bass', 'scratch FX'], rhythm: ['playful rap bounce'], texture: ['comic punchline energy'] },
  baroque_hiphop: { instruments: ['harpsichord sample', 'string stabs', 'boom-bap drums', 'sub bass'], rhythm: ['classical-sample hip-hop groove'], texture: ['ornate dramatic contrast'] },
  chill_trap: { instruments: ['soft 808', 'gentle hi-hats', 'mellow keys', 'airy pads'], rhythm: ['laid-back trap bounce'], texture: ['relaxed nocturnal space'] },
  acoustic_rnb: { instruments: ['acoustic guitar', 'Rhodes keys', 'soft bass', 'brush drums'], rhythm: ['intimate R&B pocket'], texture: ['warm unplugged groove'] },
  soul_blues: { instruments: ['blues guitar', 'organ', 'soul bass', 'live drums'], rhythm: ['slow soul-blues sway'], texture: ['deep smoky warmth'] },
  pop_punk: { instruments: ['power chords', 'fast drums', 'bright bass', 'shoutable guitar hooks'], rhythm: ['fast pop-punk drive'], texture: ['youthful band energy'] },
  romantic_rock: { instruments: ['emotional electric guitar', 'live drums', 'warm bass', 'piano layer'], rhythm: ['romantic rock build'], texture: ['wide emotional band lift'] },
  medieval_rock: { instruments: ['lute-like guitar', 'folk flute', 'rock drums', 'distorted guitar'], rhythm: ['ancient folk-rock march'], texture: ['medieval live-band color'] },
  opera_rock: { instruments: ['rock guitar', 'orchestral strings', 'dramatic drums', 'choir layers'], rhythm: ['theatrical rock build'], texture: ['operatic scale'] },
  retro_punk: { instruments: ['raw guitars', 'vintage bass', 'garage drums'], rhythm: ['straight retro-punk drive'], texture: ['rough vintage band texture'] },
  slow_metal: { instruments: ['slow distorted riffs', 'heavy bass', 'doom drums'], rhythm: ['slow crushing metal crawl'], texture: ['dark heavy pressure'] },
  djent_metal: { instruments: ['tight low riffs', 'syncopated guitars', 'modern drums', 'sub bass'], rhythm: ['precise djent syncopation'], texture: ['modern riff pressure'] },
  beatdown_hardcore: { instruments: ['breakdown guitars', 'hardcore drums', 'gang shouts', 'heavy bass'], rhythm: ['brutal breakdown groove'], texture: ['raw hardcore impact'] },
  crunkcore: { instruments: ['distorted synth', 'trap drums', 'screamed hooks', 'heavy bass'], rhythm: ['rap-core electronic bounce'], texture: ['chaotic party aggression'] },
  epic_edm: { instruments: ['festival synth lead', 'big risers', 'huge kick', 'anthem pads'], rhythm: ['massive festival build'], texture: ['wide epic impact'] },
  tech_house: { instruments: ['tight kick', 'tech bass', 'minimal synth stabs', 'club hats'], rhythm: ['clean tech-house groove'], texture: ['sleek club motion'] },
  microhouse: { instruments: ['tiny percussion', 'subtle bass', 'clicks', 'minimal chords'], rhythm: ['minimal microhouse groove'], texture: ['detailed sparse club texture'] },
  underground_techno: { instruments: ['warehouse kick', 'acid line', 'industrial hats', 'dark synth'], rhythm: ['hypnotic underground techno pulse'], texture: ['dark club pressure'] },
  goa_psytrance: { instruments: ['psychedelic leads', 'rolling bass', 'tribal percussion', 'riser FX'], rhythm: ['hypnotic psytrance drive'], texture: ['psychedelic trance space'] },
  hard_dubstep: { instruments: ['growl bass', 'impact hits', 'aggressive synths', 'half-time drums'], rhythm: ['hard dubstep drop movement'], texture: ['violent bass impact'] },
  funk_carioca: { instruments: ['raw Brazilian bass', 'tamborzão drums', 'vocal chants', 'percussion hits'], rhythm: ['funk carioca bounce'], texture: ['street-party rhythm'] },
  jazz_blues: { instruments: ['blues guitar', 'jazz piano', 'walking bass', 'brush drums'], rhythm: ['smoky jazz-blues swing'], texture: ['late-night blues warmth'] },
  acoustic_jazz: { instruments: ['upright bass', 'brush drums', 'acoustic piano', 'soft horns'], rhythm: ['live acoustic jazz swing'], texture: ['intimate club realism'] },
  p_funk_jazz: { instruments: ['funk bass', 'wah guitar', 'jazz keys', 'horn stabs'], rhythm: ['P-Funk jazz groove'], texture: ['funky fusion color'] },
  slow_country_pop: { instruments: ['acoustic guitar', 'lap steel', 'soft pop drums', 'warm bass'], rhythm: ['slow country-pop sway'], texture: ['warm rural sentiment'] },
  traditional_folk_music: { instruments: ['hand percussion', 'folk strings', 'wood flute', 'acoustic drone'], rhythm: ['regional folk pulse'], texture: ['organic traditional color'] },
  balkan_folk: { instruments: ['accordion', 'brass', 'tupan drum', 'folk strings'], rhythm: ['lively Balkan rhythm'], texture: ['Eastern European folk color'] },
  sarod: { instruments: ['sarod', 'tabla', 'tanpura drone', 'bansuri color'], rhythm: ['Indian classical pulse'], texture: ['resonant raga-like texture'] },
  chacha: { instruments: ['Latin percussion', 'piano montuno', 'brass section', 'upright bass'], rhythm: ['cha-cha-cha dance rhythm'], texture: ['playful Latin movement'] },
  church_hymn: { instruments: ['choir', 'pipe organ', 'soft strings'], rhythm: ['sacred choral flow'], texture: ['reverent church resonance'] },
  gothic_opera: { instruments: ['operatic choir', 'dark strings', 'pipe organ', 'timpani'], rhythm: ['gothic dramatic build'], texture: ['dark cathedral scale'] },
  cinematic_ballad: { instruments: ['emotional piano', 'soft strings', 'cinematic pads', 'gentle drums'], rhythm: ['score-like ballad build'], texture: ['wide emotional scene'] },
  battle_theme: { instruments: ['heroic brass', 'taiko-like drums', 'strings ostinato', 'impact hits'], rhythm: ['action-score battle drive'], texture: ['heroic tension'] },
  video_game_music: { instruments: ['loopable synth lead', 'game pads', 'chiptune accents', 'hybrid drums'], rhythm: ['loop-friendly thematic motion'], texture: ['interactive game-score clarity'] },
  bass_synth: { instruments: ['synth bass', 'digital drums', 'arps', 'FX hits'], rhythm: ['synth-bass electronic motion'], texture: ['neon digital texture'] },
  global_rhythm: { instruments: ['hand percussion', 'groove bass', 'regional drums', 'bright guitar'], rhythm: ['global rhythm groove'], texture: ['warm danceable world color'] },
  theme_bgm: { instruments: ['theme motif', 'soft strings', 'hybrid pads', 'scene percussion'], rhythm: ['scene-led theme movement'], texture: ['narrative background space'] },
  retrowave: { instruments: ['analog arps', 'neon pads', 'gated drums', 'retro bass'], rhythm: ['night-drive synth pulse'], texture: ['neon nostalgic sheen'] },
};
