        ...
        {bulkMenuState && multiSelectMode && (
          <>
            <motion.div
              ...
              data-selection-keep="true" data-floating-menu="true" data-more-menu-panel="true" className="fixed z-[9999] w-56 bg-[var(--bg-secondary)] border border-[#A98BFF]/22 rounded-xl shadow-2xl py-2 overflow-hidden pointer-events-auto"
