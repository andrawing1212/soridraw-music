...
assert.match(entry, /SORIDRAW_EXPLORE_LIKE_EVENT_BATCH_JOIN_RACE_195_20260924/);
...
console.log('195_JOINED_BATCH_CANNOT_FALL_BETWEEN_PENDING_CHECK_AND_MARKER_DELETE=PASS');
