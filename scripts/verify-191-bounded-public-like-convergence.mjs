...
assert.match(releaseWorkflow,/for scheduled_path in \/__scheduled \/cdn-cgi\/handler\/scheduled \/cdn-cgi\/local\/scheduled/);
assert.match(releaseWorkflow,/\$\{scheduled_path\}\?cron=\*\+\*\+\*\+\*\+\*/);
...
console.log('191_ONE_TIME_REMOTE_SCHEDULE_NO_CRON_PROPAGATION=PASS');
